...
{
    public function __construct(private \App\Repositories\Group\GroupInterface $modelInterface)
    {
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', GroupResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
