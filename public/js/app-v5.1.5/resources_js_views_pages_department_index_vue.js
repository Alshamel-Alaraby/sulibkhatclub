  ...
  methods: {
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/tasks/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this8.checkAll = [];
              _this8.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this8.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/tasks/".concat(id)).then(function (res) {
              _this8.getDataTask();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
                title: "".concat(_this8.$t("general.Deleted")),
    ...
    AddSubmitTask: function AddSubmitTask() {
      ...
      if (this.$v.createTask.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/tasks", _objectSpread(_objectSpread({}, this.createTask), {}, {
    ...
    editSubmitTask: function editSubmitTask(id) {
      ...
      if (this.$v.editTask.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/tasks/".concat(id), _objectSpread(_objectSpread({}, this.editTask), {}, {
          department_id: this.department_id
        })).then(function (res) {
          _this16.getData();
          setTimeout(function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _this19.edit.name = tasks.name;
              _this19.edit.name_e = tasks.name_e;
              _this19.edit.description = tasks.description;
              _this19.edit.description_e = tasks.description_e;
              _this19.errors = {};
            case 6:
            case "end":
              return _context.stop();
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    return _c("tr", {
      ...
      return _c("tr", {
        ...
        refInFor: true,
        attrs: {
          id: "modal-edit-task-".concat(data.id),
        ...
        on: {
          show: function show($event) {
            return _vm.resetModalEditTask(data.id);
          },
          hidden: function hidden($event) {
            return _vm.resetModalHiddenEditTask(data.id);
          }
        }
      }, [_c("form", [_c("div", {
        staticClass: "mb-3 d-flex justify-content-end"
        ...
        on: {
          click: function click($event) {
            $event.preventDefault();
            return _vm.editSubmitTask(data.id);
          }
        }
      }, [_vm._v("\n                                                          " + _vm._s(_vm.$t("general.Edit")) + "\n                                                      ")]) : _c("b-button", {
        staticClass: "mx-1",
        ...
        on: {
          click: function click($event) {
            $event.preventDefault();
            return _vm.$bvModal.hide("modal-edit-task-".concat(data.id));
          }
        }
      }, [_vm._v("\n                                                          " + _vm._s(_vm.$t("general.Cancel")) + "\n                                                      ")])], 1), _vm._v(" "), _c("div", {
        staticClass: "row"
