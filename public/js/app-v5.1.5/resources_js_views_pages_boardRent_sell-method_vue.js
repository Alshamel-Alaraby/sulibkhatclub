...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.sellMethods.forEach(function (el) {
  ...
  methods: {
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/boards-rent/sell-methods/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/boards-rent/sell-methods?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this4.sellMethods = l.data;
        _this4.sellMethodsPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this5 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      if (this.current_page <= this.sellMethodsPagination.last_page && this.current_page != this.sellMethodsPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i < this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/boards-rent/sell-methods?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&company_id=").concat(this.company_id)).then(function (res) {
          var l = res.data;
          _this5.sellMethods = l.data;
          _this5.sellMethodsPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/boards-rent/sell-methods/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this6.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/boards-rent/sell-methods/".concat(id)).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/boards-rent/sell-methods", this.create).then(function (res) {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/boards-rent/sell-methods/".concat(id), this.edit).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      var sellMethods = this.sellMethods.find(function (e) {
        return id == e.id;
      });
      this.edit.name = sellMethods.name;
      this.edit.name_e = sellMethods.name_e;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.sellMethodsTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_sellMethod_name_ar")) + "\n                                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "name_e"
    },
  ...
  }, [_vm._v("\n                                        " + _vm._s(_vm.sellMethodsPagination.from) + "-" + _vm._s(_vm.sellMethodsPagination.to) + " /\n                                        " + _vm._s(_vm.sellMethodsPagination.total) + "\n                                    ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.sellMethodsPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.sellMethodsPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.sellMethodsPagination.last_page == _vm.sellMethodsPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("boardRent_sellMethod_create_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_sellMethod_name_ar")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.sellMethods.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_sellMethod_name_en")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.sellMethods.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.sellMethods.length > 0 ? _c("tbody", _vm._l(_vm.sellMethods, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("boardRent_sellMethod_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
