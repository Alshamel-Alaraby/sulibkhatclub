...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
<<<<<<< HEAD:public/js/app-v5.1.5/resources_js_views_pages_recievablePayable_report_payments_vue.js
      version: "v5.1.5"
=======
      version: "v5.1.4"
>>>>>>> dev-test:public/js/app-v5.1.4/resources_js_views_pages_recievablePayable_report_payments_vue.js
    };
  }
});
  ...
  data: function data() {
    return {
      ...
      setting: {
        ...
        installment_statu_id: true,
        serial_number: true
      },
      filterSetting: ['customer_id', 'instalment_date', 'currency_id', 'rate', 'debit', 'credit', 'total', 'break_type', 'instalment_type_id', 'installment_statu_id'],
      Tooltip: '',
      mouseEnter: null
    };
  },
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      if (this.$v.create.$invalid) {
        ...
        var _this$create$customer, _this$create$instalme, _this$create$installm;
        this.isLoader = true;
        ...
        index = this.filterSetting.indexOf("installment_statu_id");
        if (index > -1) {
          _filterSetting[index] = this.$i18n.locale == "ar" ? "installment_status.name" : "installment_status.name_e";
        }
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/recievable-payable/filterBreak?start_date=".concat(this.create.start_date, "&end_date=").concat(this.create.end_date, "&customer_id=").concat((_this$create$customer = this.create.customer_id) !== null && _this$create$customer !== void 0 ? _this$create$customer : '', "&instalment_type_id=").concat((_this$create$instalme = this.create.instalment_type_id) !== null && _this$create$instalme !== void 0 ? _this$create$instalme : '', "&installment_statu_id=").concat((_this$create$installm = this.create.installment_statu_id) !== null && _this$create$installm !== void 0 ? _this$create$installm : '', "&page=").concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.$v.create.$invalid) {
        ...
        if (this.current_page <= this.installmentStatusPagination.last_page && this.current_page != this.installmentStatusPagination.current_page && this.current_page) {
          var _this$create$customer2, _this$create$instalme2, _this$create$installm2;
          this.isLoader = true;
          var _filterSetting = _toConsumableArray(this.filterSetting);
          var index = this.filterSetting.indexOf("customer_id");
          if (index > -1) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _this9.getCustomers(1);
            case 2:
              _context4.next = 4;
              return _this9.getInstallPaymentTypes();
            case 4:
              _context4.next = 6;
              return _this9.getInstallmentStatuses();
            case 6:
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("installment_opening_balance_date")) + "\n                                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
    ...
    staticClass: "mb-1",
    attrs: {
      value: _vm.$i18n.locale == "ar" ? "installment_status.name" : "installment_status.name_e"
    },
    model: {
      value: _vm.filterSetting,
      callback: function callback($$v) {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("installment_opening_balance_date")) + "\n                                        ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.installment_statu_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "installment_statu_id", $$v);
      },
      expression: "setting.installment_statu_id"
    }
  }, [_vm._v(_vm._s(_vm.$t("general.status")) + "\n                                        ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    "class": {
      "is-invalid": _vm.errors.installment_statu_id,
      "is-valid": !_vm.errors.installment_statu_id
    },
    attrs: {
    ...
    model: {
      value: _vm.create.installment_statu_id,
      callback: function callback($$v) {
        _vm.$set(_vm.create, "installment_statu_id", $$v);
      },
      expression: "create.installment_statu_id"
    }
  }), _vm._v(" "), _vm.errors.installment_statu_id ? _vm._l(_vm.errors.installment_statu_id, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                                            ")]);
  }) : _vm._e()], 2)])])])]), _vm._v(" "), _c("div", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("installment_opening_balance_date")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.installment_statu_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal td5"
    }, [_vm._v(_vm._s(_vm.$i18n.locale == "ar" ? data.installment_payment_type.name : data.installment_payment_type.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.installment_statu_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal td5"
    }, [_vm._v(_vm._s(_vm.$i18n.locale == "ar" ? data.installment_status.name : data.installment_status.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.serial_number ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal td5"
    }, [_vm._v(_vm._s(data.invoice ? data.invoice.prefix : "---"))])]) : _vm._e()]);
