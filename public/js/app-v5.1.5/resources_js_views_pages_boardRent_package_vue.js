...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _this9.streets = [];
              _context2.next = 6;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/governorates?columns[0]=country_id&search=1").then(function (res) {
                var l = res.data.data;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              governorate = _this10.location[index].governorate_id;
              _this10.location[index].city_id = null;
              _this10.location[index].avenue_id = null;
              _this10.location[index].street_id = null;
              _this10.cities[index].cities = [];
              _this10.avenues[index].avenues = [];
              _this10.streets[index].streets = [];
              _context3.next = 10;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities?columns[0]=governorate_id&search=".concat(governorate)).then(function (res) {
                var l = res.data.data;
                _this10.cities[index].cities = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
    ...
    getAvnue: function getAvnue(index) {
      var _this11 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              city = _this11.location[index].city_id;
              _this11.location[index].avenue_id = null;
              _this11.location[index].street_id = null;
              _this11.avenues[index].avenues = [];
              _this11.streets[index].streets = [];
              _context4.next = 8;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/avenues?columns[0]=city_id&search=".concat(city)).then(function (res) {
                var l = res.data.data;
                _this11.avenues[index].avenues = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
    ...
    getStreet: function getStreet(index) {
      var _this12 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              avenue = _this12.location[index].avenue_id;
              _this12.location[index].street_id = null;
              _this12.streets[index].streets = [];
              _context5.next = 6;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/streets?columns[0]=avenue_id&search=".concat(avenue)).then(function (res) {
                var l = res.data.data;
                _this12.streets[index].streets = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
    ...
    getPanel: function getPanel(index) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var _this13$location$inde, _this13$location$inde2, _this13$location$inde3, _this13$location$inde4, _this13$location$inde5, _this13$location$inde6;
        var category_id, governorate_id, city_id, avenue_id, face, street_id;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _this13.isLoader = true;
              category_id = (_this13$location$inde = _this13.location[index].category_id) !== null && _this13$location$inde !== void 0 ? _this13$location$inde : null;
              governorate_id = (_this13$location$inde2 = _this13.location[index].governorate_id) !== null && _this13$location$inde2 !== void 0 ? _this13$location$inde2 : null;
              city_id = (_this13$location$inde3 = _this13.location[index].city_id) !== null && _this13$location$inde3 !== void 0 ? _this13$location$inde3 : null;
              avenue_id = (_this13$location$inde4 = _this13.location[index].avenue_id) !== null && _this13$location$inde4 !== void 0 ? _this13$location$inde4 : null;
              face = (_this13$location$inde5 = _this13.location[index].face) !== null && _this13$location$inde5 !== void 0 ? _this13$location$inde5 : null;
              street_id = (_this13$location$inde6 = _this13.location[index].street_id) !== null && _this13$location$inde6 !== void 0 ? _this13$location$inde6 : null;
              _context6.next = 9;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/boards-rent/panels?packages=1&category_id=".concat(category_id, "&governorate_id=").concat(governorate_id, "&city_id=").concat(city_id, "&avenue_id=").concat(avenue_id, "&street_id=").concat(street_id, "&face=").concat(face)).then(function (res) {
                var l = res.data.data;
                _this13.pans[index].pans = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
    ...
    getOnePanel: function getOnePanel(id, index) {
      var _this15 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/boards-rent/panels/".concat(id)).then(function (res) {
                var l = res.data.data;
                _this15.pans[index].pans.push(l);
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
          ...
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 16:
              if (packages.panels && packages.panels.length > 0) {
                packages.panels.forEach( /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(e, index) {
                    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                      while (1) switch (_context9.prev = _context9.next) {
                        case 0:
                          ...
                          _context9.next = 7;
                          return this.getOnePanel(e.id, index);
                        case 7:
                          this.panels.push({
                            panel_id: e.id
                          });
    ...
    showGovernorateModal: function showGovernorateModal(index) {
      var _this21 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              if (!(_this21.location[index].governorate_id == 0)) {
                _context11.next = 5;
                break;
              }
              _this21.$bvModal.show("governorate-create");
              _this21.location[index].governorate_id = null;
              _context11.next = 10;
              break;
            case 5:
              _this21.panels[index].panel_id = null;
              _context11.next = 8;
              return _this21.getCity(index);
            case 8:
              _context11.next = 10;
              return _this21.getPanel(index);
            case 10:
            case "end":
    ...
    showCityModal: function showCityModal(index) {
      var _this22 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              if (!(_this22.location[index].city_id == 0)) {
                _context12.next = 5;
                break;
              }
              _this22.$bvModal.show("city-create");
              _this22.location[index].city_id = null;
              _context12.next = 10;
              break;
            case 5:
              _this22.panels[index].panel_id = null;
              _context12.next = 8;
              return _this22.getAvnue(index);
            case 8:
              _context12.next = 10;
              return _this22.getPanel(index);
            case 10:
            case "end":
    ...
    showAvenueModal: function showAvenueModal(index) {
      var _this23 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              if (!(_this23.location[index].avenue_id == 0)) {
                _context13.next = 5;
                break;
              }
              _this23.$bvModal.show("avenue-create");
              _this23.location[index].avenue_id = null;
              _context13.next = 10;
              break;
            case 5:
              _this23.panels[index].panel_id = null;
              _context13.next = 8;
              return _this23.getStreet(index);
            case 8:
              _context13.next = 10;
              return _this23.getPanel(index);
            case 10:
            case "end":
    ...
    showStreetModal: function showStreetModal(index) {
      var _this24 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              if (!(_this24.location[index].street_id == 0)) {
                _context14.next = 5;
                break;
              }
              _this24.$bvModal.show("street-create");
              _this24.location[index].street_id = null;
              _context14.next = 8;
              break;
            case 5:
              _this24.panels[index].panel_id = null;
              _context14.next = 8;
              return _this24.getPanel(index);
            case 8:
            case "end":
    ...
    showCategoryModal: function showCategoryModal(index) {
      var _this25 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15() {
        return _regeneratorRuntime().wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            case 0:
              if (!(_this25.location[index].category_id == 0)) {
                _context15.next = 5;
                break;
              }
              _this25.$bvModal.show("category-create");
              _this25.location[index].category_id = null;
              _context15.next = 8;
              break;
            case 5:
              _this25.panels[index].panel_id = null;
              _context15.next = 8;
              return _this25.getPanel(index);
            case 8:
            case "end":
    ...
    changeValuePanel: function changeValuePanel() {
      var _this26 = this;
      this.pans.forEach(function (e, index) {
        var panel_id = _this26.panels[index].panel_id;
        _this26.faceNumber = {
          'A': 0,
          'B': 0,
          'Multi': 0,
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.packagesTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_package_code")) + "\n                                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "price"
    },
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.price,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "price", $$v);
      },
      expression: "setting.price"
    }
  }, [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("boardRent_package_price")) + "\n                                        ")]), _vm._v(" "), _c("div", {
    ...
    style: {
      "pointer-events": _vm.packagesPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.packagesPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.packagesPagination.last_page == _vm.packagesPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("boardRent_package_create_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true,
      "dialog-class": "modal-full-width"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.code.$model,
      expression: "$v.create.code.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.code.$error || _vm.errors.code,
      "is-valid": !_vm.$v.create.code.$invalid && !_vm.errors.code
    },
    attrs: {
      type: "number",
      id: "field-3"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.code, "$model", $event.target.value);
      }
    }
  })]), _vm._v(" "), _vm.errors.code ? _vm._l(_vm.errors.code, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
  }) : _vm._e()], 2)]), _vm._v(" "), _c("div", {
  ...
  })]), _vm._v(" "), _vm.errors.price ? _vm._l(_vm.errors.price, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
  }) : _vm._e()], 2)])])])]), _vm._v(" "), _c("b-tab", {
    attrs: {
      title: _vm.$t("general.panel"),
      disabled: !_vm.package_id
    }
  }, [_c("div", {
    staticClass: "mb-3 d-flex justify-content-end"
  }, [!_vm.isLoader ? _c("b-button", {
    ...
    staticClass: "face-number"
  }, [_vm._v(_vm._s(_vm.faceNumber.A))])]), _vm._v(" "), _c("div", {
    staticClass: "face"
  }, [_c("span", {
    staticClass: "face-name"
  }, [_vm._v("B")]), _vm._v(" "), _c("span", {
    staticClass: "face-number"
  }, [_vm._v(_vm._s(_vm.faceNumber.B))])]), _vm._v(" "), _c("div", {
    staticClass: "face"
  }, [_c("span", {
    staticClass: "face-name"
  }, [_vm._v("Multi")]), _vm._v(" "), _c("span", {
    staticClass: "face-number"
  }, [_vm._v(_vm._s(_vm.faceNumber.Multi))])]), _vm._v(" "), _c("div", {
    staticClass: "face"
  }, [_c("span", {
    staticClass: "face-name"
  }, [_vm._v("One-Face")]), _vm._v(" "), _c("span", {
    staticClass: "face-number"
  }, [_vm._v(_vm._s(_vm.faceNumber["One-Face"]))])])])]), _vm._v(" "), _vm._l(_vm.panels, function (item, index) {
    return [_c("div", {
      key: index,
      staticClass: "row"
    }, [_c("div", {
      ...
      attrs: {
        ...
        "custom-label": function customLabel(opt) {
          return _vm.$i18n.locale == "ar" ? _vm.governorates.find(function (x) {
            return x.id == opt;
      ...
      on: {
        input: function input($event) {
          return _vm.showGovernorateModal(index);
        }
      },
      model: {
        value: _vm.location[index].governorate_id,
        callback: function callback($$v) {
          _vm.$set(_vm.location[index], "governorate_id", $$v);
        },
        expression: "location[index].governorate_id"
      }
    })], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-2"
    }, [_c("div", {
      ...
      attrs: {
        options: _vm.cities[index].cities.map(function (type) {
          return type.id;
        }),
        "custom-label": function customLabel(opt) {
          return _vm.$i18n.locale == "ar" ? _vm.cities[index].cities.find(function (x) {
            return x.id == opt;
          }).name : _vm.cities[index].cities.find(function (x) {
            return x.id == opt;
          }).name_e;
        }
      },
      on: {
        input: function input($event) {
          return _vm.showCityModal(index);
        }
      },
      model: {
        value: _vm.location[index].city_id,
        callback: function callback($$v) {
          _vm.$set(_vm.location[index], "city_id", $$v);
        },
        expression: "location[index].city_id"
      }
    })], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-2"
    }, [_c("div", {
      ...
      attrs: {
        options: _vm.avenues[index].avenues.map(function (type) {
          return type.id;
        }),
        "custom-label": function customLabel(opt) {
          return _vm.$i18n.locale == "ar" ? _vm.avenues[index].avenues.find(function (x) {
            return x.id == opt;
          }).name : _vm.avenues[index].avenues.find(function (x) {
            return x.id == opt;
          }).name_e;
        }
      },
      on: {
        input: function input($event) {
          return _vm.showAvenueModal(index);
        }
      },
      model: {
        value: _vm.location[index].avenue_id,
        callback: function callback($$v) {
          _vm.$set(_vm.location[index], "avenue_id", $$v);
        },
        expression: "location[index].avenue_id"
      }
    })], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-2"
    }, [_c("div", {
      ...
      attrs: {
        options: _vm.streets[index].streets.map(function (type) {
          return type.id;
        }),
        "custom-label": function customLabel(opt) {
          return _vm.$i18n.locale == "ar" ? _vm.streets[index].streets.find(function (x) {
            return x.id == opt;
          }).name : _vm.streets[index].streets.find(function (x) {
            return x.id == opt;
          }).name_e;
        }
      },
      on: {
        input: function input($event) {
          return _vm.showStreetModal(index);
        }
      },
      model: {
        value: _vm.location[index].street_id,
        callback: function callback($$v) {
          _vm.$set(_vm.location[index], "street_id", $$v);
        },
        expression: "location[index].street_id"
      }
    })], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-2"
    }, [_c("div", {
      ...
      attrs: {
        options: _vm.categories.map(function (type) {
          return type.id;
        }),
        "custom-label": function customLabel(opt) {
          return _vm.$i18n.locale == "ar" ? _vm.categories.find(function (x) {
            return x.id == opt;
          }).name : _vm.categories.find(function (x) {
            return x.id == opt;
          }).name_e;
        }
      },
      on: {
        input: _vm.showCategoryModal
      },
      model: {
        value: _vm.location[index].category_id,
        callback: function callback($$v) {
          _vm.$set(_vm.location[index], "category_id", $$v);
        },
        expression: "location[index].category_id"
      }
    })], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-2"
    }, [_c("div", {
      ...
      model: {
        value: _vm.location[index].face,
        callback: function callback($$v) {
          _vm.$set(_vm.location[index], "face", $$v);
        },
        expression: "location[index].face"
      }
    })], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-3"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.panel")))]), _vm._v(" "), _c("multiselect", {
      attrs: {
        options: _vm.pans[index].pans.map(function (type) {
          return type.id;
        }),
        "custom-label": function customLabel(opt) {
          return _vm.$i18n.locale == "ar" ? _vm.pans[index].pans.find(function (x) {
            return x.id == opt;
          }).name : _vm.pans[index].pans.find(function (x) {
            return x.id == opt;
          }).name_e;
        }
      },
      on: {
        input: _vm.changeValuePanel
      },
      model: {
        value: _vm.$v.panels.$each[index].panel_id.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.panels.$each[index].panel_id, "$model", $$v);
        },
        expression: "$v.panels.$each[index].panel_id.$model"
      }
    }), _vm._v(" "), _vm.$v.panels.$each[index].panel_id.$error ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                                           " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                       ")]) : _vm._e()], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-2 p-0 pt-3"
    }, [_vm.panels.length - 1 == index ? _c("button", {
      staticClass: "custom-btn-dowonload",
      attrs: {
        type: "button"
      },
      ...
      staticClass: "fas fa-plus"
    })]) : _vm._e(), _vm._v(" "), _vm.panels.length > 1 ? _c("button", {
      staticClass: "custom-btn-dowonload",
      attrs: {
        type: "button"
      },
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_package_name_ar")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.packages.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_package_name_en")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.packages.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_package_code")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.price ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_package_price")))])])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_vm._v("\n                                    " + _vm._s(_vm.$t("general.Action")) + "\n                                ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_c("i", {
    staticClass: "fas fa-ellipsis-v"
  })]) : _vm._e()])]), _vm._v(" "), _vm.packages.length > 0 ? _c("tbody", _vm._l(_vm.packages, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.code ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.code))])]) : _vm._e(), _vm._v(" "), _vm.setting.price ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.price))])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("boardRent_package_edit_form"),
        "title-class": "font-18",
        "dialog-class": "modal-full-width",
        "body-class": "p-4",
        "hide-footer": true
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.code.$model,
        expression: "$v.edit.code.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.code.$error || _vm.errors.code,
        "is-valid": !_vm.$v.edit.code.$invalid && !_vm.errors.code
      },
      attrs: {
        type: "number",
        id: "field-edit-3"
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.code, "$model", $event.target.value);
        }
      }
    })]), _vm._v(" "), _vm.errors.code ? _vm._l(_vm.errors.code, function (errorMessage, index) {
      return _c("ErrorMessage", {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.price.$model,
        expression: "$v.edit.price.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.price.$error || _vm.errors.price,
        "is-valid": !_vm.$v.edit.price.$invalid && !_vm.errors.price
      },
      attrs: {
        step: ".01",
        type: "number",
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.price, "$model", $event.target.value);
        }
      }
    })]), _vm._v(" "), _vm.errors.price ? _vm._l(_vm.errors.price, function (errorMessage, index) {
      return _c("ErrorMessage", {
    ...
    })], 2)], 1)], 1)])], 1) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("button", {
      staticClass: "btn",
      attrs: {
