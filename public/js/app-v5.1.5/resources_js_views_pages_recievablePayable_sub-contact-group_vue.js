...
/* harmony import */ var _components_create_receivablePayment_mainContactGroup__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../components/create/receivablePayment/mainContactGroup */ "./resources/js/components/create/receivablePayment/mainContactGroup.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    MainContactGroup: _components_create_receivablePayment_mainContactGroup__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
  data: function data() {
    return {
      per_page: 50,
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.subContactGroups.forEach(function (el) {
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      if (vm.$store.state.auth.work_flow_trees.includes("subContactGroup") || vm.$store.state.auth.work_flow_trees.includes("receivable payable") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
  ...
  methods: {
    ...
    showMainContactModalEdit: function showMainContactModalEdit() {
      if (this.edit.rp_main_contact_group_id == 0) {
        this.$bvModal.show("main_contact_group_create");
        this.edit.rp_main_contact_group_id = null;
      }
    },
    formatDate: function formatDate(value) {
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("recievable-payable/rp_sub_contact_group/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("recievable-payable/rp_sub_contact_group?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this4.subContactGroups = l.data;
        _this4.subContactGroupsPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this5 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      if (this.current_page <= this.subContactGroupsPagination.last_page && this.current_page != this.subContactGroupsPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i < this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("recievable-payable/rp_sub_contact_group?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&company_id=").concat(this.company_id)).then(function (res) {
          var l = res.data;
          _this5.subContactGroups = l.data;
          _this5.subContactGroupsPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("recievable-payable/rp_sub_contact_group/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this6.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("recievable-payable/rp_sub_contact_group/".concat(id)).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this8.getMainContractGroups();
            case 2:
              _context.next = 4;
              return _this8.getGlCoas();
            case 4:
              _this8.create = {
                name: "",
                name_e: "",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("recievable-payable/rp_sub_contact_group", data).then(function (res) {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        var data = {
          ...
          gl_acc_no: this.edit.gl_acc_no,
          rp_main_contact_group_id: this.edit.rp_main_contact_group_id
        };
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("recievable-payable/rp_sub_contact_group/".concat(id), data).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this12.getMainContractGroups();
            case 2:
              _context2.next = 4;
              return _this12.getGlCoas();
            case 4:
              unitStatus = _this12.subContactGroups.find(function (e) {
                return id == e.id;
              });
              _this12.edit.name = unitStatus.name;
              _this12.edit.name_e = unitStatus.name_e;
              _this12.edit.gl_acc_no = unitStatus.gl_acc_no;
              _this12.edit.rp_main_contact_group_id = unitStatus.rp_main_contact_group_id;
              _this12.errors = {};
            case 10:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("recievable-payable/rp_main_contact_group").then(function (res) {
                var l = res.data.data;
                l.unshift({
                  id: 0,
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("gl/coa").then(function (res) {
                _this14.glCoases = res.data.data;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ('SubContactGroup' + '.' || 0) + (type || 'xlsx'));
        }
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("MainContactGroup", {
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.SubcontactgroupsTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("subcontact_group_name_ar")))]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "name_e"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("subcontact_group_name_en")))])], 1)], 1), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("subcontact_group_name_ar")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.main_group_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "main_group_id", $$v);
      },
      expression: "setting.main_group_id"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("main_contact_group")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.acc_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "acc_id", $$v);
      },
      expression: "setting.acc_id"
    }
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.subContactGroupsPagination.from) + "-" + _vm._s(_vm.subContactGroupsPagination.to) + "\n                    /\n                    " + _vm._s(_vm.subContactGroupsPagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.subContactGroupsPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.subContactGroupsPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.subContactGroupsPagination.last_page == _vm.subContactGroupsPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("subcontact_group_name_ar")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.subContactGroups.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("subcontact_group_name_en")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.subContactGroups.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.main_group_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("main_contact_group")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.acc_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("gl_coa_acc")))])])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("general.Action")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_c("i", {
    staticClass: "fas fa-ellipsis-v"
  })]) : _vm._e()])]), _vm._v(" "), _vm.subContactGroups.length > 0 ? _c("tbody", _vm._l(_vm.subContactGroups, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.main_group_id ? _c("td", [_vm._v("\n                    " + _vm._s(_vm.$i18n.locale == "ar" ? data.mainContactGroup.name : data.mainContactGroup.name_e) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.acc_id ? _c("td", [_vm._v("\n                    " + _vm._s(_vm.$i18n.locale == "ar" ? data.glAccount.name : data.glAccount.name_e) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("subcontact_group_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      on: {
        input: _vm.showMainContactModalEdit
      },
      model: {
        value: _vm.edit.rp_main_contact_group_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "rp_main_contact_group_id", $$v);
        },
        expression: "edit.rp_main_contact_group_id"
      }
    }), _vm._v(" "), _vm.$v.edit.rp_main_contact_group_id.$error || _vm.errors.rp_main_contact_group_id ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.rp_main_contact_group_id ? _vm._l(_vm.errors.rp_main_contact_group_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      model: {
        value: _vm.edit.gl_acc_no,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "gl_acc_no", $$v);
        },
        expression: "edit.gl_acc_no"
      }
    }), _vm._v(" "), _vm.$v.edit.gl_acc_no.$error || _vm.errors.gl_acc_no ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.gl_acc_no ? _vm._l(_vm.errors.gl_acc_no, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
