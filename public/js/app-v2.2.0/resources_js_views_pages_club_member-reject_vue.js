          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                _context8.next = 4;
                return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/members?limet=10&company_id=".concat(_this18.company_id, "&search=").concat(search, "&columns[0]=first_name&columns[1]=second_name&columns[2]=third_name&columns[3]=last_name&columns[4]=family_name&columns[5]=national_id&columns[6]=membership_number&columns[7]=full_name")).then(function (res) {
                  var l = res.data.data;
                  _this18.members = l;
                })["catch"](function (err) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _vm.isVisible("session_number")
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  _vm.isVisible("cm_member_type_id")
                                    ? _c(
                                        "b-form-checkbox",
                                        {
                                          staticClass: "mb-1",
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("multiselect", {
                                    class: {
                                      "is-invalid":
                                        _vm.$v.create.cm_member_type_id
                                          .$error ||
                                        _vm.errors.cm_member_type_id,
                                    },
                                    attrs: {
                                  ...
                                  _vm._v(" "),
                                  !_vm.$v.create.cm_member_type_id.required
                                    ? _c(
                                        "div",
                                        { staticClass: "invalid-feedback" },
                                        [
