...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    resetModalEdit: function resetModalEdit(id) {
      ...
      this.edit.calculated_percentage = sellMethods.calculated_percentage;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-model",
                                  value:
                                    _vm.$v.create.calculated_percentage.$model,
                                  expression:
                                    "$v.create.calculated_percentage.$model",
                                },
                              ],
                              staticClass: "form-control",
                              class: {
                                                                ...
                                                                directives: [
                                                                  {
                                                                    ...
                                                                    value:
                                                                      _vm.$v
                                                                        ...
                                                                        .$model,
                                                                    expression:
                                                                      "\n                                  $v.edit.calculated_percentage.$model\n                                ",
                                                                  },
                                                                ],
                                                                staticClass:
                                                                  "form-control",
