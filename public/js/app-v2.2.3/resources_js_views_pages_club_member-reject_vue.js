...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                                                " + _vm._s(_vm.getCompanyKey("member_reject_session_number")) + "\n                                            ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("discharge_reson_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.discharge_reson_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "discharge_reson_id", $$v);
      },
      expression: "setting.discharge_reson_id"
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("discharge_reson_id") ? _c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", [_vm._v(_vm._s(_vm.getCompanyKey("member_reject_reason")))]), _vm._v(" "), _c("multiselect", {
    "class": {
      "is-invalid": _vm.$v.create.discharge_reson_id.$error || _vm.errors.discharge_reson_id
    },
    attrs: {
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.create, "discharge_reson_id", $$v);
      },
      expression: "create.discharge_reson_id"
    }
  }), _vm._v(" "), !_vm.$v.create.discharge_reson_id.required ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v("\n                                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                            ")]) : _vm._e(), _vm._v(" "), _vm.errors.discharge_reson_id ? _vm._l(_vm.errors.discharge_reson_id, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                                                ")]);
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.discharge_reson_id && _vm.isVisible("discharge_reson_id") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    on: {
      click: function click($event) {
        _vm.transactions.sort(_vm.sortString("discharge_reson_id"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
