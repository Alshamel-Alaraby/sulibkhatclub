        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this.isCustom = true;
              _context.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/cm_statues").then(function (res) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    filterSearch: function filterSearch(fields) {
      var indexC = fields.indexOf("member_type_id"),
        filter = '';
      if (indexC > -1) {
  ...
  return _c("div", [_c("b-modal", {
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.member_type_id, "$model", $$v);
      },
      expression: "$v.create.member_type_id.$model"
    }
  }), _vm._v(" "), _vm.$v.create.member_type_id.$error || _vm.errors.member_type_id ? _c("div", {
    staticClass: "text-danger"
