  ...
  methods: {
    ...
    getData: function getData() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/transactions/member-transaction-paid-after-date?date=".concat(this.create.date, "&year=").concat(this.create.year, "&page=").concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.$v.create.$invalid) {
        ...
        if (this.current_page <= this.installmentStatusPagination.last_page && this.current_page != this.installmentStatusPagination.current_page && this.current_page) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/transactions/member-transaction-paid-after-date?date=".concat(this.create.date, "&year=").concat(this.create.year, "&page=").concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
            var l = res.data;
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    }, [_c("td", [_vm._v("\n                                    " + _vm._s(data.member ? data.member.membership_number : "-") + "\n                                ")]), _vm._v(" "), _c("td", [_vm._v("\n                                    " + _vm._s(data.member ? _vm.formatDate(data.member.membership_date) : "-") + "\n                                ")]), _vm._v(" "), _c("td", [_c("h5", {
