...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.start_date, "$model", $event.target.value);
      }
    }
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.end_date, "$model", $event.target.value);
      }
    }
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.type")))])])])])]), _vm._v(" "), _vm.installmentStatus.length > 0 ? _c("tbody", _vm._l(_vm.installmentStatus, function (data, index) {
    return _c("tr", {
      key: data.id,
      staticClass: "body-tr-custom"
    }, [_c("td", [_vm._v("\n                                    " + _vm._s(data.date) + "\n                                ")]), _vm._v(" "), _c("td", [_vm._v("\n                                    " + _vm._s(data.document_no) + "\n                                ")]), _vm._v(" "), _c("td", [_vm._v("\n                                    " + _vm._s(data.serial_id) + "\n                                ")]), _vm._v(" "), _c("td", [_c("h5", {
