(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_hr_hr_vacation_balance_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  page: {
    title: "HR Vacation balance",
    meta: [{
      name: "description",
      content: "HR vacation balance"
    }]
  },
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.vacations.forEach(function (el) {
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_3__["default"])(vm, "Vacation Balance", "all vacationsBalances hr");
    });
  },
  methods: {
    ...
    log: function log(id) {
      ...
      //     this.mouseEnter = id;
      //     adminApi
      //       .get(`/hr/vacation-balance/getAll/logs/${id}`)
      //       .then((res) => {
      //         let l = res.data.data;
      //         l.forEach((e) => {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/hr/vacation-balance/getAll?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this3.vacations = l.data;
        _this3.vacationsPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this4 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      if (this.current_page <= this.vacationsPagination.last_page && this.current_page != this.vacationsPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        var _filterSetting = _toConsumableArray(this.filterSetting);
        var index = this.filterSetting.indexOf("employee");
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/hr/vacation-balance/getAll?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&company_id=").concat(this.company_id)).then(function (res) {
          var l = res.data;
          _this4.vacations = l.data;
          _this4.vacationsPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/hr/vacation-balance/getAll/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this5.checkAll = [];
              _this5.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            _this5.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/hr/vacation-balance/getAll/".concat(id)).then(function (res) {
              _this5.checkAll = [];
              _this5.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/hr/vacation-balance/getAll", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/hr/vacation-balance/getAll/".concat(id), this.edit).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      var vacations = this.vacations.find(function (e) {
        return id == e.id;
      });
      this.edit.employee = this.$i18n.locale == "ar" ? vacations.employee.name : vacations.employee.name_e;
      this.edit.date = vacations.date;
      this.edit.days = vacations.days;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=template&id=0f28e034&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=template&id=0f28e034& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n              " + _vm._s(_vm.$t("general.vacationBalanceTable")) + "\n            ")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.getCompanyKey("vacation_balance_days")) + "\n                  ")])], 1)], 1), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("vacation_balance_date")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.days,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "days", $$v);
      },
      expression: "setting.days"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("vacation_balance_days")) + "\n                    ")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.vacationsPagination.from) + "-" + _vm._s(_vm.vacationsPagination.to) + "\n                    /\n                    " + _vm._s(_vm.vacationsPagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.vacationsPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.vacationsPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.vacationsPagination.last_page == _vm.vacationsPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    on: {
      click: function click($event) {
        _vm.vacations.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("vacation_balance_date")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.vacations.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.days ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("vacation_balance_days")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.vacations.length > 0 ? _c("tbody", _vm._l(_vm.vacations, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.date))])]) : _vm._e(), _vm._v(" "), _vm.setting.days ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("vacation_balance_view_form"),
        "title-class": "font-18",
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.edit, "days", $event.target.value);
        }
      }
...
/***/ "./resources/js/views/pages/hr/hr_vacation_balance.vue":
/*!*************************************************************!*\
  !*** ./resources/js/views/pages/hr/hr_vacation_balance.vue ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _hr_vacation_balance_vue_vue_type_template_id_0f28e034___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hr_vacation_balance.vue?vue&type=template&id=0f28e034& */ "./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=template&id=0f28e034&");
/* harmony import */ var _hr_vacation_balance_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hr_vacation_balance.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _hr_vacation_balance_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _hr_vacation_balance_vue_vue_type_template_id_0f28e034___WEBPACK_IMPORTED_MODULE_0__.render,
  _hr_vacation_balance_vue_vue_type_template_id_0f28e034___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/hr/hr_vacation_balance.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=script&lang=js&":
/*!**************************************************************************************!*\
  !*** ./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_vacation_balance_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./hr_vacation_balance.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_vacation_balance_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=template&id=0f28e034&":
/*!********************************************************************************************!*\
  !*** ./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=template&id=0f28e034& ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_vacation_balance_vue_vue_type_template_id_0f28e034___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_vacation_balance_vue_vue_type_template_id_0f28e034___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_vacation_balance_vue_vue_type_template_id_0f28e034___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./hr_vacation_balance.vue?vue&type=template&id=0f28e034& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_vacation_balance.vue?vue&type=template&id=0f28e034&");
