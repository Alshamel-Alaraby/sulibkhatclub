...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getBranch: function getBranch() {
      var _this9 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/branches?company_id=".concat(this.company_id, "&notParent=1")).then(function (res) {
        var l = res.data.data;
    ...
    getPeriod: function getPeriod() {
      var _this10 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/restart-period").then(function (res) {
        var l = res.data.data;
        _this10.types = l;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
