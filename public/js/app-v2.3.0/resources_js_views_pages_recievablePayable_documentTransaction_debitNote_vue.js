  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this8.getBranches();
            case 2:
              _context2.next = 4;
              return _this8.getSalesmen();
            case 4:
              _context2.next = 6;
              return _this8.getPaymentMethod();
            case 6:
              _context2.next = 8;
              return _this8.resetModalHidden();
            case 8:
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid && !this.financial_years_validate) {
        ...
        this.errors = {};
        this.is_disabled = false;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("voucher-headers", _objectSpread({}, this.create)).then(function (res) {
          _this9.getData();
          _this9.invoice_id = res.data.data.id;
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid && !this.financial_years_validate) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].put("voucher-headers/".concat(id), _objectSpread({}, this.edit)).then(function (res) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/branches?document_id=".concat(_this11.document_id)).then(function (res) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 4;
              return _this13.getCustomers(employee_id);
            case 4:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 5;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/general-customer?limet=10&company_id=".concat(_this14.company_id, "&employee_id=").concat(employee_id, "&search=").concat(search, "&columns[0]=name&columns[1]=name_e&columns[2]=id")).then(function (res) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/payment-methods").then(function (res) {
                _this15.isLoader = false;
                var l = res.data.data;
                _this15.paymentMethods = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/recievable-payable/document-with-money-details?customer_id=".concat(id)).then(function (res) {
                _this16.isLoader = false;
                var l = res.data.data;
                l.forEach(function (e) {
                  _this16.customerBreak.push({
                    id: e.id,
                    break_type: e.break_type,
                    document: e.document,
                    amount: parseInt(e.total),
                    instalment_date: e.instalment_date,
                    salesman: _this16.handelSalesman(e),
                    serial_number: _this16.handelSerial(e),
                    amount_status: e.amount_status
                  });
                });
                _this16.accountTotalAmount();
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              _this17.customerBreak = [];
              _this17.breakTransactions = [];
              _this17.totalOrderAmount = 0;
              _this17.totalTransferAmount = 0;
              _this17.openTransfer = false;
              _this17.amountPaid = 0;
              _this17.remainingAmount = 0;
              _this17.amount = 0;
              invoice = _this17.invoices.find(function (e) {
                return id == e.id;
              });
              _this17.serial_number = invoice.prefix;
              _this17.invoice_id = invoice.id;
              _context9.next = 13;
              return _this17.getCustomers(invoice.salesmen_id);
            case 13:
              _context9.next = 15;
              return _this17.getSalesmen();
            case 15:
              _context9.next = 17;
              return _this17.getPaymentMethod();
            case 17:
              _context9.next = 19;
              return _this17.getBranches();
            case 19:
              _this17.edit.date = invoice.date;
              _this17.edit.customer_id = invoice.customer_id;
              _this17.edit.salesmen_id = invoice.salesmen_id;
              _this17.edit.payment_method_id = invoice.payment_method_id;
              _this17.edit.branch_id = invoice.branch_id;
              _this17.edit.document_id = invoice.document_id;
              _this17.edit.amount = invoice.amount;
              if (!(_this17.document && _this17.document.attributes && _this17.parseInt(document.attributes.customer) == -1)) {
                _context9.next = 32;
                break;
              }
              _context9.next = 29;
              return _this17.getBreakCustomer(_this17.edit.customer_id);
            case 29:
              _context9.next = 31;
              return _this17.getTransactions(id);
            case 31:
              _this17.amount = _this17.totalTransferAmount;
            case 32:
              _this17.errors = {};
            case 33:
            case "end":
    ...
    getSerialNumber: function getSerialNumber() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        var type, e, date, shortYear, twoDigitYear, branch, serial;
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              type = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : 'create';
              e = _arguments2.length > 1 ? _arguments2[1] : undefined;
              date = type == 'create' ? _this20.create.date : _this20.edit.date;
              shortYear = new Date(date).getFullYear();
              twoDigitYear = shortYear.toString().substr(-2);
              branch = _this20.branches.find(function (row) {
                return e == row.id;
              });
              serial = branch.serials.find(function (row) {
                return _this20.document_id == row.document_id;
              });
              _this20.serial_number = "".concat(twoDigitYear, "-").concat(branch.id, "-").concat(_this20.document_id, "-").concat(serial.perfix);
            case 8:
            case "end":
    ...
    changeDateDocument: function changeDateDocument() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
        var type, date, branch_id;
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              type = _arguments3.length > 0 && _arguments3[0] !== undefined ? _arguments3[0] : 'create';
              date = type == 'create' ? _this21.create.date : _this21.edit.date;
              branch_id = type == 'create' ? _this21.create.branch_id : _this21.edit.branch_id;
              _context11.next = 5;
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              ...
              _context12.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/document-headers/check-date?date=".concat(date)).then(function (res) {
                var l = res.data;
                if (!l) {
                  ...
                  _this22.serial_number = "".concat(twoDigitYear, "-").concat(branch.id, "-").concat(_this22.document_id, "-").concat(branch.serials[0].perfix);
                }
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              ...
              clearTimeout(_this23.debounce);
              _this23.debounce = setTimeout(function () {
                _this23.getCustomers(_this23.create.employee_id, search);
              }, 500);
            case 3:
            case "end":
    ...
    searchCustomerEdit: function searchCustomerEdit(e) {
      var _this24 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
        ...
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              search = e !== null && e !== void 0 ? e : '';
              clearTimeout(_this24.debounce);
              _this24.debounce = setTimeout(function () {
                _this24.getCustomers(_this24.edit.employee_id, search);
              }, 500);
            case 3:
            case "end":
    ...
    ReturnTransactionToOrder: function ReturnTransactionToOrder(index) {
      ...
      orderReturn = this.customerBreak.find(function (e) {
        return e.id == _this25.breakTransactions[index].id;
      });
      if (orderReturn) {
    ...
    accountTotalAmount: function accountTotalAmount() {
      ...
      this.totalOrderAmount = 0;
      this.customerBreak.forEach(function (el, index) {
        _this26.totalOrderAmount += parseInt(el.amount);
      });

      //account total amount transfer order
      this.totalTransferAmount = 0;
      this.breakTransactions.forEach(function (el, index) {
        _this26.totalTransferAmount += parseInt(el.amount);
      });
    },
    // change Status Transfer open or close
    changeStatusTransfer: function changeStatusTransfer(event) {
      var amount = 0;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_3__["default"])(vm, "Depit Note RP", "all creditNote RP");
    });
  }
});
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    attrs: {
      ...
      id: "create",
      title: _vm.titleModelName("create"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
    ...
    staticClass: "form-group"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.paymentMethod")))]), _vm._v(" "), _c("multiselect", {
    "class": {
  ...
  }) : _vm._e()], 2)]), _vm._v(" "), _vm.document && _vm.document.attributes && parseInt(_vm.document.attributes.customer) == -1 ? _c("div", {
  ...
  }, [_c("thead", [_c("tr", [_c("th", [_vm._v(_vm._s(_vm.$t("general.invoiceSerial")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.salesmen")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.type")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.Date")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.amount")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.Action")))])])]), _vm._v(" "), _vm.customerBreak.length > 0 ? _c("tbody", [_vm._l(_vm.customerBreak, function (data, index) {
    return _c("tr", {
      key: data.id,
      staticClass: "body-tr-custom"
    }, [_c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.serial_number))])]), _vm._v(" "), _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.salesman))])]), _vm._v(" "), _c("td", [data.document ? _c("h5", {
      staticClass: "m-0 font-weight-normal"
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.amount))])]), _vm._v(" "), _vm.openTransfer ? _c("td", [_c("button", {
      staticClass: "btn btn-primary btn-sm",
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.orderTransferToTransaction(index);
        }
      }
  ...
  }), _vm._v(" "), _vm.customerBreak.length > 0 ? _c("tr", {
    staticClass: "total-amount"
  }, [_c("td"), _vm._v(" "), _c("td"), _vm._v(" "), _c("td"), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.$t("general.totalAmount")))]), _vm._v(" "), _c("td", {
    staticClass: "amount-red",
    domProps: {
      innerHTML: _vm._s(_vm.totalOrderAmount)
    }
  }), _vm._v(" "), _c("td")]) : _vm._e()], 2) : _c("tbody", [_c("tr", [_c("th", {
    ...
    staticClass: "card-title float-left"
  }, [_vm._v("\n                                                                            " + _vm._s(_vm.$t("general.transactions")) + "\n                                                                        ")])]), _vm._v(" "), _c("div", {
    staticClass: "table-responsive mb-3 custom-table-theme position-relative"
  }, [_vm.isLoader ? _c("loader", {
    attrs: {
      size: "large"
    ...
    staticClass: "table table-borderless table-hover table-centered m-0"
  }, [_c("thead", [_c("tr", [_c("th", [_vm._v(_vm._s(_vm.$t("general.invoiceSerial")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.salesmen")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.type")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.Date")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.amount")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.Action")))])])]), _vm._v(" "), _vm.breakTransactions.length > 0 ? _c("tbody", [_vm._l(_vm.breakTransactions, function (data, index) {
    return _c("tr", {
      key: data.id,
      staticClass: "body-tr-custom"
    }, [_c("td", [_c("h5", {
      ...
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.ReturnTransactionToOrder(index);
        }
      }
    }, [_vm._v("<<")])]) : _c("td", [_c("button", {
      staticClass: "btn btn-secondary btn-sm",
  ...
  }), _vm._v(" "), _vm.breakTransactions.length > 0 ? _c("tr", {
    staticClass: "total-amount"
  }, [_c("td"), _vm._v(" "), _c("td"), _vm._v(" "), _c("td"), _vm._v(" "), _c("td", [_c("h5", {
    staticClass: "m-0 font-weight-normal"
  }, [_vm._v(_vm._s(_vm.$t("general.totalAmount")))])]), _vm._v(" "), _c("td", {
    staticClass: "amount-red",
    domProps: {
      innerHTML: _vm._s(_vm.totalTransferAmount)
    }
  }), _vm._v(" "), _c("td")]) : _vm._e()], 2) : _c("tbody", [_c("tr", [_c("th", {
    staticClass: "text-center",
    attrs: {
    ...
    staticClass: "col-md-6"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.TheDifference")))]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "form-control mb-1 input-Sender",
    attrs: {
      type: "text",
      disabled: ""
    },
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.documentCustomer")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    return _c("tr", {
      ...
      attrs: {
        ...
        title: _vm.$t("general.editReceiptVoucher"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      "class": {
        "is-invalid": _vm.$v.edit.branch_id.$error || _vm.errors.branch_id
      },
      attrs: {
        options: _vm.branches.map(function (type) {
          return type.id;
      ...
      on: {
        input: function input($event) {
          return _vm.getSerialNumber("edit", $event);
        }
      },
      model: {
        value: _vm.edit.branch_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "branch_id", $$v);
        },
        expression: "edit.branch_id"
      }
    }), _vm._v(" "), !_vm.$v.edit.branch_id.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                            ")]) : _vm._e(), _vm._v(" "), _vm.errors.branch_id ? _vm._l(_vm.errors.branch_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      on: {
        input: function input($event) {
          return _vm.changeDateDocument("edit");
        }
      },
      model: {
        value: _vm.edit.date,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "date", $$v);
        },
      ...
      "class": {
        "is-invalid": _vm.$v.edit.salesmen_id.$error || _vm.errors.salesmen_id
      },
      attrs: {
        disabled: !_vm.edit.branch_id,
        options: _vm.salesmen.map(function (type) {
      ...
      model: {
        value: _vm.edit.salesmen_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "salesmen_id", $$v);
        },
        expression: "edit.salesmen_id"
      }
    }), _vm._v(" "), !_vm.$v.edit.salesmen_id.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                            ")]) : _vm._e(), _vm._v(" "), _vm.errors.salesmen_id ? _vm._l(_vm.errors.salesmen_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      "class": {
        "is-invalid": _vm.$v.edit.customer_id.$error || _vm.errors.customer_id
      },
      attrs: {
        disabled: !_vm.edit.branch_id,
        internalSearch: false,
      ...
      model: {
        value: _vm.edit.customer_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "customer_id", $$v);
        },
        expression: "edit.customer_id"
      }
    }), _vm._v(" "), !_vm.$v.edit.customer_id.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                            ")]) : _vm._e(), _vm._v(" "), _vm.errors.customer_id ? _vm._l(_vm.errors.customer_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      "class": {
        "is-invalid": _vm.$v.edit.payment_method_id.$error || _vm.errors.payment_method_id
      },
      attrs: {
        disabled: !_vm.edit.branch_id,
        options: _vm.paymentMethods.map(function (type) {
      ...
      model: {
        value: _vm.edit.payment_method_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "payment_method_id", $$v);
        },
        expression: "edit.payment_method_id"
      }
    }), _vm._v(" "), !_vm.$v.edit.payment_method_id.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                            ")]) : _vm._e(), _vm._v(" "), _vm.errors.payment_method_id ? _vm._l(_vm.errors.payment_method_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
    ...
    }), _vm._v(" "), !_vm.$v.edit.amount.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                            ")]) : _vm._e(), _vm._v(" "), _vm.errors.amount ? _vm._l(_vm.errors.amount, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
