        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/members?sponsor_id=".concat(_this19.create.sponsor_id, "&hasTransaction=1&member_status_id=1&without=").concat(_this19.removeMembers, "&limet=10&company_id=").concat(_this19.company_id, "&search=").concat(search, "&columns[0]=national_id&columns[1]=membership_number&columns[2]=full_name")).then(function (res) {
                var l = res.data.data;
                _this19.members = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/memberships-renewals?date_search=".concat(_this21.create.date)).then(function (res) {
                var l = res.data.data;
                _this21.renewal = l;
                if (_this21.renewal.length > 0) {
                  _this21.create.date_from = _this21.renewal[0].from;
                  _this21.create.date_to = _this21.renewal[0].to;
                }
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              member_name = member.first_name + ' ' + member.second_name + ' ' + member.third_name + ' ' + member.last_name;
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _vm.dataInv ? _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("sponsor")))]), _vm._v(" "), _vm.isVisible("cm_member_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "cm_member_id"
    },
  ...
  }, [_vm.isVisible("sponsor_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.serial_number && _vm.isVisible("serial_number") ? _c("td", [_vm._v("\n                                         " + _vm._s(_vm.$t("general.serial_number")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.cm_member_id && _vm.isVisible("cm_member_id") ? _c("td", [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("member")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.amount && _vm.isVisible("amount") ? _c("td", [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("subscription_amount")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.type && _vm.isVisible("type") ? _c("td", [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("subscription_type")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.year_from && _vm.isVisible("year_from") ? _c("td", [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("year_from")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.year_to && _vm.isVisible("year_to") ? _c("td", [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("year_to")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.number_of_years && _vm.isVisible("number_of_years") ? _c("td", [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("number_of_years")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.sponsor_id && _vm.isVisible("sponsor_id") ? _c("th", [_c("div", {
    ...
    on: {
      click: function click($event) {
        _vm.transactions.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.number_of_years))])]) : _vm._e(), _vm._v(" "), _vm.setting.sponsor_id && _vm.isVisible("sponsor_id") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
