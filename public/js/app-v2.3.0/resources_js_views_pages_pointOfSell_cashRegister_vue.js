(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_pointOfSell_cashRegister_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.unitStatuses.forEach(function (el) {
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_0__["default"])(vm, "POS Cash Register", "all POS Cash Register");
    });
  },
  methods: {
    ...
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/customTable/table-columns/pos_cash_registers").then(function (res) {
    ...
    arabicValue: function arabicValue(txt) {
      this.create.title = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.arabicValue)(txt);
      this.edit.title = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.arabicValue)(txt);
    },
    englishValue: function englishValue(txt) {
      this.create.title_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.englishValue)(txt);
      this.edit.title_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.englishValue)(txt);
    },
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("point-of-sale/cash-register/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("point-of-sale/cash-register?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this5.unitStatuses = l.data;
        _this5.unitStatusPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this6 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      if (this.current_page <= this.unitStatusPagination.last_page && this.current_page != this.unitStatusPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i < this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("point-of-sale/cash-register?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&company_id=").concat(this.company_id)).then(function (res) {
          var l = res.data;
          _this6.unitStatuses = l.data;
          _this6.unitStatusPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("point-of-sale/cash-register/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            _this7.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"]("point-of-sale/cash-register/".concat(id)).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                icon: "success",
    ...
    getCreateBy: function getCreateBy() {
      var created_by = this.$store.state.auth.type == 'admin' ? this.$store.state.auth.partner ? this.$store.state.auth.partner.name : this.$store.state.auth.partner.name_e : this.$store.state.auth.user ? this.$store.state.auth.user.name : this.$store.state.auth.user.name_e;
      return created_by;
    },
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("point-of-sale/cash-register", _objectSpread(_objectSpread({}, data), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("point-of-sale/cash-register/".concat(id), data).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              unitStatus = _this13.unitStatuses.find(function (e) {
                return id == e.id;
              });
              _this13.edit.title = unitStatus.title;
              _this13.edit.title_e = unitStatus.title_e;
              _this13.edit.branch_id = unitStatus.branch_id;
              _this13.edit.multiple_access = unitStatus.multiple_access;
              _this13.errors = {};
            case 9:
            case "end":
              return _context.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/branches?company_id=".concat(_this14.company_id, "&notParent=1")).then(function (res) {
                var l = res.data.data;
                _this14.branches = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ('cash-register' + '.' || 0) + (type || 'xlsx'));
        }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=template&id=1b56c2f6&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=template&id=1b56c2f6& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.CashRegisterTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm.isVisible("title") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "title"
    },
  ...
  }, [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("customer_groups_title_ar")) + "\n                                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("title_e") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "title_e"
    },
  ...
  }, [_vm._v("\n                                        " + _vm._s(_vm.getCompanyKey("customer_groups_title_en")) + "\n                                    ")]) : _vm._e()], 1)], 1), _vm._v(" "), _c("div", {
  ...
  }, [_vm.isPermission("create document status") ? _c("b-button", {
    directives: [{
      name: "b-modal",
  ...
  })]), _vm._v(" "), _vm.checkAll.length == 1 && _vm.isPermission("update document status") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
  ...
  })]) : _vm._e(), _vm._v(" "), _vm.checkAll.length > 1 && _vm.isPermission("delete document status") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
        $event.preventDefault();
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "title", $$v);
      },
      expression: "setting.title"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("customer_groups_title_ar")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("title_e") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.title_e,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "title_e", $$v);
      },
      expression: "setting.title_e"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("customer_groups_title_en")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("branch_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_branch")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("multiple_access") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.multiple_access,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "multiple_access", $$v);
      },
      expression: "setting.multiple_access"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_multiple_access")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("created_by") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.created_by,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "created_by", $$v);
      },
      expression: "setting.created_by"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_created_by")))]) : _vm._e(), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                                        " + _vm._s(_vm.unitStatusPagination.from) + "-" + _vm._s(_vm.unitStatusPagination.to) + " /\n                                        " + _vm._s(_vm.unitStatusPagination.total) + "\n                                    ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.unitStatusPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.unitStatusPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.unitStatusPagination.last_page == _vm.unitStatusPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("cash_register_create_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
    ...
    staticClass: "mr-2"
  }, [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("cash_register_branch")) + "\n                                            "), _vm.isRequired("branch_id") ? _c("span", {
    staticClass: "text-danger"
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("title") ? _c("div", {
    staticClass: "col-md-12"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    staticClass: "control-label"
  }, [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("cash_register_title_ar")) + "\n                                            "), _vm.isRequired("title") ? _c("span", {
    staticClass: "text-danger"
    ...
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.title.$error || _vm.errors.title,
      "is-valid": !_vm.$v.create.title.$invalid && !_vm.errors.title
    },
    attrs: {
      type: "text",
      "data-create": "1"
    ...
    on: {
      ...
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.title, "$model", $event.target.value);
      }
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("title_e") ? _c("div", {
    staticClass: "col-md-12"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    staticClass: "control-label"
  }, [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("cash_register_title_en")) + "\n                                            "), _vm.isRequired("title_e") ? _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _c("div", {
    attrs: {
      dir: "ltr"
    ...
    "class": {
      "is-invalid": _vm.$v.create.title_e.$error || _vm.errors.title_e,
      "is-valid": !_vm.$v.create.title_e.$invalid && !_vm.errors.title_e
    },
    attrs: {
      type: "text",
      "data-create": "2"
    ...
    on: {
      ...
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.title_e, "$model", $event.target.value);
      }
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("multiple_access") ? _c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    staticClass: "mr-2"
  }, [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("cash_register_multiple_access")) + "\n                                            "), _vm.isRequired("multiple_access") ? _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _c("b-form-group", {
    "class": {
      "is-invalid": _vm.$v.create.multiple_access.$error || _vm.errors.multiple_access,
      "is-valid": !_vm.$v.create.multiple_access.$invalid && !_vm.errors.multiple_access
    }
  }, [_c("b-form-radio", {
    staticClass: "d-inline-block",
    attrs: {
    ...
    model: {
      value: _vm.$v.create.multiple_access.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.multiple_access, "$model", $$v);
      },
      expression: "$v.create.multiple_access.$model"
    }
  ...
  }, [_vm._v("\n                                                " + _vm._s(_vm.$t("general.No")) + "\n                                            ")])], 1), _vm._v(" "), _vm.errors.multiple_access ? _vm._l(_vm.errors.multiple_access, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.title && _vm.isVisible("title") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_title_ar")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.unitStatuses.sort(_vm.sortString("title"));
      }
    }
  }), _vm._v(" "), _c("i", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.title_e && _vm.isVisible("title_e") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_title_en")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.unitStatuses.sort(_vm.sortString("title_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_branch")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.unitStatuses.sort(_vm.sortString("discount"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.multiple_access && _vm.isVisible("multiple_access") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_multiple_access")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.unitStatuses.sort(_vm.sortString("multiple_access"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.created_by && _vm.isVisible("created_by") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("cash_register_created_by")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.unitStatuses.sort(_vm.sortString("created_by"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.unitStatuses.length > 0 ? _c("tbody", _vm._l(_vm.unitStatuses, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      on: {
        ...
        dblclick: function dblclick($event) {
          $event.preventDefault();
          _vm.isPermission("update document status") ? _vm.$bvModal.show("modal-edit-".concat(data.id)) : false;
        }
      }
    }, [_vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.title && _vm.isVisible("title") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.title))])]) : _vm._e(), _vm._v(" "), _vm.setting.title_e && _vm.isVisible("title_e") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.title_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.branch_id && _vm.isVisible("branch_id") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                        " + _vm._s(data.branch ? _vm.$i18n.locale == "ar" ? data.branch.name : data.branch.name_e : " - ") + "\n                                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.multiple_access && _vm.isVisible("multiple_access") ? _c("td", [_c("span", {
      "class": [data.multiple_access == 1 ? "text-success" : "text-danger", "badge"]
    }, [_vm._v("\n                                        " + _vm._s(data.multiple_access == 1 ? "".concat(_vm.$t("general.Yes")) : "".concat(_vm.$t("general.No"))) + "\n                                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.created_by && _vm.isVisible("created_by") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.created_by))])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
    ...
    }, [_vm.isPermission("update document status") ? _c("a", {
      staticClass: "dropdown-item",
      attrs: {
        href: "#"
      },
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.isPermission("delete document status") ? _c("a", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("cash_register_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.title.$model,
        expression: "$v.edit.title.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.title.$error || _vm.errors.title,
        "is-valid": !_vm.$v.edit.title.$invalid && !_vm.errors.title
      },
      attrs: {
        type: "text",
        "data-edit": "1"
      ...
      on: {
        keyup: function keyup($event) {
          return _vm.arabicValue(_vm.edit.title);
        },
        keypress: function keypress($event) {
          if (!$event.type.indexOf("key") && _vm._k($event.keyCode, "enter", 13, $event.key, "Enter")) return null;
        ...
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.title, "$model", $event.target.value);
        }
      }
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.title_e.$model,
        expression: "$v.edit.title_e.$model"
      }],
      staticClass: "form-control englishInput",
      "class": {
        "is-invalid": _vm.$v.edit.title_e.$error || _vm.errors.title_e,
        "is-valid": !_vm.$v.edit.title_e.$invalid && !_vm.errors.title_e
      },
      attrs: {
        type: "text",
        "data-edit": "2"
      ...
      on: {
        keyup: function keyup($event) {
          return _vm.englishValue(_vm.edit.title_e);
        },
        keypress: function keypress($event) {
          if (!$event.type.indexOf("key") && _vm._k($event.keyCode, "enter", 13, $event.key, "Enter")) return null;
          return _vm.moveInput("select", "edit", 3);
        },
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.title_e, "$model", $event.target.value);
        }
      }
      ...
      "class": {
        "is-invalid": _vm.$v.edit.multiple_access.$error || _vm.errors.multiple_access,
        "is-valid": !_vm.$v.edit.multiple_access.$invalid && !_vm.errors.multiple_access
      }
    }, [_c("b-form-radio", {
      staticClass: "d-inline-block",
      attrs: {
        name: "edit_def_some-radios",
        value: "1"
      },
      model: {
        value: _vm.$v.edit.multiple_access.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.multiple_access, "$model", $$v);
        },
        expression: "$v.edit.multiple_access.$model"
      }
    }, [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.Yes")) + "\n                                                            ")]), _vm._v(" "), _c("b-form-radio", {
      staticClass: "d-inline-block m-1",
      attrs: {
...
/***/ "./resources/js/views/pages/pointOfSell/cashRegister.vue":
/*!***************************************************************!*\
  !*** ./resources/js/views/pages/pointOfSell/cashRegister.vue ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _cashRegister_vue_vue_type_template_id_1b56c2f6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cashRegister.vue?vue&type=template&id=1b56c2f6& */ "./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=template&id=1b56c2f6&");
/* harmony import */ var _cashRegister_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cashRegister.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _cashRegister_vue_vue_type_template_id_1b56c2f6___WEBPACK_IMPORTED_MODULE_0__.render,
  _cashRegister_vue_vue_type_template_id_1b56c2f6___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/pointOfSell/cashRegister.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=script&lang=js&":
/*!****************************************************************************************!*\
  !*** ./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_cashRegister_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./cashRegister.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_cashRegister_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=template&id=1b56c2f6&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=template&id=1b56c2f6& ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cashRegister_vue_vue_type_template_id_1b56c2f6___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cashRegister_vue_vue_type_template_id_1b56c2f6___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_cashRegister_vue_vue_type_template_id_1b56c2f6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./cashRegister.vue?vue&type=template&id=1b56c2f6& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/cashRegister.vue?vue&type=template&id=1b56c2f6&");
