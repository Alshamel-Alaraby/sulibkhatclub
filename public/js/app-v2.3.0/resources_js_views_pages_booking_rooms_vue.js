...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      is_disabled: false,
      filterSetting: ["name", "name_e", "code", "price", "description", "description_e", this.$i18n.locale == 'ar' ? 'unitStatus.name' : 'unitStatus.name_e', "number_of_individuals", "extra_guest_price", "booking_floor_id"]
    };
  },
  validations: {
    create: {
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      var index = this.filterSetting.indexOf("booking_floor_id");
      if (index > -1) {
        _filterSetting[index] = this.$i18n.locale == "ar" ? "floor.name" : "floor.name_e";
      }
      var filter = "";
    ...
    resetModal: function resetModal() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!_this8.isVisible('booking_floor_id')) {
                _context.next = 3;
                break;
              }
              _context.next = 3;
              return _this8.getFloors();
            case 3:
              if (!_this8.isVisible('unit_status_id')) {
                _context.next = 6;
                break;
              }
              _context.next = 6;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              if (!_this12.isVisible('booking_floor_id')) {
                _context2.next = 3;
                break;
              }
              _context2.next = 3;
              return _this12.getFloors();
            case 3:
              if (!_this12.isVisible('unit_status_id')) {
                _context2.next = 6;
                break;
              }
              _context2.next = 6;
            ...
            case 6:
              category = _this12.categories.find(function (e) {
                return id == e.id;
              });
              _this12.edit.name = category.name;
              _this12.edit.name_e = category.name_e;
              _this12.edit.description = category.description;
              _this12.edit.description_e = category.description_e;
              _this12.edit.code = category.code;
              _this12.edit.price = category.price;
              _this12.edit.unit_status_id = category.unit_status_id;
              _this12.edit.number_of_individuals = category.number_of_individuals;
              _this12.edit.extra_guest_price = category.extra_guest_price;
              _this12.edit.booking_floor_id = category.booking_floor_id;
              _this12.errors = {};
            case 18:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/booking/floors").then(function (res) {
    ...
    getStatus: function getStatus() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/statuses/get-drop-down?module_type=booking").then(function (res) {
        ...
        _this16.errorFun("Error", "Thereisanerrorinthesystem");
      })["finally"](function () {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_name_en")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("number_of_individuals") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "number_of_individuals"
    },
    model: {
      value: _vm.filterSetting,
      callback: function callback($$v) {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_number_of_individuals")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("extra_guest_price") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_extra_guest_price")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("booking_floor_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "booking_floor_id"
    },
    model: {
      value: _vm.filterSetting,
      callback: function callback($$v) {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_floor")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("description") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "description"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_description_en")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("unit_status_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.number_of_individuals,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "number_of_individuals", $$v);
      },
      expression: "setting.number_of_individuals"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_number_of_individuals")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("extra_guest_price") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.extra_guest_price,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "extra_guest_price", $$v);
      },
      expression: "setting.extra_guest_price"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_extra_guest_price")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("booking_floor_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.booking_floor_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "booking_floor_id", $$v);
      },
      expression: "setting.booking_floor_id"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_floor")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("description") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("room_unit_status")))]) : _vm._e(), _vm._v(" "), _c("div", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_status_id && _vm.isVisible("unit_status_id") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("room_unit_status")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.categories.sort(_vm.sortString(_vm.$i18n.locale =  true ? "unit_status.name" : 0));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.number_of_individuals && _vm.isVisible("number_of_individuals") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("room_number_of_individuals")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.categories.sort(_vm.sortString("number_of_individuals"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.extra_guest_price && _vm.isVisible("extra_guest_price") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("room_extra_guest_price")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.categories.sort(_vm.sortString("extra_guest_price"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.booking_floor_id && _vm.isVisible("booking_floor_id") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("room_floor")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.categories.sort(_vm.sortString(_vm.$i18n.locale =  true ? "floor.name" : 0));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_status_id && _vm.isVisible("unit_status_id") ? _c("td", [data.unit_status ? _c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                        " + _vm._s(_vm.$i18n.locale == "ar" ? data.unit_status.name : data.unit_status.name_e) + "\n                                    ")]) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.setting.number_of_individuals && _vm.isVisible("number_of_individuals") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.number_of_individuals))])]) : _vm._e(), _vm._v(" "), _vm.setting.extra_guest_price && _vm.isVisible("extra_guest_price") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.extra_guest_price))])]) : _vm._e(), _vm._v(" "), _vm.setting.booking_floor_id && _vm.isVisible("booking_floor_id") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                        " + _vm._s(data.floor ? _vm.$i18n.locale == "ar" ? data.floor.name : data.floor.name : "---") + "\n                                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.description && _vm.isVisible("description") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
      ...
      model: {
        value: _vm.edit.booking_floor_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "booking_floor_id", $$v);
        },
        expression: "edit.booking_floor_id"
      }
    }), _vm._v(" "), _vm.$v.edit.booking_floor_id.$error || _vm.errors.booking_floor_id ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                                            " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                        ")]) : _vm._e(), _vm._v(" "), _vm.errors.booking_floor_id ? _vm._l(_vm.errors.booking_floor_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      "class": {
        "is-invalid": _vm.$v.edit.unit_status_id.$error || _vm.errors.unit_status_id,
        "is-valid": !_vm.$v.edit.unit_status_id.$invalid && !_vm.errors.unit_status_id
      },
      attrs: {
        options: _vm.statuses.map(function (type) {
          return type.id;
      ...
      model: {
        value: _vm.edit.unit_status_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "unit_status_id", $$v);
        },
        expression: "edit.unit_status_id"
      }
    }), _vm._v(" "), !_vm.$v.edit.unit_status_id.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                            " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                        ")]) : _vm._e(), _vm._v(" "), _vm.errors.unit_status_id ? _vm._l(_vm.errors.unit_status_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.number_of_individuals.$model,
        expression: "$v.edit.number_of_individuals.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.number_of_individuals.$error || _vm.errors.number_of_individuals,
        "is-valid": !_vm.$v.edit.number_of_individuals.$invalid && !_vm.errors.number_of_individuals
      },
      attrs: {
        type: "number"
      },
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.number_of_individuals, "$model", $event.target.value);
        }
      }
    })]), _vm._v(" "), _vm.errors.number_of_individuals ? _vm._l(_vm.errors.number_of_individuals, function (errorMessage, index) {
      return _c("ErrorMessage", {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.extra_guest_price.$model,
        expression: "$v.edit.extra_guest_price.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.extra_guest_price.$error || _vm.errors.extra_guest_price,
        "is-valid": !_vm.$v.edit.extra_guest_price.$invalid && !_vm.errors.extra_guest_price
      },
      attrs: {
        type: "number"
      },
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.extra_guest_price, "$model", $event.target.value);
        }
      }
    })]), _vm._v(" "), _vm.errors.extra_guest_price ? _vm._l(_vm.errors.extra_guest_price, function (errorMessage, index) {
      return _c("ErrorMessage", {
