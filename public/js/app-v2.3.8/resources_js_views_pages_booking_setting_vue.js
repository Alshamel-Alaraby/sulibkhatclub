(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_booking_setting_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/setting.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/setting.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_13__["default"])(vm, "Booking Setting", "");
    });
  },
  data: function data() {
    return {
  ...
  methods: {
    tConvert: function tConvert(time) {
      return (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.tConvert)(time);
    },
    ...
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/booking_settings").then(function (res) {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/booking/Settings?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("booking/Settings/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this6.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("booking/Settings/".concat(id)).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("booking/Settings", this.create).then(function (res) {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        if (this.edit.key == "Check-in") {
          data = {
            "Check-in": this.edit.value
          };
        } else if (this.edit.key == "Check-out") {
          data = {
            "Check-out": this.edit.value
          };
        } else if (this.edit.key == "extend_automatically") {
          data = {
            "extend_automatically": this.edit.value
          };
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("booking/Settings/update", data).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      ...
      this.edit.key = category.key;
      this.edit.value = category.value;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("booking/Settings/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ("category" + "." || 0) + (type || "xlsx"));
        }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/setting.vue?vue&type=template&id=d5047940&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/setting.vue?vue&type=template&id=d5047940& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.setting")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm.isVisible("key") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "key"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("key")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("value") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "value"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("value")))]) : _vm._e()], 1)], 1), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("key")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("value") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("value")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _c("div", {
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("brand_create_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.key && _vm.isVisible("key") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("key")))]), _vm._v(" "), _c("div", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.value && _vm.isVisible("value") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("value")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    return _c("tr", {
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.key && _vm.isVisible("key") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.key))])]) : _vm._e(), _vm._v(" "), _vm.setting.value && _vm.isVisible("value") ? _c("td", [data.id == 1 || data.id == 2 ? _c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(_vm.tConvert(data.value)))]) : data.id == 3 ? _c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(parseInt(data.value) == 1 ? _vm.$t("general.Yes") : _vm.$t("general.No")))]) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("key_value_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
    ...
    }, [_vm._v("\n                                " + _vm._s(_vm.getCompanyKey("key")) + "\n                                "), _vm.isRequired("key") ? _c("span", {
      staticClass: "text-danger"
    }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.key.$model,
        expression: "$v.edit.key.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.key.$error || _vm.errors.key,
        "is-valid": !_vm.$v.edit.key.$invalid && !_vm.errors.key
      },
      attrs: {
        disabled: "",
        type: "text",
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.key, "$model", $event.target.value);
        }
      }
    })])]) : _vm._e(), _vm._v(" "), _vm.isVisible("value") && (data.id == 1 || data.id == 2) ? _c("div", {
      staticClass: "col-md-12"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", {
    ...
    }, [_vm._v("\n                                " + _vm._s(_vm.getCompanyKey("value")) + "\n                                "), _vm.isRequired("value") ? _c("span", {
      staticClass: "text-danger"
    }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.value.$model,
        expression: "$v.edit.value.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.value.$error || _vm.errors.value,
        "is-valid": !_vm.$v.edit.value.$invalid && !_vm.errors.value
      },
      attrs: {
        type: "time",
        "data-edit": "1",
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.value, "$model", $event.target.value);
        }
      }
    })])]) : _vm._e(), _vm._v(" "), _vm.isVisible("value") && data.id == 3 ? _c("div", {
      staticClass: "col-md-12"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", {
      ...
      on: {
        change: function change($event) {
          ...
          _vm.$set(_vm.edit, "value", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
        }
      }
    }, [_c("option", {
      attrs: {
    ...
    }, [_vm._v(_vm._s(_vm.$t("general.No")))])])])]) : _vm._e()])])])], 1) : _vm._e()]);
...
/***/ "./resources/js/views/pages/booking/setting.vue":
/*!******************************************************!*\
  !*** ./resources/js/views/pages/booking/setting.vue ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _setting_vue_vue_type_template_id_d5047940___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./setting.vue?vue&type=template&id=d5047940& */ "./resources/js/views/pages/booking/setting.vue?vue&type=template&id=d5047940&");
/* harmony import */ var _setting_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./setting.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/booking/setting.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _setting_vue_vue_type_template_id_d5047940___WEBPACK_IMPORTED_MODULE_0__.render,
  _setting_vue_vue_type_template_id_d5047940___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/booking/setting.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/booking/setting.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/js/views/pages/booking/setting.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/pages/booking/setting.vue?vue&type=template&id=d5047940&":
/*!*************************************************************************************!*\
  !*** ./resources/js/views/pages/booking/setting.vue?vue&type=template&id=d5047940& ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_setting_vue_vue_type_template_id_d5047940___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_setting_vue_vue_type_template_id_d5047940___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_setting_vue_vue_type_template_id_d5047940___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./setting.vue?vue&type=template&id=d5047940& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/setting.vue?vue&type=template&id=d5047940&");
