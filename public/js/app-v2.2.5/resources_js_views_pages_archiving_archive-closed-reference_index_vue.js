...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_8__["default"])(vm, "Archive Closed Reference", "all Store");
    });
  },
  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        this.is_disabled = false;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/archive-closed-reference", _objectSpread(_objectSpread({}, this.create), {}, {
