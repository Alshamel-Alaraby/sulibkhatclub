...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      checkAll: [],
      current_page: 1,
      filterSetting: ["member_request_id", "date_from", "date_to", "amount", "prefix"],
      printLoading: true,
      printObj: {
        id: "printData"
      }
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("new_subscription_year_from")) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("date_to") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "date_to"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("new_subscription_year_to")) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("amount") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "amount"
    },
  ...
  }, [_vm._v("\n                                                " + _vm._s(_vm.$t("general.serial_number")) + "\n                                            ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("member_request_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                            " + _vm._s(data.member_request ? data.member_request.first_name + " " + data.member_request.second_name + " " + data.member_request.third_name + " " + data.member_request.last_name : "") + "\n                                        ")]) : _c("h5", {
      staticClass: "m-0 font-weight-normal"
