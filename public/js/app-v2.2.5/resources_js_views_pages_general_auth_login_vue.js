      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return axios.get("".concat("https://admin.alshamelalaraby.com/", "api/everything_about_the_company/").concat(id)).then(function (res) {
                var l = res.data.data;
                var name = [];
                  ...
                  if (parent.programFolders) {
                    parent.programFolders.forEach(function (child1) {
                      ...
                      if (child1.menu_folder) {
                        child1.menu_folder.forEach(function (child2) {
                          // name.push(child2.name_e);
                          if (child2.subMenus) {
                            child2.subMenus.forEach(function (child3) {
                              // name.push(child3.name_e);
                              if (child3.screens) {
                                child3.screens.forEach(function (child4) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _this3.$store.commit("auth/editWorkFlowTrees", ["dictionary", "home", "company"].concat(name));
            case 3:
            case "end":
            ...
            case 0:
              ...
              permissions.forEach(function (el) {
                if (el.category.length > 0 && el.category) {
                  el.category.forEach(function (e) {
              ...
              _this4.$store.commit("auth/editPermission", permissions);
              _this4.$store.commit("auth/editWorkFlowTrees", ["home"].concat(workflowTree));
            case 4:
            case "end":
