(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_archiving_document-field_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/document-field.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/document-field.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_create_property_tree__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/create/property-tree */ "./resources/js/components/create/property-tree.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    propertyTree: _components_create_property_tree__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.documentFields.forEach(function (el) {
  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tree-properties/root-nodes").then(function (res) {
                var l = res.data;
                l.unshift({
                  id: 0,
                  name: "اضف خاصية",
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/document-field?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this4.documentFields = l.data;
        _this4.documentFieldPagination = l.pagination;
    ...
    getDataTypes: function getDataTypes() {
      var _this5 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/data-types").then(function (res) {
        _this5.dataTypes = res.data.data;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
          icon: "error",
          title: "".concat(_this5.$t("general.Error")),
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this6 = this;
      if (this.current_page <= this.documentFieldPagination.last_page && this.current_page != this.documentFieldPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i > this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/document-field?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this6.documentFields = l.data;
          _this6.documentFieldPagination = l.pagination;
     ...
     */
    deleteDocumentField: function deleteDocumentField(id, index) {
      var _this7 = this;
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/document-field/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
          ...
          if (result.value) {
            _this7.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/document-field/".concat(id)).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        this.is_disabled = false;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/document-field", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        var _this$edit = this.edit,
          ...
          lookup_table = _this$edit.lookup_table,
          is_reference = _this$edit.is_reference,
          type = _this$edit.type,
          lookup_table_column = _this$edit.lookup_table_column,
          tree_property_id = _this$edit.tree_property_id,
          field_characters = _this$edit.field_characters;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/document-field/".concat(id), {
          name: name,
          name_e: name_e,
          is_reference: is_reference == "1" ? 1 : 0,
          data_type_id: type,
          lookup_table_column: lookup_table_column,
          lookup_table: lookup_table,
          tree_property_id: tree_property_id,
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              documentField = _this13.documentFields.find(function (e) {
                return id == e.id;
              });
              _context4.next = 3;
              return _this13.getTables();
            case 3:
              _context4.next = 5;
            ...
            case 5:
              ...
              _context4.next = 8;
              return _this13.getColumns(documentField.lookup_table);
            case 8:
              _this13.getDataTypes();
              _this13.edit.name = documentField.name;
              _this13.edit.name_e = documentField.name_e;
              _this13.edit.type = documentField.data_type.id;
              _this13.edit.is_reference = documentField.is_reference;
              _this13.edit.lookup_table = documentField.lookup_table;
              _this13.edit.tree_property_id = documentField.tree_property_id;
              _this13.edit.field_characters = documentField.field_characters;
              if (_this13.edit.type == "lookup(Table)") {
                _this13.showInput = true;
              }
              _this13.edit.lookup_table_column = documentField.lookup_table_column;
              _this13.errors = {};
            case 19:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/document-field/tables").then(function (res) {
                var l = res.data.data;
                _this14.tables = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/document-field/columns/".concat(table)).then(function (res) {
                var l = res.data.data;
                _this15.columns = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
    ...
    showTreeEdit: function showTreeEdit() {
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ('document-field' + '.' || 0) + (type || 'xlsx'));
        }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/document-field.vue?vue&type=template&id=08436c02&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/document-field.vue?vue&type=template&id=08436c02& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("propertyTree", {
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.$t("DocumentField.DocumentFieldsTable")))]), _vm._v(" "), _c("div", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.deleteDocumentField(_vm.checkAll);
      }
    }
  }, [_c("i", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.deleteDocumentField(_vm.checkAll[0]);
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-trash-alt"
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("documentFieldName")) + "\n                  ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.is_reference,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "is_reference", $$v);
      },
      expression: "setting.is_reference"
    }
  }, [_vm._v("\n                    " + _vm._s(_vm.getCompanyKey("document-field-reference")) + "\n                  ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.lookup_table,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "lookup_table", $$v);
      },
      expression: "setting.lookup_table"
    }
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.lookup_table_column,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "lookup_table_column", $$v);
      },
      expression: "setting.lookup_table_column"
    }
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.documentFieldPagination.from) + "-" + _vm._s(_vm.documentFieldPagination.to) + "\n                    /\n                    " + _vm._s(_vm.documentFieldPagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.documentFieldPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.documentFieldPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.documentFieldPagination.last_page == _vm.documentFieldPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("documentFieldName")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.documentFields.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("documentFieldNameE")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.documentFields.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.is_reference ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("document-field-reference")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.documentFields.sort(_vm.sortString("is_reference"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.type ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("document-field-type")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.documentFields.sort(_vm.sortString("type"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    on: {
      click: function click($event) {
        _vm.documentFields.sort(_vm.sortString("field_characters"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.lookup_table ? _c("td", [_vm._v("\n                    " + _vm._s(_vm.getCompanyKey("document-field-lookup")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.lookup_table_column ? _c("td", [_vm._v("\n                    " + _vm._s(_vm.getCompanyKey("document-field-lookup_column")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("general.Action")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_c("i", {
    staticClass: "fas fa-ellipsis-v"
  })]) : _vm._e()])]), _vm._v(" "), _vm.documentFields.length > 0 ? _c("tbody", _vm._l(_vm.documentFields, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.is_reference ? _c("td", [_c("span", {
      "class": [data.is_reference == 1 ? "text-success" : "text-danger", "badge"]
    }, [_vm._v("\n                      " + _vm._s(data.is_reference == 1 ? "".concat(_vm.$t("general.Yes")) : "".concat(_vm.$t("general.No"))) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.type ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.data_type.name : data.data_type.name_e) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.field_characters ? _c("td", [_vm._v("\n                    " + _vm._s(data.field_characters) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.lookup_table ? _c("td", [_vm._v("\n                    " + _vm._s(data.lookup_table ? data.lookup_table : "-") + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.lookup_table_column ? _c("td", [_vm._v("\n                    " + _vm._s(data.lookup_table_column ? data.lookup_table_column : "-") + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.deleteDocumentField(data.id);
        }
      }
    }, [_c("div", {
      staticClass: "d-flex justify-content-between align-items-center text-black"
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("documentFieldEdit"),
        "title-class": "font-18",
        "body-class": "p-4",
        size: "lg",
        "hide-footer": true
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.type.$model,
        expression: "$v.edit.type.$model"
      }],
      staticClass: "custom-select",
      "class": {
        "is-invalid": _vm.$v.edit.type.$error || _vm.errors.type,
        "is-valid": !_vm.$v.edit.type.$invalid && !_vm.errors.type
      },
      on: {
        change: [function ($event) {
          var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
          ...
          _vm.$set(_vm.$v.edit.type, "$model", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
        }, _vm.lookUpChange]
      }
    }, _vm._l(_vm.dataTypes, function (type) {
      return _c("option", {
    ...
    }) : _vm._e()], 2)]), _vm._v(" "), _vm.edit.type && _vm.edit.type != 7 ? _c("div", {
      staticClass: "col-md-6"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", {
    ...
    }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.edit.type == 10 ? _c("div", {
      staticClass: "col-md-6"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", [_vm._v("\n                                " + _vm._s(_vm.getCompanyKey("property")) + "\n                                "), _c("span", {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.tree_property_id.$model,
        expression: "$v.edit.tree_property_id.$model"
      }],
      staticClass: "custom-select",
      "class": {
        "is-invalid": _vm.$v.edit.tree_property_id.$error || _vm.errors.tree_property_id,
        "is-valid": !_vm.$v.edit.tree_property_id.$invalid && !_vm.errors.tree_property_id
      },
      on: {
        change: [function ($event) {
          var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
          ...
          _vm.$set(_vm.$v.edit.tree_property_id, "$model", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
        }, _vm.showTreeEdit]
      }
    }, _vm._l(_vm.properties, function (property) {
      return _c("option", {
      ...
      on: {
        input: function input($event) {
          return _vm.getColumns(_vm.edit.lookup_table);
        }
      },
      model: {
        value: _vm.$v.edit.lookup_table.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.lookup_table, "$model", $$v);
        },
        expression: "$v.edit.lookup_table.$model"
      }
    }), _vm._v(" "), _vm.$v.edit.lookup_table.$error || _vm.errors.lookup_table ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.lookup_table ? _vm._l(_vm.errors.lookup_table, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      directives: [{
        name: "show",
        rawName: "v-show",
        value: _vm.edit.lookup_table,
        expression: "edit.lookup_table"
      }],
      staticClass: "col-md-6"
    }, [_c("div", {
      staticClass: "form-group position-relative"
      ...
      model: {
        value: _vm.$v.edit.lookup_table_column.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.lookup_table_column, "$model", $$v);
        },
        expression: "$v.edit.lookup_table_column.$model"
      }
    }), _vm._v(" "), _vm.$v.edit.lookup_table_column.$error || _vm.errors.lookup_table_column ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.lookup_table_column ? _vm._l(_vm.errors.lookup_table_column, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      "class": {
        "is-invalid": _vm.$v.edit.is_reference.$error || _vm.errors.is_reference,
        "is-valid": !_vm.$v.edit.is_reference.$invalid && !_vm.errors.is_reference
      }
    }, [_c("b-form-radio", {
      staticClass: "d-inline-block",
      attrs: {
      ...
      model: {
        value: _vm.$v.edit.is_reference.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.is_reference, "$model", $$v);
        },
        expression: "$v.edit.is_reference.$model"
      }
    }, [_vm._v(_vm._s(_vm.$t("general.isReferenceYes")))]), _vm._v(" "), _c("b-form-radio", {
      staticClass: "d-inline-block m-1",
      attrs: {
...
/***/ "./resources/js/views/pages/archiving/document-field.vue":
/*!***************************************************************!*\
  !*** ./resources/js/views/pages/archiving/document-field.vue ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _document_field_vue_vue_type_template_id_08436c02___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./document-field.vue?vue&type=template&id=08436c02& */ "./resources/js/views/pages/archiving/document-field.vue?vue&type=template&id=08436c02&");
/* harmony import */ var _document_field_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./document-field.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/archiving/document-field.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _document_field_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _document_field_vue_vue_type_template_id_08436c02___WEBPACK_IMPORTED_MODULE_0__.render,
  _document_field_vue_vue_type_template_id_08436c02___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/archiving/document-field.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/archiving/document-field.vue?vue&type=script&lang=js&":
/*!****************************************************************************************!*\
  !*** ./resources/js/views/pages/archiving/document-field.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_document_field_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./document-field.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/document-field.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_document_field_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/archiving/document-field.vue?vue&type=template&id=08436c02&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/views/pages/archiving/document-field.vue?vue&type=template&id=08436c02& ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_document_field_vue_vue_type_template_id_08436c02___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_document_field_vue_vue_type_template_id_08436c02___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_document_field_vue_vue_type_template_id_08436c02___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./document-field.vue?vue&type=template&id=08436c02& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/document-field.vue?vue&type=template&id=08436c02&");
