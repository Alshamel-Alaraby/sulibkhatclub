...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      if (vm.$store.state.auth.work_flow_trees.includes("main contact groups") || vm.$store.state.auth.work_flow_trees.includes("receivable payable") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/recievable-payable/rp_main_contact_group?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this3.rolesType = l.data;
        _this3.rolesTypePagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.rolesTypePagination.last_page && this.current_page != this.rolesTypePagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/recievable-payable/rp_main_contact_group?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/recievable-payable/rp_main_contact_group/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this5.checkAll = [];
              _this5.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this5.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/recievable-payable/rp_main_contact_group/".concat(id)).then(function (res) {
              _this5.checkAll = [];
              _this5.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/recievable-payable/rp_main_contact_group", this.create).then(function (res) {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/recievable-payable/rp_main_contact_group/".concat(id), {
          name: name,
          name_e: name_e
        }).then(function (res) {
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/recievable-payable/rp_main_contact_group/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ('MainContactGroups' + '.' || 0) + (type || 'xlsx'));
        }
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.MainContactGroupsTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("Group_name")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.rolesTypePagination.from) + "-" + _vm._s(_vm.rolesTypePagination.to) + " /\n                    " + _vm._s(_vm.rolesTypePagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.rolesTypePagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.rolesTypePagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.rolesTypePagination.last_page == _vm.rolesTypePagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("Group_name")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.rolesType.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("Group_name_e")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.rolesType.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.rolesType.length > 0 ? _c("tbody", _vm._l(_vm.rolesType, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("MainContactGroupsEdit"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
