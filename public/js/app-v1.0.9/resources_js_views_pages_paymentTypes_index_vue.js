(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_paymentTypes_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/paymentTypes/index.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/paymentTypes/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      //
      vm.showScreen("bank", "payment types") && vm.$store.state.auth.work_flow_trees.includes("bank") || vm.$store.state.auth.user.type == 'super_admin') {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.paymentTypes.forEach(function (el) {
  ...
  methods: {
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/general_payment_types").then(function (res) {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/payment-types?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this4.paymentTypes = l.data;
        _this4.paymentTypesPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this5 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      if (this.current_page <= this.paymentTypesPagination.last_page && this.current_page != this.paymentTypesPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i > this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/payment-types?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this5.paymentTypes = l.data;
          _this5.paymentTypesPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/payment-types/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this6.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/payment-types/".concat(id)).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/payment-types", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/payment-types/".concat(id), {
          name: name,
          name_e: name_e,
    ...
    resetModalEdit: function resetModalEdit(id) {
      var module = this.paymentTypes.find(function (e) {
        return id == e.id;
      });
      this.edit.name = module.name;
      this.edit.name_e = module.name_e;
      this.edit.is_default = module.is_default == true ? 1 : 0;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/payment-types/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ('Payment Types' + '.' || 0) + (type || 'xlsx'));
        }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/paymentTypes/index.vue?vue&type=template&id=4efa3b80&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/paymentTypes/index.vue?vue&type=template&id=4efa3b80& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.payment-types-Table")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("payment_type_name_ar")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("name_e") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.paymentTypesPagination.from) + "-" + _vm._s(_vm.paymentTypesPagination.to) + " /\n                    " + _vm._s(_vm.paymentTypesPagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.paymentTypesPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.paymentTypesPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.paymentTypesPagination.last_page == _vm.paymentTypesPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("payment_type_create_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("payment_type_name_ar")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.paymentTypes.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("payment_type_name_en")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.paymentTypes.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("payment_type_default")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.paymentTypes.length > 0 ? _c("tbody", _vm._l(_vm.paymentTypes, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      "class": [parseInt(data.is_default) == true ? "text-success" : "text-danger", "badge"]
    }, [_vm._v("\n                      " + _vm._s(parseInt(data.is_default) == true ? "".concat(_vm.$t("general.Yes")) : "".concat(_vm.$t("general.No"))) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("payment_type_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
...
/***/ "./resources/js/views/pages/paymentTypes/index.vue":
/*!*********************************************************!*\
  !*** ./resources/js/views/pages/paymentTypes/index.vue ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_4efa3b80___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=4efa3b80& */ "./resources/js/views/pages/paymentTypes/index.vue?vue&type=template&id=4efa3b80&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/paymentTypes/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_4efa3b80___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_4efa3b80___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/paymentTypes/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/paymentTypes/index.vue?vue&type=script&lang=js&":
/*!**********************************************************************************!*\
  !*** ./resources/js/views/pages/paymentTypes/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/paymentTypes/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/pages/paymentTypes/index.vue?vue&type=template&id=4efa3b80&":
/*!****************************************************************************************!*\
  !*** ./resources/js/views/pages/paymentTypes/index.vue?vue&type=template&id=4efa3b80& ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_4efa3b80___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_4efa3b80___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_4efa3b80___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=4efa3b80& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/paymentTypes/index.vue?vue&type=template&id=4efa3b80&");
