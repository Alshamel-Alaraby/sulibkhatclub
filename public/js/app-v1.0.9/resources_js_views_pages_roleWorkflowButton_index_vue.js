(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_roleWorkflowButton_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  page: {
    title: "Role Workflow Button",
    meta: [{
      name: "Role Workflow Button",
      content: "Role Workflow Button"
    }]
  },
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      if (vm.$store.state.auth.work_flow_trees.includes('role workflow button') || vm.$store.state.auth.work_flow_trees.includes('role') || vm.$store.state.auth.user.type == 'super_admin') {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.roleWorkflowButtons.forEach(function (el) {
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflow-button?page=".concat(page, "&per_page=").concat(_this4.per_page, "&search=").concat(_this4.search, "&").concat(filter)).then(function (res) {
                var l = res.data;
                _this4.roleWorkflowButtons = l.data;
                _this4.roleWorkflowButtonsPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.roleWorkflowButtonsPagination.last_page && this.current_page != this.roleWorkflowButtonsPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i > this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflow-button?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this5.roleWorkflowButtons = l.data;
          _this5.roleWorkflowButtonsPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/role-workflow-button", this.create).then(function (res) {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/role-workflow-button/".concat(id), this.edit).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 4:
              module = _this12.roleWorkflowButtons.find(function (e) {
                return id == e.id;
              });
              _this12.edit.workflow_id = module.workflow_id;
              _this12.edit.role_id = module.role.id;
              _this12.edit.button_id = module.button_id;
              _this12.errors = {};
            case 9:
            case "end":
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflow-button/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=template&id=60e26e58&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=template&id=60e26e58& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Role", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.roleWorkflowButtonsTable")))]), _vm._v(" "), _c("div", {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.button_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "button_id", $$v);
      },
      expression: "setting.button_id"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("button")) + "\n                    ")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.roleWorkflowButtonsPagination.from) + "-" + _vm._s(_vm.roleWorkflowButtonsPagination.to) + "\n                    /\n                    " + _vm._s(_vm.roleWorkflowButtonsPagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.roleWorkflowButtonsPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.roleWorkflowButtonsPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.roleWorkflowButtonsPagination.last_page == _vm.roleWorkflowButtonsPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("role_workflow_button_create_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
    ...
    staticClass: "my-1 mr-2"
  }, [_vm._v(_vm._s(_vm.getCompanyKey("button")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
      options: _vm.buttons.map(function (type) {
        return type.id;
      }),
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.buttons.find(function (x) {
          return x.id == opt;
        }).name : _vm.buttons.find(function (x) {
          return x.id == opt;
        }).name_e;
      }
    },
    model: {
      value: _vm.create.button_id,
      callback: function callback($$v) {
        _vm.$set(_vm.create, "button_id", $$v);
      },
      expression: "create.button_id"
    }
  }), _vm._v(" "), _vm.errors.button_id ? _vm._l(_vm.errors.button_id, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
  }) : _vm._e()], 2)])])])]), _vm._v(" "), _c("div", {
  ...
  })])]), _vm._v(" "), _vm.setting.role_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("role")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.workflow_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("workflow")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.button_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("button")))])])]) : _vm._e(), _vm._v(" "), _c("th", [_vm._v("\n                    " + _vm._s(_vm.$t("general.Action")) + "\n                  ")]), _vm._v(" "), _c("th", [_c("i", {
    staticClass: "fas fa-ellipsis-v"
  })])])]), _vm._v(" "), _vm.roleWorkflowButtons.length > 0 ? _c("tbody", _vm._l(_vm.roleWorkflowButtons, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      return x.id == data.workflow_id;
    }).name_e : "") + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.button_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(_vm.buttons.length > 0 ? _vm.$i18n.locale == "ar" ? _vm.buttons.find(function (x) {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("role_workflow_button_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      model: {
        value: _vm.edit.button_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "button_id", $$v);
        },
        expression: "edit.button_id"
      }
    }), _vm._v(" "), _vm.errors.button_id ? _vm._l(_vm.errors.button_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
...
/***/ "./resources/js/views/pages/roleWorkflowButton/index.vue":
/*!***************************************************************!*\
  !*** ./resources/js/views/pages/roleWorkflowButton/index.vue ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_60e26e58___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=60e26e58& */ "./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=template&id=60e26e58&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_60e26e58___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_60e26e58___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/roleWorkflowButton/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=script&lang=js&":
/*!****************************************************************************************!*\
  !*** ./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=template&id=60e26e58&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=template&id=60e26e58& ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_60e26e58___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_60e26e58___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_60e26e58___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=60e26e58& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflowButton/index.vue?vue&type=template&id=60e26e58&");
