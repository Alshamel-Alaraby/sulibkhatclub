...
/* harmony import */ var _components_create_realEstate_tree_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../components/create/realEstate/tree.vue */ "./resources/js/components/create/realEstate/tree.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    TreeBrowser: _components_create_realEstate_tree_vue__WEBPACK_IMPORTED_MODULE_10__["default"]
  },
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_13__["default"])(vm, "Sponsor", "all sponsor club");
    });
  },
  data: function data() {
    return {
  ...
  methods: {
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/cm_sponsers").then(function (res) {
    ...
    getGroup: function getGroup() {
      var _this4 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/sponsor-group").then(function (res) {
        _this4.groups = res.data.data;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          icon: "error",
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.sponsorsPagination.last_page && this.current_page != this.sponsorsPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("club-members/sponsers?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this7.sponsors = l.data;
          _this7.sponsorsPagination = l.pagination;
    ...
    getSponserGroup: function getSponserGroup(id) {
      var _this8 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("club-members/sponsers/get-sponsors/".concat(id)).then(function (res) {
        var l = res.data.data;
        _this8.sponserGroups = l;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          icon: "error",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("club-members/sponsers", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("club-members/sponsers/".concat(id), _objectSpread(_objectSpread({}, this.edit), {}, {
          company_id: this.$store.getters["auth/company_id"]
        })).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      this.getGroup();
      var module = this.sponsors.find(function (e) {
        return id == e.id;
      });
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("sponsor_name_ar")))]) : _vm._e(), _vm._v("sponsorGroup\n                    "), _vm.isVisible("name_e") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "name_e"
    },
    ...
    staticClass: "mb-1",
    attrs: {
      value: _vm.$i18n.locale == "ar" ? "sponsorGroup.name" : "sponsorGroup.name_e"
    },
    model: {
      value: _vm.filterSetting,
      callback: function callback($$v) {
  ...
  })]), _vm._v(" "), _vm.checkAll.length == 1 && _vm.isPermission("update sponsor club") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
  ...
  })]) : _vm._e(), _vm._v(" "), _vm.checkAll.length > 1 && _vm.isPermission("delete sponsor club") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
        $event.preventDefault();
  ...
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("sponsor_name_en")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("parent_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.group_id && _vm.isVisible("group_id") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("sponsor_group")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    return _c("tr", {
      ...
      on: {
        ...
        dblclick: function dblclick($event) {
          $event.preventDefault();
          _vm.isPermission("update sponsor club") ? _vm.$bvModal.show("modal-edit-".concat(data.id)) : false;
        }
      }
    }, [_vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.group_id && _vm.isVisible("group_id") ? _c("td", [data.group ? [_vm._v("\n                        " + _vm._s(_vm.$i18n.locale == "ar" ? data.group.name : data.group.name_e) + "\n                      ")] : _vm._e()], 2) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
    ...
    }, [_vm.isPermission("update sponsor club") ? _c("a", {
      staticClass: "dropdown-item",
      attrs: {
        href: "#"
      },
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.isPermission("delete sponsor club") ? _c("a", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("sponsor_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      model: {
        value: _vm.edit.group_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "group_id", $$v);
        },
        expression: "edit.group_id"
      }
    }), _vm._v(" "), _vm.$v.edit.group_id.$error || _vm.errors.group_id ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                            " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.errors.group_id ? _vm._l(_vm.errors.group_id, function (errorMessage, index) {
