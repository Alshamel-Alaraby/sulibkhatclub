...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
      ...
      setTimeout(function () {
        if (_this3.type != 'edit') {
          ...
          if (_this3.idObjEdit.dataObj) {
            ...
            _this3.is_panel = false;
            _this3.current_page_pans_pack = 1;
            var pack = _this3.idObjEdit.dataObj;
            _this3.package_id = pack.id;
            _this3.create.name = pack.name;
            _this3.create.name_e = pack.name_e;
            _this3.create.code = pack.code;
            _this3.create.price = pack.price;
            if (pack.panels && pack.panels.length > 0) {
              _this3.allPanelPackages = pack.panels;
    ...
    getPanel: function getPanel() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/boards-rent/panels?page=".concat(1, "&per_page=", 20, "&packages=1", filter)).then(function (res) {
        var l = res.data;
        _this8.pans = l.data;
        _this8.pansPagination = l.pagination;
        _this8.current_page_pans = l.pagination.current_page;
      })["catch"](function (err) {
    ...
    getPanelPagination: function getPanelPagination() {
      ...
      if (this.current_page_pans <= this.pansPagination.last_page && this.current_page_pans != this.pansPagination.current_page && this.current_page_pans) {
        ...
        filter += this.location.street_id ? "&street_id=".concat(this.location.street_id) : '';
        filter += this.location.code ? "&code=".concat(this.location.code) : '';
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/boards-rent/panels?page=".concat(20, "&per_page=", 7, "&packages=1", filter)).then(function (res) {
          var l = res.data;
          _this9.pans = l.data;
      ...
      if (this.$v.create.$invalid) {
        ...
        if (this.type != 'edit' && this.typeCom != 'edit') {
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post(this.url, _objectSpread(_objectSpread({}, this.create), {}, {
            ...
            _this11.package_id = res.data.data.id;
            _this11.typeCom = 'edit';
            if (!_this11.isPage) _this11.$emit("created");else _this11.$emit("getDataTable");
            setTimeout(function () {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("".concat(this.url, "/").concat(this.package_id), _objectSpread(_objectSpread({}, this.create), {}, {
            ...
            _this11.$bvModal.hide(_this11.id);
            _this11.$emit("getDataTable");
            setTimeout(function () {
              _this11.successFun('Editsuccessfully');
            }, 500);
          })["catch"](function (err) {
            if (err.response.data) {
              _this11.errors = err.response.data.errors;
    ...
    changeValuePanel: function changeValuePanel() {
      ...
      this.allPanelPackages.forEach(function (e, index) {
        if (e.face == 'A') {
          _this12.faceNumber.A = _this12.faceNumber.A + 1;
        } else if (e.face == 'B') {
          _this12.faceNumber.B = _this12.faceNumber.B + 1;
        } else if (e.face == 'Multi') {
          _this12.faceNumber.Multi = _this12.faceNumber.Multi + 1;
        } else if (e.face == 'One-Face') {
          _this12.faceNumber['One-Face'] = _this12.faceNumber['One-Face'] + 1;
        }
      });
    },
    // paginate
  ...
  data: function data() {
    return {
      ...
      tableSetting: [{
        isFilter: true,
        isSet: true,
        trans: "boardRent_unitStatus_name_ar",
        isV: 'name',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: true,
        isSet: true,
        trans: "boardRent_unitStatus_name_en",
        isV: 'name_e',
        type: 'string',
        sort: true,
        setting: {
