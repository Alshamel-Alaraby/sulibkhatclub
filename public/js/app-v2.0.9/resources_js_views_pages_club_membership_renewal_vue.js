      ...
      memberships_renewals: {
        ...
        $each: {
          ...
          membership_cost: {
            ...
            minValue: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.minValue)(0.01)
          },
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    return [_c("div", {
      ...
      model: {
        value: _vm.$v.create.memberships_renewals.$each[index].from.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.create.memberships_renewals.$each[index].from, "$model", $$v);
        },
        expression: "$v.create.memberships_renewals.$each[index].from.$model"
      }
    }), _vm._v(" "), _vm.errors.from ? _vm._l(_vm.errors.from, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      }, [_vm._v("\n                                                    " + _vm._s(errorMessage) + "\n                                                ")]);
    }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("to") ? _c("div", {
      staticClass: "col-md-2"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", {
      ...
      model: {
        value: _vm.$v.create.memberships_renewals.$each[index].to.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.create.memberships_renewals.$each[index].to, "$model", $$v);
        },
        expression: "$v.create.memberships_renewals.$each[index].to.$model"
      }
    }), _vm._v(" "), _vm.errors.to ? _vm._l(_vm.errors.to, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      }, [_vm._v("\n                                                    " + _vm._s(errorMessage) + "\n                                                ")]);
    ...
    return _c("tr", {
      ...
      model: {
        value: _vm.$v.edit.from.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.from, "$model", $$v);
        },
        expression: "$v.edit.from.$model"
      }
    }), _vm._v(" "), _vm.errors.from ? _vm._l(_vm.errors.from, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      model: {
        value: _vm.$v.edit.to.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.to, "$model", $$v);
        },
        expression: "$v.edit.to.$model"
      }
    }), _vm._v(" "), _vm.errors.to ? _vm._l(_vm.errors.to, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
