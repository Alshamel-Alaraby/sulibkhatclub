...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      checkAll: [],
      current_page: 1,
      filterSetting: ["cm_member_id", "date_from", "date_to", "amount"],
      printLoading: true,
      printObj: {
        id: "printData"
      }
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/serials?branch_id=".concat(_this8.create.branch_id)).then(function (res) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/memberships-renewals?from=".concat(_this17.create.date_from, "&to=").concat(_this17.create.date_to)).then(function (res) {
                var l = res.data.data;
                _this17.renewal = l;
                if (_this17.create.type) {
                  _this17.renewalAmount();
                }
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
