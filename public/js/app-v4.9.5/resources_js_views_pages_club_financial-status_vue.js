  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/financial-status?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this4.financialStatuses = l.data;
        _this4.financialStatusesPagination = l.pagination;
    ...
    getCustomTableFields: function getCustomTableFields() {
      var _this5 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/general_financialStatuses").then(function (res) {
...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.financialStatusesTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("financial_status_name_ar")))]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "name_e"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("financial_status_name_en")))])], 1)], 1), _vm._v(" "), _c("div", {
