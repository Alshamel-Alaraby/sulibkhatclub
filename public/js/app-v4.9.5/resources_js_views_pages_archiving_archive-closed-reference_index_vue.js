(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_archiving_archive-closed-reference_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  page: {
    ...
    meta: [{
      name: "description",
      content: "Archive Closed Reference"
    }]
  },
  components: {
  ...
  data: function data() {
    return {
      ...
      isLoader: false,
      archDocFields: [],
      //Use this state to Fetch Archive Doc Fields
      create: {
        arch_docfields_id: "",
        field_value: ""
      },
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.archiveClosedReferenceAr.forEach(function (el) {
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/archive-closed-reference?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this3.archiveClosedReferenceAr = l.data;
        _this3.archiveClosedReferencePagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this4 = this;
      if (this.current_page <= this.archiveClosedReferencePagination.last_page && this.current_page != this.archiveClosedReferencePagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i > this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/archive-closed-reference?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this4.archiveClosedReferenceAr = l.data;
          _this4.archiveClosedReferencePagination = l.pagination;
     ...
     */
    deleteArchiveClosedReference: function deleteArchiveClosedReference(id) {
      var _this5 = this;
      sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
        ...
        if (result.value) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/archive-closed-reference/".concat(id)).then(function (res) {
            _this5.getData();
            _this5.checkAll = [];
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
              icon: "success",
     ...
     */
    bulkDeleteArchiveClosedReference: function bulkDeleteArchiveClosedReference(id) {
      var _this6 = this;
      sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
        title: "".concat(this.$t("general.Areyousure")),
        text: "".concat(this.$t("general.Youwontbeabletoreverthis")),
        ...
        if (result.value) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/archive-closed-reference/bulk-delete", {
            ids: id
          }).then(function (res) {
            _this6.getData();
            _this6.checkAll = [];
     ...
     *  get parent
     */
    getArcDocFields: function getArcDocFields() {
      var _this9 = this;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        this.is_disabled = false;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/archive-closed-reference", _objectSpread({}, this.create)).then(function (res) {
          _this11.getData();
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        var _this$edit = this.edit,
          arch_docfields_id = _this$edit.arch_docfields_id,
          field_value = _this$edit.field_value;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/archive-closed-reference/".concat(id), {
          arch_docfields_id: arch_docfields_id,
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this13.getArcDocFields();
            case 2:
              documentField = _this13.archiveClosedReferenceAr.find(function (e) {
                return id == e.id;
              });
              _this13.edit.arch_docfields_id = documentField.arch_docfields_id;
              _this13.edit.field_value = documentField.field_value;
              _this13.errors = {};
            case 6:
            case "end":
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=template&id=29f26252&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=template&id=29f26252& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("ArchiveClosedReference.ArchiveClosedReferencesTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.ArchiveClosedReferenceDocField")))]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "field_value"
    },
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.ArchiveClosedReferenceFieldValue")))])], 1)], 1), _vm._v(" "), _c("div", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.bulkDeleteArchiveClosedReference(_vm.checkAll);
      }
    }
  }, [_c("i", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.deleteArchiveClosedReference(_vm.checkAll);
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-trash-alt"
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.arch_docfields_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "arch_docfields_id", $$v);
      },
      expression: "setting.arch_docfields_id"
    }
  }, [_vm._v(_vm._s(_vm.$t("general.ArchiveClosedReferenceDocField")) + "\n                  ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("general.ArchiveClosedReferenceFieldValue")) + "\n                  ")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.archiveClosedReferencePagination.from) + "-" + _vm._s(_vm.archiveClosedReferencePagination.to) + " /\n                    " + _vm._s(_vm.archiveClosedReferencePagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.archiveClosedReferencePagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.archiveClosedReferencePagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.archiveClosedReferencePagination.last_page == _vm.archiveClosedReferencePagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    attrs: {
      id: "create",
      title: _vm.$t("ArchiveClosedReference.AddArchiveClosedReference"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true,
      size: "lg"
  ...
  }, [_vm._v("\n                          " + _vm._s(_vm.$t("ArchiveClosedReference.ArcDocField")) + "\n                          "), _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")])]), _vm._v(" "), _c("multiselect", {
    attrs: {
      options: _vm.archDocFields.map(function (type) {
        return type.id;
      }),
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale ? _vm.archDocFields.find(function (x) {
          return x.id == opt;
        }).name : _vm.archDocFields.find(function (x) {
          return x.id == opt;
        }).arch_docfields_id;
      }
    },
    model: {
      value: _vm.create.arch_docfields_id,
      callback: function callback($$v) {
        _vm.$set(_vm.create, "arch_docfields_id", $$v);
      },
      expression: "create.arch_docfields_id"
    }
  }), _vm._v(" "), !_vm.$v.create.arch_docfields_id.integer ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.$t("general.fieldIsInteger")))]) : _vm._e(), _vm._v(" "), _vm.errors.arch_docfields_id ? _vm._l(_vm.errors.arch_docfields_id, function (errorMessage, index) {
  ...
  }, [_vm._v("\n                      " + _vm._s(_vm.$t("ArchiveClosedReference.FieldValue")) + "\n                      "), _c("span", {
    staticClass: "text-danger"
  ...
  }), _vm._v(" "), !_vm.$v.create.field_value.minLength ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v("\n                      " + _vm._s(_vm.$t("general.Itmustbeatleast")) + "\n                      " + _vm._s(_vm.$v.create.field_value.$params.minLength.min) + "\n                      " + _vm._s(_vm.$t("general.letters")) + "\n                    ")]) : _vm._e(), _vm._v(" "), !_vm.$v.create.field_value.maxLength ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v("\n                      " + _vm._s(_vm.$t("general.Itmustbeatmost")) + "\n                      " + _vm._s(_vm.$v.create.field_value.$params.maxLength.max) + "\n                      " + _vm._s(_vm.$t("general.letters")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.errors.field_value ? _vm._l(_vm.errors.field_value, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
  }) : _vm._e()], 2)])])])]), _vm._v(" "), _c("div", {
  ...
  })])]), _vm._v(" "), _vm.setting.arch_docfields_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("ArchiveClosedReference.ArcDocField")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.archiveClosedReferenceAr.sort(_vm.sortString("arch_docfields_id"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("ArchiveClosedReference.FieldValue")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.archiveClosedReferenceAr.sort(_vm.sortString("field_value"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]), _vm._v(" "), _vm.archiveClosedReferenceAr.length > 0 ? _c("tbody", _vm._l(_vm.archiveClosedReferenceAr, function (data, index) {
    return _c("tr", {
      key: data.id,
    ...
    })])]), _vm._v(" "), _vm.setting.arch_docfields_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.arch_docfields_id ? _vm.$i18n.locale == "ar" ? data.arch_docfield.name : data.arch_docfield.name_e : "") + "\n                  ")])]) : _vm._e(), _vm._v(" "), _vm.setting.field_value ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
      ...
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.deleteArchiveClosedReference(data.id);
        }
      }
    }, [_c("div", {
      staticClass: "d-flex justify-content-between align-items-center text-black"
      ...
      attrs: {
        ...
        title: _vm.$t("ArchiveClosedReference.EditArchiveClosedReference"),
        "title-class": "font-18",
        "body-class": "p-4",
        size: "lg",
        "hide-footer": true
      ...
      model: {
        value: _vm.edit.arch_docfields_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "arch_docfields_id", $$v);
        },
        expression: "edit.arch_docfields_id"
      }
    }), _vm._v(" "), !_vm.$v.edit.arch_docfields_id.integer ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v(_vm._s(_vm.$t("general.fieldIsInteger")))]) : _vm._e(), _vm._v(" "), _vm.errors.arch_docfields_id ? _vm._l(_vm.errors.arch_docfields_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
    ...
    }), _vm._v(" "), !_vm.$v.edit.field_value.minLength ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                  " + _vm._s(_vm.$t("general.Itmustbeatleast")) + "\n                                  " + _vm._s(_vm.$v.edit.field_value.$params.minLength.min) + "\n                                  " + _vm._s(_vm.$t("general.letters")) + "\n                              ")]) : _vm._e(), _vm._v(" "), !_vm.$v.edit.field_value.maxLength ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                  " + _vm._s(_vm.$t("general.Itmustbeatmost")) + "\n                                  " + _vm._s(_vm.$v.edit.field_value.$params.maxLength.max) + "\n                                  " + _vm._s(_vm.$t("general.letters")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.field_value ? _vm._l(_vm.errors.field_value, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      }, [_vm._v(_vm._s(errorMessage))]);
...
/***/ "./resources/js/views/pages/archiving/archive-closed-reference/index.vue":
/*!*******************************************************************************!*\
  !*** ./resources/js/views/pages/archiving/archive-closed-reference/index.vue ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_29f26252___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=29f26252& */ "./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=template&id=29f26252&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_29f26252___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_29f26252___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/archiving/archive-closed-reference/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************!*\
  !*** ./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=template&id=29f26252&":
/*!**************************************************************************************************************!*\
  !*** ./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=template&id=29f26252& ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_29f26252___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_29f26252___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_29f26252___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=29f26252& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/archive-closed-reference/index.vue?vue&type=template&id=29f26252&");
