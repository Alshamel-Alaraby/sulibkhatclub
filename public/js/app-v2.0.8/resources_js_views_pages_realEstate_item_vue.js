  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("real-estate/Category-item", _objectSpread(_objectSpread({}, this.create), {}, {
...
/* harmony import */ var _components_create_general_unit_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../components/create/general/unit.vue */ "./resources/js/components/create/general/unit.vue");
...
/* harmony import */ var _components_general_loader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/general/loader */ "./resources/js/components/general/loader.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    Unit: _components_create_general_unit_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    ...
    loader: _components_general_loader__WEBPACK_IMPORTED_MODULE_9__["default"],
  ...
  validations: {
    create: {
      ...
      price: {
        ...
        minValue: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__.minValue)(0)
      },
      unit_id: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__.requiredIf)(function (model) {
  ...
  methods: {
    ...
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/customTable/table-columns/rlst_items").then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/Category-item?item_id=".concat(_this6.item_id)).then(function (res) {
                _this6.itemCategories = res.data.data;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_8___default().fire({
                  icon: "error",
                  title: "".concat(_this6.$t("general.Error")),
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("real-estate/Category-item").then(function (res) {
                var l = res.data.data;
                if (_this7.isPermission('create category RealState')) {
                  l.unshift({
                    id: 0,
                    name: "اضف فئة",
                    name_e: "Add category"
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.itemsPagination.last_page && this.current_page != this.itemsPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/item?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this10.items = l.data;
          _this10.itemsPagination = l.pagination;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              if (!_this13.isVisible('unit_id')) {
                _context3.next = 3;
                break;
              }
              _context3.next = 3;
              return _this13.getUnits();
            case 3:
              _context3.next = 5;
              return _this13.getCategories();
            case 5:
              _this13.create = {
                code_number: "",
                name: "",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid && !this.isVaildPhone) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/real-estate/item", _objectSpread(_objectSpread({}, this.create), {}, {
          company_id: this.$store.getters["auth/company_id"]
        })).then(function (res) {
          _this15.item_id = res.data.data.id;
          _this15.getData();
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_8___default().fire({
              icon: "success",
    ...
    editSubmit: function editSubmit(id, index) {
      ...
      if (this.images) this.images.forEach(function (e) {
        _this16.edit.old_media.push(e.id);
      });
          ...
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/units").then(function (res) {
                var l = res.data.data;
                if (_this17.isPermission('create Unit')) {
                  l.unshift({
                    id: 0,
                    name: "اضف وحدة",
                    name_e: "Add unit"
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              item = _this18.items.find(function (e) {
                return id == e.id;
              });
              if (!_this18.isVisible('unit_id')) {
                _context5.next = 4;
                break;
              }
              _context5.next = 4;
              return _this18.getUnits();
            case 4:
              _context5.next = 6;
              return _this18.getCategories();
            case 6:
              _this18.item_id = item.id;
              _context5.next = 9;
              return _this18.getItemCategories();
            case 9:
              _this18.edit.name = item.name;
              _this18.edit.name_e = item.name_e;
              _this18.edit.unit_id = item.unit_id;
              _this18.edit.code_number = item.code_number;
              _this18.edit.price = item.price;
              _this18.edit.type = item.type;
              _this18.errors = {};
              _this18.images = (_item$media = item.media) !== null && _item$media !== void 0 ? _item$media : [];
      ...
      if (file) {
        ...
        if (!this.idDelete) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/media", formDate).then(function (res) {
            var old_media = [];
            _this19.images.forEach(function (e) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/real-estate/item/".concat(_this19.item_id), {
              old_media: old_media,
              media: new_media
            }).then(function (res) {
              var _res$data$data$media;
              _this19.images = (_res$data$data$media = res.data.data.media) !== null && _res$data$data$media !== void 0 ? _res$data$data$media : [];
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_8___default().fire({
            ...
            if (result.value) {
              ...
              _formDate.append("media[0]", _this19.media);
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/media", _formDate).then(function (res) {
                var old_media = [];
                _this19.images.forEach(function (e) {
                  return old_media.push(e.id);
                });
                old_media.splice(old_media.indexOf(_this19.idDelete), 1);
                var new_media = [];
                res.data.data.forEach(function (e) {
                  return new_media.push(e.id);
                });
                _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/real-estate/".concat(_this19.item_id), {
                  old_media: old_media,
                  media: new_media
                }).then(function (res) {
                  var _res$data$data$media2;
                  _this19.images = (_res$data$data$media2 = res.data.data.media) !== null && _res$data$data$media2 !== void 0 ? _res$data$data$media2 : [];
                  if (_this19.images && _this19.images.length > 0) {
                    _this19.showPhoto = _this19.images[_this19.images.length - 1].webp;
                  } else {
                    _this19.showPhoto = "./images/img-1.png";
    ...
    deleteImageCreate: function deleteImageCreate(id, index) {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/real-estate/item/".concat(this.item_id), {
        ...
        _this20.items[index] = res.data.data;
        _this20.images = (_res$data$data$media3 = res.data.data.media) !== null && _res$data$data$media3 !== void 0 ? _res$data$data$media3 : [];
        if (_this20.images && _this20.images.length > 0) {
          _this20.showPhoto = _this20.images[_this20.images.length - 1].webp;
        } else {
          _this20.showPhoto = "./images/img-1.png";
        }
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_8___default().fire({
          icon: "error",
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Unit", {
  ...
  }, [_vm.isPermission("create items RealState") ? _c("b-button", {
    directives: [{
      name: "b-modal",
  ...
  })]), _vm._v(" "), _vm.checkAll.length == 1 && _vm.isPermission("update items RealState") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
  ...
  })]) : _vm._e(), _vm._v(" "), _vm.checkAll.length > 1 && _vm.isPermission("delete items RealState") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
        $event.preventDefault();
  ...
  }, [_vm.isVisible("code_number") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("item_name_en")) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("unit_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    staticClass: "row"
  }, [_vm.isVisible("code_number") ? _c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", {
  ...
  }, [_vm._v("\n                                                            " + _vm._s(_vm.getCompanyKey("code_number")) + "\n                                                            "), _vm.isRequired("code_number") ? _c("span", {
    staticClass: "text-danger"
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("unit_id") ? _c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    staticClass: "form-group position-relative"
  }, [_c("label", {
    staticClass: "control-label"
  }, [_vm._v("\n                                                            " + _vm._s(_vm.getCompanyKey("item_unit")) + "\n                                                            "), _vm.isRequired("unit_id") ? _c("span", {
    staticClass: "text-danger"
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.code_number && _vm.isVisible("code_number") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_id && _vm.isVisible("unit_id") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    return _c("tr", {
      ...
      on: {
        ...
        dblclick: function dblclick($event) {
          $event.preventDefault();
          _vm.isPermission("update items RealState") ? _vm.$bvModal.show("modal-edit-".concat(data.id)) : false;
        }
      }
    }, [_vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.code_number && _vm.isVisible("code_number") ? _c("td", [_vm._v("\n                                            " + _vm._s(data.code_number) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.setting.name && _vm.isVisible("name") ? _c("td", [_vm._v("\n                                            " + _vm._s(data.name) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.setting.name_e && _vm.isVisible("name_e") ? _c("td", [_vm._v("\n                                            " + _vm._s(data.name_e) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.setting.unit_id && _vm.isVisible("unit_id") ? _c("td", [_vm._v("\n                                            " + _vm._s(data.unit ? _vm.$i18n.locale == "ar" ? data.unit.name : data.unit.name_e : "") + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.setting.type && _vm.isVisible("type") ? _c("td", [_vm._v("\n                                            " + _vm._s(data.type) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.setting.price && _vm.isVisible("price") ? _c("td", [_vm._v("\n                                            " + _vm._s(data.price) + "\n                                        ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      staticClass: "btn-group"
    }, [_c("button", {
      ...
      staticClass: "dropdown-menu dropdown-menu-custom"
    }, [_vm.isPermission("update items RealState") ? _c("a", {
      staticClass: "dropdown-item",
      attrs: {
        href: "#"
      },
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.isPermission("delete items RealState") ? _c("a", {
      staticClass: "dropdown-item text-black",
      attrs: {
        href: "#"
      },
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_item_vue_vue_type_style_index_0_id_05a08d84_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./item.vue?vue&type=style&index=0&id=05a08d84&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/item.vue?vue&type=style&index=0&id=05a08d84&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_item_vue_vue_type_style_index_0_id_05a08d84_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_item_vue_vue_type_style_index_0_id_05a08d84_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./item.vue?vue&type=style&index=0&id=05a08d84&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/item.vue?vue&type=style&index=0&id=05a08d84&lang=css&");
