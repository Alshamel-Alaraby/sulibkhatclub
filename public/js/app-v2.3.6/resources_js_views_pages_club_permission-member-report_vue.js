  ...
  methods: {
    ...
    getData: function getData() {
      ...
      if (this.cm_permission_id.length == 0) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire({
          ...
          text: "".concat(this.$t("general.YouMustChoosePermission"))
        });
        return;
      }
      this.isLoader = true;
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/members/report-cm-member?members_permissions_id=".concat(this.cm_permission_id, "&page=").concat(page, "&per_page=50&search=").concat(this.search, "&").concat(filter), {
        params: {
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.itemsPagination.last_page && this.current_page != this.itemsPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/members/report-cm-member?members_permissions_id=".concat(this.cm_permission_id, "&page=").concat(this.current_page, "&per_page=50&search=").concat(this.search, "&").concat(filter), {
          params: {
            members_permissions_id: this.cm_permission_id
          }
        }).then(function (res) {
