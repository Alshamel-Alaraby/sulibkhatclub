                            ...
                            [
                              _c("label", { staticClass: "control-label" }, [
                                _vm._v(
                                  "\n                                            " +
                                    _vm._s(
                                      _vm.getCompanyKey("member_permission")
                                    ) +
                                    "\n                                            "
                                ),
                                _c("span", { staticClass: "text-danger" }, [
                              ...
                              _vm._v(" "),
                              _vm.$v.create.cm_permissions_id.$error ||
                        ...
                        _c("div", { staticClass: "col-md-6" }, [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _vm.$v.create.cm_financial_status_id.$error ||
                              ...
                              _c("input", {
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value:
                                      _vm.$v.create.membership_period.$model,
                                    expression:
                                      "$v.create.membership_period.$model",
                                  },
                                ],
                                staticClass: "form-control",
                                class: {
                                  "is-invalid":
                                    _vm.$v.create.membership_period.$error ||
                                    _vm.errors.membership_period,
                                  "is-valid":
                                    !_vm.$v.create.membership_period.$invalid &&
                                    !_vm.errors.membership_period,
                                },
                                attrs: { type: "number" },
                                domProps: {
                                ...
                                on: {
                                  input: function ($event) {
                                    ...
                                    _vm.$set(
                                      _vm.$v.create.membership_period,
                                      "$model",
                                      $event.target.value
                                    )
                                  },
                                  ...
                                  [
                                    ...
                                    _c(
                                      "select",
                                      {
                                        ...
                                        class: {
                                          "is-invalid":
                                            _vm.$v.create.day.$error ||
                                            _vm.errors.day,
                                          "is-valid":
                                            !_vm.$v.create.day.$invalid &&
                                            !_vm.errors.day,
                                        },
                                        on: {
                                        ...
                                        directives: [
                                          {
                                            ...
                                            expression:
                                              "$v.create.month.$model",
                                          },
                                        ],
                                        staticClass: "custom-select",
                                        class: {
                                          "is-invalid":
                                            _vm.$v.create.month.$error ||
                                            _vm.errors.month,
                                          "is-valid":
                                            !_vm.$v.create.month.$invalid &&
                                            !_vm.errors.month,
                                        },
                                        on: {
                                          change: function ($event) {
