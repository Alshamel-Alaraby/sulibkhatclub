...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/members?page=".concat(page, "&per_page=").concat(this.per_page, "&member_type_id=").concat(this.member_type_id)).then(function (res) {
        var l = res.data;
        _this3.items = l.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.itemsPagination.last_page && this.current_page != this.itemsPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/members/?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&member_type_id=").concat(this.member_type_id)).then(function (res) {
          var l = res.data;
          _this4.items = l.data;
