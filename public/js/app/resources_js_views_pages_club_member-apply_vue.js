...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      is_disabled: false,
      filterSetting: ["full_name", "document_no", "birth_date", "national_id", "home_phone", "work_phone", "home_address", "work_address", "job", "degree"],
      codeCountry: "",
      printLoading: true,
      printObj: {
        id: "printData"
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/club-members/member-requests", _objectSpread(_objectSpread({}, this.create), {}, {
          ...
          _this11.$bvModal.hide("check_national_id");
          _this11.member_request_id = res.data.data.id;
        })["catch"](function (err) {
          if (err.response.data) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/club-members/member-requests/checkNationalId?national_id=".concat(_this14.create.national_id)).then(function (res) {
                _this14.isLoader = false;
                var l = res.data;
                if (l) {
                  _this14.$bvModal.show("check_national_id");
                  _this14.checkMembers = l;
                } else {
                  _this14.AddSubmit();
                }
              })["catch"](function (err) {
