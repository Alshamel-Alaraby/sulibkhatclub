...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      is_disabled: false,
      filterSetting: ["full_name", "document_no", "birth_date", "national_id", "home_phone", "work_phone", "home_address", "work_address", "job", "degree", "sponsor_id"],
      codeCountry: "",
      printLoading: true,
      printObj: {
        id: "printData"
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 6:
              _this10.create = {
                ...
                last_name: "",
                family_name: "",
                birth_date: _this10.formatDate(new Date()),
                national_id: "",
                nationality_number: "",
                home_phone: "",
                work_phone: "",
  ...
  return _c("div", [_c("b-modal", {
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.branches.find(function (x) {
          return x.id == opt;
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.serials.find(function (x) {
          return x.id == opt;
