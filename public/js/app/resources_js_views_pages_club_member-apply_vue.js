    ...
    resetModal: function resetModal() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _this10.birth_date = new Date();
              _this10.applying_date = new Date();
              _this10.codeCountry = _this10.$store.getters["locationIp/countryCode"];
              if (!_this10.isVisible('sponsor_id')) {
                _context2.next = 6;
                break;
              }
              _context2.next = 6;
              return _this10.getSponsors();
            case 6:
              _this10.create = {
                applying_date: _this10.formatDate(new Date()),
                // applying_number: "",
                first_name: "",
                phone_code: "",
                second_name: "",
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/club-members/member-requests", _objectSpread(_objectSpread({}, this.create), {}, {
          ...
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
              icon: "success",
              text: "".concat(_this12.$t("general.Addedsuccessfully")),
              showConfirmButton: false,
              timer: 1500
            });
          }, 500);
          _this12.$bvModal.hide("check_national_id");
          _this12.member_request_id = res.data.data.id;
        })["catch"](function (err) {
          if (err.response.data) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 3:
              member = _this14.members.find(function (e) {
                return id == e.id;
              });
              _this14.birth_date = new Date(member.birth_date);
              _this14.applying_date = new Date(member.applying_date);
              _this14.edit.applying_number = member.applying_number;
              _this14.edit.first_name = member.first_name;
              _this14.edit.second_name = member.second_name;
              _this14.edit.phone_code = member.phone_code;
              _this14.edit.third_name = member.third_name;
              _this14.edit.last_name = member.last_name;
              _this14.edit.family_name = member.family_name;
              _this14.edit.birth_date = member.birth_date;
              _this14.edit.applying_date = member.applying_date;
              _this14.edit.national_id = member.national_id;
              _this14.edit.nationality_number = member.nationality_number;
              _this14.edit.home_phone = member.home_phone;
              _this14.edit.work_phone = member.work_phone;
              _this14.edit.home_address = member.home_address;
              _this14.edit.work_address = member.work_address;
              _this14.edit.job = member.job;
              _this14.edit.degree = member.degree;
              _this14.edit.gender = member.gender;
              _this14.edit.member_type_id = member.member_type_id;
              _this14.edit.sponsor_id = member.sponsor_id;
              _this14.edit.application_number = member.application_number;
              _this14.transaction = member.transaction;
              _this14.member_request_id = member.id;
              _this14.errors = {};
            case 30:
            case "end":
              return _context3.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/club-members/member-requests/checkNationalId?national_id=".concat(_this16.create.national_id)).then(function (res) {
                _this16.isLoader = false;
                var l = res.data;
                if (l) {
                  _this16.$bvModal.show("check_national_id");
                  _this16.checkMembers = l;
                } else {
                  _this16.AddSubmit();
                }
              })["catch"](function (err) {
