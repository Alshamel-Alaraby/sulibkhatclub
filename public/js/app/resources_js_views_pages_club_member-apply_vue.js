...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col-8"
  }, [_c("b", [_vm._v(_vm._s(_vm.$t("general.We got from Mr")) + "  : " + _vm._s(_vm.data_row.member ? _vm.data_row.member.full_name : _vm.data_row.member_request.full_name))])]), _vm._v(" "), _c("h3", {
    staticClass: "col-4"
  }, [_c("b", [_vm._v(_vm._s(_vm.$t("general.NoMembership")) + " : " + _vm._s(_vm.data_row.member ? _vm.data_row.member.membership_number : ""))])])]), _vm._v(" "), _c("h3", [_c("b", [_vm._v(_vm._s(_vm.$t("general.According to the cash amount and its amount")) + " ( " + _vm._s(_vm.data_row.amount + " " + _vm.$t("general.APPKDW")) + " ) " + _vm._s(_vm.convert_currency_to_words(_vm.data_row.amount)) + " " + _vm._s(_vm.$t("general.KDW") + " " + _vm.$t("general.Just nothing else")))])]), _vm._v(" "), _c("h3", [_c("b", [_vm._v(_vm._s(_vm.$t("general.This is the cost of subscribe/annual subscription to the club for up to one year")) + " " + _vm._s(_vm.data_row.year))])]), _vm._v(" "), _c("div", {
    staticStyle: {
      display: "flex",
