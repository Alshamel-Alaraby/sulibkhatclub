(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_booking_report_occupied_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_5__["default"])(vm, "Daily Occupied Report", "all payer member club");
    });
  },
  methods: {
    ...
    getData: function getData() {
      ...
      this.total = 0;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/booking/report/occupied-rooms-status?page=".concat(page, "&per_page=").concat(this.per_page, "&branch_id=").concat(this.member_type_id)).then(function (res) {
        var l = res.data;
        _this3.items = l.data;
        _this3.getVoucherHeadersTotal(l.data);
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.itemsPagination.last_page && this.current_page != this.itemsPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/booking/report/house-keeping?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&branch_id=").concat(this.member_type_id)).then(function (res) {
          var l = res.data;
          _this4.items = l.data;
    ...
    getMemberTypes: function getMemberTypes() {
      var _this6 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/branches?notParent=1").then(function (res) {
        _this6.member_types = res.data.data;
        if (res.data.data.length == 1) {
          _this6.member_type_id = res.data.data[0].id;
          _this6.getData();
        }
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire({
    ...
    calcExtraGuest: function calcExtraGuest(item) {
      var price = 0;
    ...
    calcRoomPrice: function calcRoomPrice(item) {
      var price = item.document_header_details[0].price_per_uint;
      if (parseInt(item.attendans_num) > item.document_header_details[0].unit.number_of_individuals) {
        price = item.document_header_details[0].price_per_uint - parseFloat(item.document_header_details[0].unit.extra_guest_price);
      }
      return price;
    },
    getVoucherHeadersTotal: function getVoucherHeadersTotal(items) {
      var _this7 = this;
      var sumItem = 0,
        service = 0,
        total = 0;
      items.forEach(function (el) {
        if (el.document_header_details && el.document_header_details.length > 0) {
          sumItem += _this7.getTotalCharge(el);
          total += parseFloat(_this7.getOutstandingBalance(el));
          if (el.customer) {
            service += _this7.getVoucherHeaders(el.customer.voucher_headers);
          }
        }
      });
      this.totalPerPrice = sumItem ? sumItem : 0;
      this.totalService = service ? service : 0;
      this.total = parseFloat(total).toFixed(3);
    },
    getVoucherHeaders: function getVoucherHeaders(items) {
      var sumItem = 0;
      if (items.length > 0) {
        sumItem = items.reduce(function (n, _ref) {
          var amount = _ref.amount;
          return parseFloat(n) + parseFloat(amount);
        }, 0);
        return sumItem;
      }
      return sumItem;
    },
    getDocumentHeaders: function getDocumentHeaders(items) {
      var sumItem = 0;
      if (items.length > 0) {
        sumItem = items.reduce(function (n, _ref2) {
          var net_invoice = _ref2.net_invoice;
          return n + net_invoice;
        }, 0);
        return parseFloat(sumItem);
      }
      return sumItem;
    },
    getTotalCharge: function getTotalCharge(data) {
      if (data.document_header_details.length > 0 && data.document_header_details) {
        var date1 = new Date(data.document_header_details[0].date_from);
        var date2 = new Date();
        var diffTime = Math.abs(date2 - date1);
        var diffDaysPlus = Math.ceil(diffTime / (1000 * 60 * 60 * 24));
        var diffDays = diffDaysPlus - 1;
        return parseFloat(diffDays * (data.document_header_details[0].price_per_uint - data.document_header_details[0].discount / data.document_header_details[0].rent_days)) + this.getDocumentHeaders(data.customer.document_header);
      }
      return 0;
    },
    getOutstandingBalance: function getOutstandingBalance(data) {
      return parseFloat(this.getTotalCharge(data) - (data.customer ? this.getVoucherHeaders(data.customer.voucher_headers) : 0)).toFixed(3);
    },
    print: function print(status) {
      if (status == true) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=template&id=26eb39a9&scoped=true&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=template&id=26eb39a9&scoped=true& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                            " + _vm._s(_vm.$t("general.dailyOccupied")) + "\n                        ")]), _vm._v(" "), _c("div", {
    ...
    attrs: {
      options: _vm.member_types.map(function (type) {
        return type.id;
      }),
      "custom-label": function customLabel(opt) {
        return _vm.member_types.find(function (x) {
          return x.id == opt;
        }) ? _vm.$i18n.locale == "ar" ? _vm.member_types.find(function (x) {
          return x.id == opt;
        }).name : _vm.member_types.find(function (x) {
          return x.id == opt;
        }).name_e : null;
      }
    },
    ...
    model: {
      value: _vm.member_type_id,
      callback: function callback($$v) {
        _vm.member_type_id = $$v;
      },
      expression: "member_type_id"
    }
  })], 1), _vm._v(" "), _c("div", {
  ...
  }, [_c("span", [_vm._v("Landscape")])])]), _vm._v(" "), _c("a", {
    ...
    staticClass: "d-flex justify-content-between align-items-center text-black"
  }, [_c("span", [_vm._v("Portrait")])])])])]), _vm._v(" "), _vm.checkAll.length == 1 ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
  ...
  }, [_vm._v("Apply")])])], 1)], 1), _vm._v(" "),  false ? 0 : _vm._e()])])]), _vm._v(" "), _c("div", {
    ref: "exportable_table",
    attrs: {
      id: "printData"
    }
  }, [_c("div", {
    staticClass: "head-branch text-center"
  }, [_c("h2", [_vm._v("\n                                DIVONA HOTAL\n                                "), _vm.member_types.find(function (el) {
    return el.id == _vm.member_type_id;
  }) ? _c("span", [_vm.member_types.find(function (el) {
    return el.id == _vm.member_type_id;
  }).media ? [_c("img", {
    attrs: {
      src: _vm.member_types.find(function (el) {
        return el.id == _vm.member_type_id;
      }).media[0].url
    }
  })] : _vm._e()], 2) : _vm._e(), _vm._v("\n                                فندق ديفونا\n                            ")]), _vm._v(" "), _c("p", {
    staticClass: "font-weight-bold"
  }, [_vm._v("- DAILY OCCUPIED ROOMS REPORT -")]), _vm._v(" "), _c("div", [_vm._v("\n                                " + _vm._s(_vm.$t("general.branch")) + ":\n                                "), _vm.member_types.find(function (x) {
    return x.id == _vm.member_type_id;
  }) ? [_vm._v("\n                                    " + _vm._s(_vm.$i18n.locale == "ar" ? _vm.member_types.find(function (x) {
    return x.id == _vm.member_type_id;
  }).name : _vm.member_types.find(function (x) {
    return x.id == _vm.member_type_id;
  }).name_e) + "\n                                ")] : _vm._e()], 2), _vm._v(" "), _vm.$store.state.auth.type == "admin" ? _c("div", {
    staticClass: "ml-1"
  }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.admin")) + ":\n                                " + _vm._s(_vm.$i18n.locale ? _vm.$store.getters["auth/partner"].name : _vm.$store.getters["auth/partner"].name_e) + "\n                            ")]) : _c("div", {
    staticClass: "ml-1"
  }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.admin")) + ":\n                                " + _vm._s(_vm.$i18n.locale ? _vm.$store.state.auth.user.name : _vm.$store.state.auth.user.name_e) + "\n                            ")])]), _vm._v(" "), _c("div", {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("houseKeepingDaily_rome")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_invoice_number")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_guest_name")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_nationality")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_pax")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_type")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_Arrival")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_departure")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_accommodation_rate")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_extra_guest")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_service_charge")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_discount")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_accomodationNetRate")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_total_charges")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_total_payment")))])])]), _vm._v(" "), _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("dailyCheckedIn_outstanding_balance")))])])])])]), _vm._v(" "), _vm.items.length > 0 ? _c("tbody", [_vm._l(_vm.items, function (data, index) {
    var _vm$getOutstandingBal;
    return _c("tr", {
      key: data.id,
    ...
    }, [_c("td", [_vm._v("\n                                        " + _vm._s(data.document_header_details.length > 0 ? data.document_header_details[0].unit ? data.document_header_details[0].unit.code : "-" : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(data.serial_number))]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.customer ? _vm.$i18n.locale == "ar" ? data.customer.name : data.customer.name_e : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.customer ? data.customer.nationality : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(data.attendans_num))]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.document_header_details ? data.document_header_details[0] ? data.document_header_details[0].category_booking : "-" : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.document_header_details ? data.document_header_details.length > 0 ? data.document_header_details[0] ? data.document_header_details[0].date_from : "-" : "-" : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.document_header_details ? data.document_header_details.length > 0 ? data.document_header_details[0] ? data.document_header_details[0].date_to : "-" : "-" : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(_vm.calcRoomPrice(data)) + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.calcExtraGuest(data)))]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.customer ? _vm.getDocumentHeaders(data.customer.document_header) : "0") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.document_header_details ? data.document_header_details[0] ? data.document_header_details[0].discount / data.document_header_details[0].rent_days : "-" : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.document_header_details ? data.document_header_details[0] ? data.document_header_details[0].price_per_uint - data.document_header_details[0].discount / data.document_header_details[0].rent_days : "-" : "-") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(_vm.getTotalCharge(data)) + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v("\n                                        " + _vm._s(data.customer ? _vm.getVoucherHeaders(data.customer.voucher_headers) : "0") + "\n                                    ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s((_vm$getOutstandingBal = _vm.getOutstandingBalance(data)) !== null && _vm$getOutstandingBal !== void 0 ? _vm$getOutstandingBal : 0))])]);
  }), _vm._v(" "), _c("tr", [_c("td", {
    attrs: {
      colspan: "12"
    }
    ...
    staticClass: "colPay"
  }, [_vm._v(_vm._s(_vm.$t("general.total")))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.totalPerPrice))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.totalService))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.total))])])], 2) : _c("tbody", [_c("tr", [_c("th", {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.signature[data-v-26eb39a9] {\r\n    display: none;\n}\n.head-branch[data-v-26eb39a9] {\r\n    display: none;\n}\n.colPay[data-v-26eb39a9]{\r\n    background-color: #3bafda;\r\n    color: #fff;\r\n    font-weight: 500;\n}\n@media print {\n.colPay[data-v-26eb39a9]{\r\n        color: #000;\n}\n.head-branch[data-v-26eb39a9] {\r\n        margin-top: 50px;\r\n        display: block;\n}\n.head-branch h2[data-v-26eb39a9]{\r\n        text-decoration: underline;\n}\n.head-branch img[data-v-26eb39a9]{\r\n        width: 100px;\r\n        height: 100px;\n}\n.head-branch span[data-v-26eb39a9] {\r\n        display: inline-block;\r\n        position: relative;\r\n        top: -49px;\n}\n.do-not-print[data-v-26eb39a9] {\r\n        display: none;\n}\n.arrow-sort[data-v-26eb39a9] {\r\n        display: none;\n}\ntable thead tr th[data-v-26eb39a9] {\r\n        color: #000;\r\n        border: 1px solid #000;\n}\ntable tbody tr td[data-v-26eb39a9] {\r\n        color: #000;\r\n        border: 1px solid #000;\n}\nhr[data-v-26eb39a9] {\r\n        transform: rotate(90deg);\r\n        background-color: #0000008a;\r\n        border: 1px solid #4444449c;\n}\n.custom-table-theme thead[data-v-26eb39a9] {\r\n        border-top: 1px solid #000;\r\n        border-bottom: 1px solid #000;\n}\n.custom-table-theme tbody[data-v-26eb39a9] {\r\n        border: 1px solid #000;\n}\n.signature[data-v-26eb39a9] {\r\n        display: block;\n}\n.signature h4[data-v-26eb39a9] {\r\n        text-decoration: underline;\r\n        margin: 3px;\n}\n}\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_style_index_0_id_26eb39a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_style_index_0_id_26eb39a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/views/pages/booking/report/occupied.vue":
/*!**************************************************************!*\
  !*** ./resources/js/views/pages/booking/report/occupied.vue ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _occupied_vue_vue_type_template_id_26eb39a9_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./occupied.vue?vue&type=template&id=26eb39a9&scoped=true& */ "./resources/js/views/pages/booking/report/occupied.vue?vue&type=template&id=26eb39a9&scoped=true&");
/* harmony import */ var _occupied_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./occupied.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/booking/report/occupied.vue?vue&type=script&lang=js&");
/* harmony import */ var _occupied_vue_vue_type_style_index_0_id_26eb39a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css& */ "./resources/js/views/pages/booking/report/occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _occupied_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _occupied_vue_vue_type_template_id_26eb39a9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _occupied_vue_vue_type_template_id_26eb39a9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "26eb39a9",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/booking/report/occupied.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/booking/report/occupied.vue?vue&type=script&lang=js&":
/*!***************************************************************************************!*\
  !*** ./resources/js/views/pages/booking/report/occupied.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./occupied.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/booking/report/occupied.vue?vue&type=template&id=26eb39a9&scoped=true&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/views/pages/booking/report/occupied.vue?vue&type=template&id=26eb39a9&scoped=true& ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_template_id_26eb39a9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_template_id_26eb39a9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_template_id_26eb39a9_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./occupied.vue?vue&type=template&id=26eb39a9&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=template&id=26eb39a9&scoped=true&");
...
/***/ "./resources/js/views/pages/booking/report/occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css&":
/*!***********************************************************************************************************************!*\
  !*** ./resources/js/views/pages/booking/report/occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css& ***!
  \***********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_occupied_vue_vue_type_style_index_0_id_26eb39a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/booking/report/occupied.vue?vue&type=style&index=0&id=26eb39a9&scoped=true&lang=css&");
