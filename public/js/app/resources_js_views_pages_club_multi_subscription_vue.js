...
var render = function render() {
  ...
  return _vm.data_row.length > 0 ? _c("div", {
    ...
    return _c("div", {
      ...
      staticClass: "col-4"
    }, [_c("b", [_vm._v(_vm._s(_vm.$t("general.NoMembership")) + " : " + _vm._s(data.member.membership_number))])])]), _vm._v(" "), _c("h3", [_c("b", [_vm._v(_vm._s(_vm.$t("general.According to the cash amount and its amount")) + " ( " + _vm._s(data.amount + " " + _vm.$t("general.APPKDW")) + " ) " + _vm._s(_vm.convertToArabicWords(data.amount)) + " " + _vm._s(_vm.$t("general.KDW") + " " + _vm.$t("general.Just nothing else")))])]), _vm._v(" "), _c("h3", [_c("b", [_vm._v(_vm._s(_vm.$t("general.This is the cost of renewal/annual subscription to the club for up to one year")) + " " + _vm._s(data.year))])]), _vm._v(" "), _c("div", {
      staticStyle: {
        display: "flex",
