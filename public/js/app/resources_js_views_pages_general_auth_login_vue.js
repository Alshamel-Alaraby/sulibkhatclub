        ...
        if (this.login_as == "admin") {
          axios.post("".concat("https://admin.alshamelalaraby2.com/", "api/partners/login"), {
            ...
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(res) {
              var l, _l$partner, id, name, name_e, is_active, email, mobile_no;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _this.$store.commit("auth/editWorkFlowTrees", ["dictionary", "home", "Company"]);
                    ...
                    if (l.partner.companies.length > 1 && l.partner.companies) {
                      ...
                      if (l.partner.companies[0].is_active == 1) {
                        ...
                        _this.getProgramsAndModulesForCompany(l.partner.companies[0].id);
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _this2.$store.commit("auth/editWorkFlowTrees", ["home"].concat(workflowTree));
            case 4:
            case "end":
