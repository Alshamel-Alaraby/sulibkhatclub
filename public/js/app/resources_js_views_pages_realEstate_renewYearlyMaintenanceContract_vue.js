(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_realEstate_renewYearlyMaintenanceContract_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _api_adminAxios__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../api/adminAxios */ "./resources/js/api/adminAxios.js");
...
/* harmony import */ var _helper_PageTitle__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../helper/PageTitle */ "./resources/js/helper/PageTitle.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  page: {
    ...
    meta: [{
      name: "RenewYearlyMaintenanceContract",
      content: "RenewYearlyMaintenanceContract"
    }]
  },
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_3__["default"])(vm, "Renew Yearly Maintenance Contract", "all RenewYearlyMaintenanceContract");
    });
  },
  components: {
  ...
  mixins: [_helper_mixin_translation_mixin__WEBPACK_IMPORTED_MODULE_6__["default"], _helper_mixin_success_error__WEBPACK_IMPORTED_MODULE_11__["default"]],
  computed: {
    pageTitle: function pageTitle() {
      return _helper_PageTitle__WEBPACK_IMPORTED_MODULE_10__["default"].value;
    }
  },
  data: function data() {
    return {
      ...
      filterSetting: ['date', 'customer_id', 'prefix'],
      errors: {},
      isCheckAll: false,
      checkAll: [],
      buildings: [],
  ...
  watch: {
    ...
    pageTitle: {
      handler: function handler(newV, old) {
        this.page_title = _helper_PageTitle__WEBPACK_IMPORTED_MODULE_10__["default"].value;
      }
    }
  },
  mounted: function mounted() {
  ...
  methods: {
    getBuildings: function getBuildings() {
      var _this3 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_8__["default"].get("/real-estate/buildings").then(function (res) {
        var l = res.data.data;
        _this3.buildings = l;
      })["catch"](function (err) {
    ...
    getData: function getData() {
      var _this$searchFilter$da,
        _this$searchFilter$bu,
        _this4 = this;
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_8__["default"].get("document-headers/all_renew_contract_header?document_id=".concat(44, "&start_date=", (_this$searchFilter$da = this.searchFilter.date) !== null && _this$searchFilter$da !== void 0 ? _this$searchFilter$da : '', "&building_id=").concat((_this$searchFilter$bu = this.searchFilter.building_id) !== null && _this$searchFilter$bu !== void 0 ? _this$searchFilter$bu : '', "&page=").concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&is_quotation=1")).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.reservationsPagination.last_page && this.current_page != this.reservationsPagination.current_page && this.current_page) {
        var _this$searchFilter$da2, _this$searchFilter$bu2;
        this.isLoader = true;
        var _filterSetting = _toConsumableArray(this.filterSetting);
        var index = this.filterSetting.indexOf("customer_id");
        if (index > -1) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_8__["default"].get("document-headers/all_renew_contract_header?document_id=".concat(44, "&date=", (_this$searchFilter$da2 = this.searchFilter.date) !== null && _this$searchFilter$da2 !== void 0 ? _this$searchFilter$da2 : '', "&building_id=").concat((_this$searchFilter$bu2 = this.searchFilter.building_id) !== null && _this$searchFilter$bu2 !== void 0 ? _this$searchFilter$bu2 : '', "&page=").concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&is_quotation=1")).then(function (res) {
          var l = res.data;
          _this5.reservations = l.data;
          _this5.reservationsPagination = l.pagination;
    ...
    RenewContracts: function RenewContracts() {
      var _this6 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_8__["default"].post("document-headers/bulk-renew-contract", {
                ids: _this6.checkAll,
                date_from: _this6.renew.date_from,
                date_to: _this6.renew.date_to
              }).then(function (res) {
                _this6.isLoader = false;
                setTimeout(function () {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                    icon: "success",
                    text: "".concat(_this6.$t("general.Renewed Successfully")),
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_8__["default"].get("/document/".concat(44)).then(function (res) {
                _this7.isLoader = false;
                var l = res.data.data;
                _this7.document = l;
                _this7.relatedDocuments = l.document_relateds;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                  icon: "error",
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_8__["default"].get("document-headers/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || (_this9.document.name + '.' || 0) + (type || 'xlsx'));
        }
     ...
     */
    resetModalHiddenSearchFilter: function resetModalHiddenSearchFilter() {
     ...
     */
    resetModalSearchFilter: function resetModalSearchFilter() {
      var _this10 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", [_c("div", {
    staticClass: "row"
  }, [_c("div", {
    staticClass: "col-12"
  }, [_c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.page_title && _vm.page_title.url == _vm.$route.fullPath ? _vm.$i18n.locale == "ar" ? _vm.page_title.title : _vm.page_title.title_e : _vm.$i18n.locale == "ar" ? _vm.$t("general.table") + " " + _vm.document.name : _vm.document.name_e + " " + _vm.$t("general.table")))]) : _c("h4", {
    staticClass: "header-title"
  }, [_vm._v(_vm._s(_vm.page_title && _vm.page_title.url == _vm.$route.fullPath ? _vm.$i18n.locale == "ar" ? _vm.page_title.title : _vm.page_title.title_e : _vm.$t("general.table")) + "\n                            ")]), _vm._v(" "), _c("div", [_c("b-button", {
    directives: [{
      name: "b-modal",
      rawName: "v-b-modal.searchFilter",
      modifiers: {
        searchFilter: true
      }
    }],
  ...
  }, [_vm._v("\n                                    " + _vm._s(_vm.$t("general.searchFilter")) + "\n                                    "), _c("i", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.serial_number")))])], 1)], 1), _vm._v(" "), _c("div", {
  ...
  })]), _vm._v(" "), _vm.checkAll.length >= 1 ? _c("b-button", {
    directives: [{
      name: "b-modal",
      rawName: "v-b-modal.renew",
      modifiers: {
        renew: true
      }
    }],
  ...
  }, [_vm._v(" " + _vm._s(_vm.$t("general.serial_number")))]), _vm._v(" "), _c("div", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.RenewContracts.apply(null, arguments);
      }
    }
  }, [_vm._v("\n                                            " + _vm._s(_vm.$t("general.Renew")) + "\n                                        ")]) : _c("b-button", {
    staticClass: "mx-1",
    ...
    model: {
      value: _vm.renew.date_from,
      callback: function callback($$v) {
        _vm.$set(_vm.renew, "date_from", $$v);
      },
      expression: "renew.date_from"
    }
    ...
    model: {
      value: _vm.renew.date_to,
      callback: function callback($$v) {
        _vm.$set(_vm.renew, "date_to", $$v);
      },
      expression: "renew.date_to"
    }
    ...
    on: {
      show: _vm.resetModalSearchFilter,
      hidden: _vm.resetModalHiddenSearchFilter
    }
  }, [_c("form", [_c("div", {
    staticClass: "mb-3 d-flex justify-content-end"
  }, [!_vm.is_disabled ? [!_vm.isLoader ? _c("b-button", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.resetModalHiddenSearchFilter.apply(null, arguments);
      }
    }
  }, [_vm._v("\n                                        " + _vm._s(_vm.$t("general.Cancel")) + "\n                                    ")])], 2), _vm._v(" "), _c("div", {
    staticClass: "row"
    ...
    staticClass: "control-label"
  }, [_vm._v("\n                                                " + _vm._s(_vm.$t("general.documentBuilding")) + "\n                                            ")]), _vm._v(" "), _c("multiselect", {
    attrs: {
      "show-labels": false,
    ...
    model: {
      value: _vm.searchFilter.building_id,
      callback: function callback($$v) {
        _vm.$set(_vm.searchFilter, "building_id", $$v);
      },
      expression: "searchFilter.building_id"
    }
  })], 1)]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.searchFilter.date,
      expression: "searchFilter.date"
    }],
    staticClass: "form-control",
    attrs: {
      type: "number"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.searchFilter, "date", $event.target.value);
      }
    }
    ...
    on: {
      click: function click($event) {
        _vm.reservations.sort(_vm.sortString("date"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.building")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.Unit")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.date_from ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.from_date")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.date_to ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.to_date")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.amount ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    on: {
      click: function click($event) {
        _vm.reservations.sort(_vm.sortString("net_invoice"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    on: {
      click: function click($event) {
        _vm.reservations.sort(_vm.sortString("prefix"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                                " + _vm._s(data.header_details[0] ? _vm.$i18n.locale == "ar" ? data.header_details[0].building.name : data.header_details[0].building.name_e : "") + "\n                                            ")])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                                " + _vm._s(data.header_details[0] ? _vm.$i18n.locale == "ar" ? data.header_details[0].unit.name : data.header_details[0].unit.name_e : "") + "\n                                            ")])]) : _vm._e(), _vm._v(" "), _vm.setting.date_from ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                                " + _vm._s(data.header_details[0] ? data.header_details[0].date_from : "") + "\n                                            ")])]) : _vm._e(), _vm._v(" "), _vm.setting.date_to ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                                " + _vm._s(data.header_details[0] ? data.header_details[0].date_to : "") + "\n                                            ")])]) : _vm._e(), _vm._v(" "), _vm.setting.amount ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                                " + _vm._s(data.net_invoice) + "\n                                            ")])]) : _vm._e(), _vm._v(" "), _vm.setting.serial_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                                " + _vm._s(data.prefix) + "\n                                            ")])]) : _vm._e()]);
...
/***/ "./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue":
/*!********************************************************************************!*\
  !*** ./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _renewYearlyMaintenanceContract_vue_vue_type_template_id_1596c739_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true& */ "./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true&");
/* harmony import */ var _renewYearlyMaintenanceContract_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renewYearlyMaintenanceContract.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _renewYearlyMaintenanceContract_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _renewYearlyMaintenanceContract_vue_vue_type_template_id_1596c739_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _renewYearlyMaintenanceContract_vue_vue_type_template_id_1596c739_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "1596c739",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_renewYearlyMaintenanceContract_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./renewYearlyMaintenanceContract.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_renewYearlyMaintenanceContract_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true&":
/*!***************************************************************************************************************************!*\
  !*** ./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true& ***!
  \***************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_renewYearlyMaintenanceContract_vue_vue_type_template_id_1596c739_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_renewYearlyMaintenanceContract_vue_vue_type_template_id_1596c739_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_renewYearlyMaintenanceContract_vue_vue_type_template_id_1596c739_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/renewYearlyMaintenanceContract.vue?vue&type=template&id=1596c739&scoped=true&");
