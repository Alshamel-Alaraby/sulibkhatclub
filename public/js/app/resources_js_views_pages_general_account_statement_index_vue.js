(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_general_account_statement_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/account_statement/index.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/account_statement/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _helper_PageTitle__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../helper/PageTitle */ "./resources/js/helper/PageTitle.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    pageTitle: {
      handler: function handler(newV, old) {
        this.page_title = _helper_PageTitle__WEBPACK_IMPORTED_MODULE_9__["default"].value;
      }
    }
  },
  computed: {
    pageTitle: function pageTitle() {
      return _helper_PageTitle__WEBPACK_IMPORTED_MODULE_9__["default"].value;
    }
  },
  mixins: [_helper_mixin_translation_mixin__WEBPACK_IMPORTED_MODULE_3__["default"], _helper_mixin_customTable__WEBPACK_IMPORTED_MODULE_5__["default"], _helper_mixin_crudHelper__WEBPACK_IMPORTED_MODULE_6__["default"], _helper_mixin_success_error__WEBPACK_IMPORTED_MODULE_11__["default"]],
  components: {
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_4__["default"])(vm, "Account Statement", "Account Statement");
    });
  },
  data: function data() {
    return {
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this.isLoader = true;
              _context.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_10__["default"].get("/document/5").then(function (res) {
                _this.isLoader = false;
                var l = res.data.data;
                _this.document = l;
                _this.relatedDocuments = l.document_relateds;
              })["catch"](function (err) {
    ...
    getClientType: function getClientType() {
      var _this2 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_10__["default"].get("/client-types").then(function (res) {
        var l = res.data.data;
        var documentTypesIds = [];
        _this2.document.clientTypes.forEach(function (e, index) {
          documentTypesIds.push(parseInt(e));
        });
        _this2.clientTypes = l.filter(function (x) {
          return documentTypesIds.includes(x.id);
        });
        if (_this2.clientTypes.length == 1) {
          _this2.create.client_type_id = _this2.clientTypes[0].id;
          _this2.getCustomers(_this2.clientTypes[0].db_table);
        }
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_12___default().fire({
          icon: "error",
    ...
    searchCustomer: function searchCustomer(e) {
      ...
      this.debounce = setTimeout(function () {
        var table = _this3.clientTypes.find(function (e) {
          return e.id == _this3.client_type_id;
        }) ? _this3.clientTypes.find(function (e) {
          return e.id == _this3.client_type_id;
        }).db_table : '';
        if (table) {
          _this3.getCustomers(table, search);
        }
      }, 500);
    },
    ...
    getCustomers: function getCustomers() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_10__["default"].get("/client-types/get-drop-down-model?db_table=".concat(table, "&limet=10&search=").concat(search)).then(function (res) {
    ...
    getAccountStatement: function getAccountStatement(id, client_type_id) {
      var _this5 = this;
      this.customers.forEach(function (element) {
        if (element.id == id) {
          _this5.client = element;
        }
      });
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_10__["default"].get("/account-statement?client_type_id=".concat(client_type_id, "&customer_id=").concat(id)).then(function (res) {
        _this5.isLoader = false;
        var l = res.data.data;
        _this5.account_statement = l;
        var total_debit = 0;
        var total_credit_plus_paid_amount = 0;
        l.forEach(function (element) {
          _this5.last_balance = element.balance;
        ...
        _this5.total = total_debit + " / " + total_credit_plus_paid_amount;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_12___default().fire({
          icon: "error",
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/account_statement/index.vue?vue&type=template&id=96ee2182&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/account_statement/index.vue?vue&type=template&id=96ee2182& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.page_title && _vm.page_title.url == _vm.$route.fullPath ? _vm.$i18n.locale == "ar" ? _vm.page_title.title : _vm.page_title.title_e : _vm.$t("general.Account Statement")))])]), _vm._v(" "), _c("div", {
    staticClass: "col-lg-6 d-flex my-2",
    staticStyle: {
      "font-weight": "500"
    }
  }, [_vm.account_statement.length > 0 ? _c("div", {
    ...
    staticClass: "custom-btn-dowonload h-100 pt-3"
  }, [_c("i", {
    staticClass: "fe-printer"
  })])]) : _vm._e(), _vm._v(" "), _c("div", {
    ...
    model: {
      value: _vm.client_type_id,
      callback: function callback($$v) {
        _vm.client_type_id = $$v;
      },
      expression: "client_type_id"
    }
  })], 1)]), _vm._v(" "), _vm.client_type_id ? _c("div", {
    staticClass: "col-md-5"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    ...
    on: {
      ...
      input: function input($event) {
        return _vm.getAccountStatement(_vm.customer_id, _vm.client_type_id);
      }
    },
    model: {
  ...
  }, [Object.keys((_vm$client = _vm.client) !== null && _vm$client !== void 0 ? _vm$client : []).length ? _c("h3", {
    staticClass: "text-center my-3"
  }, [_vm._v(_vm._s(_vm.$t("general.Account Statement For ") + _vm.client.name))]) : _vm._e(), _vm._v(" "), _c("table", {
    staticClass: "table table-borderless table-hover table-centered m-0"
  }, [_c("thead", [_c("tr", {
    staticClass: "text-center"
  }, [_c("th", [_vm._v(_vm._s(_vm.$t("general.Historyofthebond")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.Bond Type")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.serial")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.Notes")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.debit")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.credit")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.balance")))])])]), _vm._v(" "), _vm.account_statement.length > 0 ? _c("tbody", _vm._l(_vm.account_statement, function (item) {
    var _item$notes;
    return _c("tr", {
      key: item.id
    }, [_c("td", [_vm._v(_vm._s(item.date))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.$i18n.locale == "ar" ? item.name : item.name_e))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(item.prefix))]), _vm._v(" "), _c("td", [_vm._v(_vm._s((_item$notes = item.notes) !== null && _item$notes !== void 0 ? _item$notes : "-"))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(item.debit && item.debit != "0" && item.debit > 0 ? item.debit : "-"))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(item.credit && item.credit != "0" && item.credit > 0 ? item.credit : item.paid_amount && item.paid_amount != "0" ? item.paid_amount : "-"))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(item.balance))])]);
  }), 0) : _c("tbody", [_c("tr", [_c("th", {
    staticClass: "text-center",
    attrs: {
      colspan: "30"
    }
  }, [_vm._v("\n                                        " + _vm._s(_vm.$t("general.notDataFound")) + "\n                                    ")])])])]), _vm._v(" "), _vm.client_type_id && _vm.customer_id ? _c("table", {
    staticClass: "table table-borderless table-hover table-centered m-0"
  }, [_c("thead", [_c("tr", {
    staticClass: "text-center"
  }, [_c("th", [_vm._v(_vm._s(_vm.$t("general.total")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.total))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.balance")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.last_balance))])])])]) : _vm._e()])], 1)])])])], 1);
};
var staticRenderFns = [];
render._withStripped = true;
...
/***/ "./resources/js/views/pages/general/account_statement/index.vue":
/*!**********************************************************************!*\
  !*** ./resources/js/views/pages/general/account_statement/index.vue ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_96ee2182___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=96ee2182& */ "./resources/js/views/pages/general/account_statement/index.vue?vue&type=template&id=96ee2182&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/general/account_statement/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_96ee2182___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_96ee2182___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/general/account_statement/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/general/account_statement/index.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************!*\
  !*** ./resources/js/views/pages/general/account_statement/index.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/account_statement/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/pages/general/account_statement/index.vue?vue&type=template&id=96ee2182&":
/*!*****************************************************************************************************!*\
  !*** ./resources/js/views/pages/general/account_statement/index.vue?vue&type=template&id=96ee2182& ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_96ee2182___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_96ee2182___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_96ee2182___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=96ee2182& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/account_statement/index.vue?vue&type=template&id=96ee2182&");
