      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              companies = _helper_global_js__WEBPACK_IMPORTED_MODULE_5__._companies.value.find(function (el) {
                return el.id == id;
              });
              ...
              _this2.getProgramsAndModulesForCompany(id);
              ...
              //   this.getWorkflows();
              //   }
              _this2.getDefaultKeys();
              _this2.getCompanyKeys(companies.id);
            ...
            case 11:
              sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                ...
                text: "".concat(_this2.$t("general.contactTheAdministration"))
              });
            case 12:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _this4.$store.commit("auth/editWorkFlowTrees", ["dictionary", "home", "company"].concat(name));
              _this4.$store.commit("auth/editCustomModules", modules);
            case 5:
            case "end":
          ...
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/translation-update", {
                ...
                var workflows = _this5.$store.state.auth.work_flow_trees;
                var keys = {};
                ...
                _this5.$store.commit('translation/editDefaultsKeys', keys);
                _this5.$store.commit('translation/editFilterResult', _objectSpread({}, keys));
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
          ...
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/translation-update", {
                ...
                _this6.$store.commit('translation/editCompanyKeys', res.data.translations);
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
