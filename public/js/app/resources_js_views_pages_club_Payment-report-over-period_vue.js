  ...
  methods: {
    ...
    getData: function getData() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/transactions/report-cm-transactions".concat(data, "&per_page=").concat(this.per_page, "&order=full_name&sort=ASC")).then(function (res) {
          var l = res.data;
