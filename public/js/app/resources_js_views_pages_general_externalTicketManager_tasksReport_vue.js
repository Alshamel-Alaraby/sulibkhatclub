(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_general_externalTicketManager_tasksReport_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _helper_mixin_customTable__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../helper/mixin/customTable */ "./resources/js/helper/mixin/customTable.js");
...
/* harmony import */ var _helper_mixin_crudHelper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../helper/mixin/crudHelper */ "./resources/js/helper/mixin/crudHelper.js");
...
/* harmony import */ var _components_widgets_errorMessage_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../components/widgets/errorMessage.vue */ "./resources/js/components/widgets/errorMessage.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_helper_mixin_translation_mixin__WEBPACK_IMPORTED_MODULE_3__["default"], _helper_mixin_customTable__WEBPACK_IMPORTED_MODULE_7__["default"], _helper_mixin_success_error__WEBPACK_IMPORTED_MODULE_8__["default"], _helper_mixin_crudHelper__WEBPACK_IMPORTED_MODULE_9__["default"]],
  components: {
    ErrorMessage: _components_widgets_errorMessage_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_14__["default"])(vm, "Tasks Report", "all Tasks Report");
    });
  },
  props: ['notification_data', 'id'],
  watch: {
    $route: function $route(to, from) {
      var _this$notification_da,
        _this = this;
      // react to route changes...
      if (Object.keys((_this$notification_da = this.notification_data) !== null && _this$notification_da !== void 0 ? _this$notification_da : []).length) {
        var index;
        this.tables.forEach(function (ele, i) {
          if (ele.id == _this.notification_data.id) {
            index = i;
          }
        });
        if (index) {
  ...
  data: function data() {
    return {
      ...
      // },
      {
        ...
        isFilter: true,
        isSet: true,
        trans: "execution_end_date",
        isV: 'execution_end_date',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: true,
        isSet: true,
        trans: "execution_duration",
        isV: 'execution_duration',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: true,
        isSet: true,
        trans: "notification_date",
        isV: 'notification_date',
        type: 'string',
        sort: true,
        setting: {
  ...
  methods: {
    ...
    getStatus: function getStatus() {
      var _this4 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_10__["default"].get("/statuses/get-drop-down?module_type=bordRent").then(function (res) {
        ...
        setTimeout(function () {
          var _this4$notification_d;
          if (Object.keys((_this4$notification_d = _this4.notification_data) !== null && _this4$notification_d !== void 0 ? _this4$notification_d : []).length) {
            if (!_this4.tables.find(function (el) {
              return el.id == _this4.notification_data.id;
            })) _this4.tables.push(_this4.notification_data);
            _this4.dbClickRow(_this4.notification_data.id);
            _this4.$router.push('/dashboard/ticket-manager/external_tasks');
          }
        }, 1500);
      });
    },
    getDepartment: function getDepartment() {
      var _this5 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_10__["default"].get("/depertments").then(function (res) {
        _this5.departments = res.data.data;
      })["catch"](function (err) {
    ...
    getLocation: function getLocation() {
      var _this6 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_10__["default"].get("/locations/get-drop-down?not_parent=1").then(function (res) {
        _this6.locations = res.data.data;
      })["catch"](function (err) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=template&id=0f4dc2a8&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=template&id=0f4dc2a8& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    staticClass: "form-group position-relative"
  }, [_c("label", [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("boardRent_task_location")) + "\n                                            "), _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")])]), _vm._v(" "), _c("multiselect", {
    "class": {
    ...
    attrs: {
      options: _vm.locations.map(function (type) {
        return type.id;
      }),
      "custom-label": function customLabel(opt) {
    ...
    model: {
      value: _vm.$v.create.location_id.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.location_id, "$model", $$v);
      },
      expression: "$v.create.location_id.$model"
    }
  }), _vm._v(" "), _vm.errors.location_id ? _vm._l(_vm.errors.location_id, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                                            ")]);
  }) : _vm._e()], 2)])])])]), _vm._v(" "), _c("searchPage", {
    attrs: {
    ...
    on: {
      logFire: function logFire(id) {
        return _vm.getLog(_vm.data.id, _vm.url);
      },
      "delete": function _delete(ids) {
        return _vm.deleteRow(ids, _vm.url);
      },
...
/***/ "./resources/js/views/pages/general/externalTicketManager/tasksReport.vue":
/*!********************************************************************************!*\
  !*** ./resources/js/views/pages/general/externalTicketManager/tasksReport.vue ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _tasksReport_vue_vue_type_template_id_0f4dc2a8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tasksReport.vue?vue&type=template&id=0f4dc2a8& */ "./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=template&id=0f4dc2a8&");
/* harmony import */ var _tasksReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasksReport.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _tasksReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _tasksReport_vue_vue_type_template_id_0f4dc2a8___WEBPACK_IMPORTED_MODULE_0__.render,
  _tasksReport_vue_vue_type_template_id_0f4dc2a8___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/general/externalTicketManager/tasksReport.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tasksReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./tasksReport.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tasksReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=template&id=0f4dc2a8&":
/*!***************************************************************************************************************!*\
  !*** ./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=template&id=0f4dc2a8& ***!
  \***************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_tasksReport_vue_vue_type_template_id_0f4dc2a8___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_tasksReport_vue_vue_type_template_id_0f4dc2a8___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_tasksReport_vue_vue_type_template_id_0f4dc2a8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./tasksReport.vue?vue&type=template&id=0f4dc2a8& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/general/externalTicketManager/tasksReport.vue?vue&type=template&id=0f4dc2a8&");
