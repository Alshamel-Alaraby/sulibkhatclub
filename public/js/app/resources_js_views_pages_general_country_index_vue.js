...
/* harmony import */ var _helper_mixin_success_error__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../helper/mixin/success&error */ "./resources/js/helper/mixin/success&error.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_helper_mixin_translation_mixin__WEBPACK_IMPORTED_MODULE_10__["default"], _helper_mixin_success_error__WEBPACK_IMPORTED_MODULE_17__["default"]],
  components: {
  ...
  validations: {
    create: {
      ...
      short_code: {
        ...
        alpha: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.alpha,
        minLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.minLength)(1),
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.maxLength)(10)
      },
      phone_key: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.requiredIf)(function (model) {
          return this.isRequired("phone_key");
      ...
      national_id_length: {
        ...
        integer: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.integer,
        minLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.minLength)(1),
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.maxLength)(2)
      },
      is_active: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_18__.requiredIf)(function (model) {
          return this.isRequired("is_active");
        ...
        if (result.value) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/cities/".concat(id)).then(function (res) {
            ...
            if (err.response.status == 400) {
              ...
              _this4.errorFunChildren('Error', text);
            } else {
              sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                icon: "error",
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/countries/bulk-delete", {
              ...
              if (err.response.status == 400) {
                ...
                _this15.errorFunChildren('Error', text);
                _this15.getData();
              } else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                  icon: "error",
