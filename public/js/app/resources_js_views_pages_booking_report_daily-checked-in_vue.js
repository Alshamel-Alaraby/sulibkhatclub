...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getVoucherHeaders: function getVoucherHeaders(items) {
      var sumItem = 0;
      if (items) {
        items.customer.voucher_headers.forEach(function (e) {
    ...
    getVoucherHeadersTotal: function getVoucherHeadersTotal(items) {
      ...
      this.total = (_parseFloat$toFixed = parseFloat(sumItem).toFixed(3)) !== null && _parseFloat$toFixed !== void 0 ? _parseFloat$toFixed : '0';
    }
  }
});
