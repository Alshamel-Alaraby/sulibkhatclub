...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_4__["default"])(vm, "Rooms", "Rooms");
    });
  },
  data: function data() {
    return {
  ...
  methods: {
    getBranch: function getBranch() {
      var _this = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_12__["default"].get("/branches/get-drop-down?company_id=".concat(this.company_id, "&notParent=1")).then(function (res) {
    ...
    get_rooms_categories: function get_rooms_categories() {
      var _this2 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_12__["default"].get("h_m_s/rooms_categories?company_id=".concat(this.company_id, "&type=children")).then(function (res) {
        _this2.rooms_categories = res.data.data;
      });
    },
      ...
      setTimeout(function () {
        if (_this3.type != 'edit') {
          ...
          if (_this3.idObjEdit.dataObj) {
            var room = _this3.idObjEdit.dataObj;
            _this3.errors = {};
            _this3.create.name = room.name;
            _this3.create.name_e = room.name_e;
            _this3.create.rooms_category_id = room.rooms_category_id;
            _this3.create.branch_id = room.branch_id;
            _this3.create.note = room.note;
          }
        }
      }, 50);
    },
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    attrs: {
      ...
      defaultsKeys: _vm.defaultsKeys,
      url: _vm.url,
      rooms_categories: _vm.rooms_categories,
...
var render = function render() {
  ...
  return _c("div", [_c("b-modal", {
    attrs: {
      id: _vm.id,
      title: _vm.type != "edit" ? _vm.getCompanyKey("hms_rooms_categories_create_form") : _vm.getCompanyKey("hms_rooms_categories_edit_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      size: "lg",
      "hide-footer": true
  ...
  }, [_vm._v("\n                            " + _vm._s(_vm.getCompanyKey("hms_rooms_categories_name_ar")) + "\n                            "), _vm.isRequired("name") ? _c("span", {
    staticClass: "text-danger"
  ...
  }, [_vm._v("\n                            " + _vm._s(_vm.getCompanyKey("hms_rooms_categories_name_en")) + "\n                            "), _vm.isRequired("name_e") ? _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _c("div", {
    attrs: {
      dir: "ltr"
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.rooms_categories.find(function (x) {
          return x.id == opt;
        }) ? _vm.$i18n.locale == "ar" ? _vm.rooms_categories.find(function (x) {
          return x.id == opt;
        }).name : _vm.rooms_categories.find(function (x) {
          return x.id == opt;
        }).name_e : null;
      }
    },
