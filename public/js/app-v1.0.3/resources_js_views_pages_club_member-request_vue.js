  ...
  methods: {
    ...
    rejectSubmit: function rejectSubmit() {
      ...
      if (this.$v.reject.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/club-members/members/decline-member/".concat(this.checkAll[0]), {
          note: this.reject.note
        }).then(function (res) {
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.$v.reject.note.$model,
                                    expression: "$v.reject.note.$model",
                                  },
                                ],
                                staticClass: "form-control",
                                class: {
                                  "is-invalid":
                                    _vm.$v.reject.note.$error ||
                                    _vm.errors.note,
                                  "is-valid":
                                    !_vm.$v.reject.note.$invalid &&
                                    !_vm.errors.note,
                                },
                                attrs: { type: "text" },
                                domProps: { value: _vm.$v.reject.note.$model },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
