...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      create: {
        ...
        status_id: null,
        employee_id: null,
        start_from: (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(new Date()),
        date: (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(new Date()),
        end_date: (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(new Date()),
        descriptions: "",
        admin_comment: "",
        amount: 0,
  ...
  validations: {
    create: {
      ...
      approved_from_date: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.create.request_type_id || this.create.request_type_id && this.getRequestType(this.create.request_type_id).start_from && this.manageOthers;
        })
      },
      end_date: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
      ...
      approved_to_date: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.create.request_type_id || this.create.request_type_id && this.getRequestType(this.create.request_type_id).end_date && this.manageOthers;
        })
      },
      date: {},
      approved_date: {
      ...
      approved_amount: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.create.request_type_id || this.create.request_type_id && this.getRequestType(this.create.request_type_id).amount && this.manageOthers;
        })
      },
      from_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
      ...
      approved_from_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.create.request_type_id || this.create.request_type_id && this.getRequestType(this.create.request_type_id).from_hour && this.manageOthers;
        })
      },
      to_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
      ...
      approved_to_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.create.request_type_id || this.create.request_type_id && this.getRequestType(this.create.request_type_id).to_hour && this.manageOthers;
        })
      }
    },
    edit: {
      ...
      approved_from_date: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.edit.request_type_id || this.edit.request_type_id && this.getRequestType(this.edit.request_type_id).start_from && this.manageOthers;
        })
      },
      end_date: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
      ...
      approved_to_date: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.edit.request_type_id || this.edit.request_type_id && this.getRequestType(this.edit.request_type_id).end_date && this.manageOthers;
        })
      },
      descriptions: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.required
      ...
      approved_amount: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.edit.request_type_id || this.edit.request_type_id && this.getRequestType(this.edit.request_type_id).amount && this.manageOthers;
        })
      },
      from_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
      ...
      approved_from_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.edit.request_type_id || this.edit.request_type_id && this.getRequestType(this.edit.request_type_id).from_hour && this.manageOthers;
        })
      },
      to_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
      ...
      approved_to_hour: {
        required: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_16__.requiredIf)(function (model) {
          return !this.edit.request_type_id || this.edit.request_type_id && this.getRequestType(this.edit.request_type_id).to_hour && this.manageOthers;
        })
      }
    }
  },
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_2__["default"])(vm, "Online Request", "all onlineRequest hr");
    });
  },
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/hr/online-requests?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/hr/online-requests/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this9.checkAll = [];
              _this9.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            _this9.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"]("/hr/online-requests/".concat(id)).then(function (res) {
              _this9.checkAll = [];
              _this9.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                icon: "success",
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 11:
              ...
              if (!_this11.manageOthers && _this11.$store.state.auth.user.employee_id) {
                _this11.create.employee_id = _this11.$store.state.auth.user.employee_id;
              }
              _this11.create.status_id = 1;
              _this11.errors = {};
            case 16:
            case "end":
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/hr/online-requests", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/hr/online-requests/".concat(id), this.edit).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var financialYear, currDateFromHour, currDateToHour, currDateApprovedFromHour, currDateApprovedToHour;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              if (_this15.$store.state.auth.user.employee_id) {
                _context6.next = 5;
                break;
              }
              _context6.next = 3;
            ...
            case 5:
              _context6.next = 7;
              return _this15.getEmployeeChildren();
            case 7:
              _context6.next = 9;
            ...
            case 11:
              ...
              _this15.edit.request_type_id = financialYear.request_type_id;
              _this15.edit.status_id = financialYear.status_id;
              _this15.edit.employee_id = financialYear.employee_id;
              _this15.edit.descriptions = financialYear.descriptions;
              _this15.edit.admin_comment = financialYear.admin_comment;
              _this15.edit.amount = financialYear.amount;
              _this15.edit.approved_amount = financialYear.approved_amount;
              _this15.edit.start_from = _this15.formatDate(financialYear.start_from);
              _this15.edit.end_date = _this15.formatDate(financialYear.end_date);
              _this15.edit.date = _this15.formatDate(financialYear.date);
              currDateFromHour = new Date();
              currDateFromHour.setHours(financialYear.from_hour.split(":")[0], financialYear.from_hour.split(":")[1], financialYear.from_hour.split(":")[2]);
              currDateToHour = new Date();
              currDateToHour.setHours(financialYear.to_hour.split(":")[0], financialYear.to_hour.split(":")[1], financialYear.to_hour.split(":")[2]);
              currDateApprovedFromHour = new Date();
              currDateApprovedFromHour.setHours(financialYear.approved_from_hour.split(":")[0], financialYear.approved_from_hour.split(":")[1], financialYear.approved_from_hour.split(":")[2]);
              currDateApprovedToHour = new Date();
              currDateApprovedToHour.setHours(financialYear.approved_to_hour.split(":")[0], financialYear.approved_to_hour.split(":")[1], financialYear.approved_to_hour.split(":")[2]);
              _this15.edit.from_hour = _this15.formatTime(currDateFromHour);
              _this15.edit.to_hour = _this15.formatTime(currDateToHour);
              _this15.edit.approved_date = _this15.formatDate(financialYear.approved_date);
              _this15.edit.approved_from_date = _this15.formatDate(financialYear.approved_from_date);
              _this15.edit.approved_to_date = _this15.formatDate(financialYear.approved_to_date);
              _this15.edit.approved_from_hour = _this15.formatTime(currDateApprovedFromHour);
              _this15.edit.approved_to_hour = _this15.formatTime(currDateApprovedToHour);
              _this15.edit.custom_start_from = new Date(financialYear.start_from);
              _this15.edit.custom_end_date = new Date(financialYear.end_date);
              _this15.edit.custom_date = new Date(financialYear.date);
              _this15.edit.custom_approved_date = new Date(financialYear.approved_date);
              _this15.edit.custom_approved_from_date = new Date(financialYear.approved_from_date);
              _this15.edit.custom_approved_to_date = new Date(financialYear.approved_to_date);
              _this15.edit.custom_from_hour = currDateFromHour;
              _this15.edit.custom_to_hour = currDateToHour;
    ...
    start_from: function start_from(e) {
      if (e) {
        this.create.start_from = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(e);
        this.edit.start_from = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(e);
      } else {
    ...
    end_date: function end_date(e) {
      if (e) {
        this.create.end_date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(e);
        this.edit.end_date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(e);
      } else {
    ...
    date: function date(e) {
      if (e) {
        this.create.date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(e);
        this.edit.date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_10__.formatDateOnly)(e);
      } else {
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/hr/online-requests/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  })]), _vm._v(" "), _vm.checkAll.length == 1 && _vm.isPermission("update onlineRequest hr") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.admin_comment,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "admin_comment", $$v);
      },
      expression: "setting.admin_comment"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("online_request_admin_comment")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("online_request_admin_comment")) + "\n                      "), _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")])]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.admin_comment.$model,
      expression: "$v.create.admin_comment.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.admin_comment.$error || _vm.errors.admin_comment,
      "is-valid": !_vm.$v.create.admin_comment.$invalid
    },
    attrs: {
      disabled: !_vm.manageOthers,
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.admin_comment, "$model", $event.target.value);
      }
    }
  })])])])])]), _vm._v(" "), _c("div", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.admin_comment ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("online_request_admin_comment")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    return _c("tr", {
      ...
      on: {
        ...
        dblclick: function dblclick($event) {
          $event.preventDefault();
          _vm.isPermission("update onlineRequest") ? _vm.$bvModal.show("modal-edit-".concat(data.id)) : false;
        }
      }
    }, [_vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    ...
    }, [_vm.isPermission("update onlineRequest hr") ? _c("a", {
      staticClass: "dropdown-item",
      attrs: {
        href: "#"
      },
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.isPermission("delete onlineRequest hr") ? _c("a", {
      ...
      attrs: {
        type: "date",
        "default-value": _vm.edit.custom_approved_from_date,
        confirm: ""
      },
      on: {
        change: _vm.approved_from_date
      ...
      model: {
        value: _vm.edit.custom_approved_from_date,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "custom_approved_from_date", $$v);
        },
        expression: "edit.custom_approved_from_date"
      }
    }), _vm._v(" "), !_vm.$v.edit.approved_from_date.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.approved_from_date ? _vm._l(_vm.errors.approved_from_date, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      attrs: {
        type: "date",
        "default-value": _vm.edit.custom_approved_to_date,
        confirm: ""
      },
      on: {
        change: _vm.approved_to_date
      ...
      model: {
        value: _vm.edit.custom_approved_to_date,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "custom_approved_to_date", $$v);
        },
        expression: "edit.custom_approved_to_date"
      }
    }), _vm._v(" "), !_vm.$v.edit.approved_to_date.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.approved_to_date ? _vm._l(_vm.errors.approved_to_date, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.admin_comment.$model,
        expression: "$v.edit.admin_comment.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.admin_comment.$error || _vm.errors.admin_comment,
        "is-valid": !_vm.$v.edit.admin_comment.$invalid
      },
      attrs: {
        type: "text",
        id: "create-20"
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.admin_comment, "$model", $event.target.value);
        }
      }
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".line[data-v-168cc55d] {\n  border-bottom: 1px solid #fff !important;\n  margin-top: 0.5rem !important;\n  margin-bottom: 0.5rem !important;\n}\ntable td[data-v-168cc55d],\ntable th[data-v-168cc55d] {\n  white-space: nowrap;\n}", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_online_request_vue_vue_type_style_index_0_id_168cc55d_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_online_request_vue_vue_type_style_index_0_id_168cc55d_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _hr_online_request_vue_vue_type_style_index_0_id_168cc55d_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true& */ "./resources/js/views/pages/hr/hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/***/ "./resources/js/views/pages/hr/hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true&":
/*!*********************************************************************************************************************!*\
  !*** ./resources/js/views/pages/hr/hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true& ***!
  \*********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_hr_online_request_vue_vue_type_style_index_0_id_168cc55d_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/hr_online_request.vue?vue&type=style&index=0&id=168cc55d&lang=scss&scoped=true&");
