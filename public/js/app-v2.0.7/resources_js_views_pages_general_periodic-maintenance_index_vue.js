...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getTask: function getTask() {
      var _this6 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_4__["default"].get("/tasks").then(function (res) {
        var l = res.data;
        _this6.tasks = l.data;
      })["catch"](function (err) {
        _this6.errorFun('Error', 'Thereisanerrorinthesystem');
    ...
    getDepartment: function getDepartment() {
      var _this7 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_4__["default"].get("/depertments").then(function (res) {
        var l = res.data.data;
