...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    }, [_vm._v("\n                                            " + _vm._s(data.type ? _vm.$i18n.locale == "ar" ? data.type.name : data.type.name_e : " - ") + "\n                                        ")])]) : _vm._e(), _vm._v(" "), _vm.setting.cm_permissions_id ? _c("td", [data.permission.length > 0 ? _c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, _vm._l(data.permission, function (per, index) {
      return _c("span", {
        key: per.id
      }, [_vm._v("\n                                                 " + _vm._s(_vm.$i18n.locale == "ar" ? per.name : per.name_e) + " -\n                                            ")]);
    }), 0) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.setting.cm_financial_status_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
