...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      if (vm.$store.state.auth.work_flow_trees.includes("sell method") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/boards-rent/sell-methods", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/boards-rent/sell-methods/".concat(id), _objectSpread(_objectSpread({}, this.edit), {}, {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.calculated_percentage,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "calculated_percentage", $$v);
      },
      expression: "setting.calculated_percentage"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("boardRent_sellMethod_calculated_percentage")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.commission_ratio,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "commission_ratio", $$v);
      },
      expression: "setting.commission_ratio"
    }
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.calculated_percentage ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_sellMethod_calculated_percentage")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.commission_ratio ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("boardRent_sellMethod_commission_ratio")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.calculated_percentage ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(data.target_calculation_ratio) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.commission_ratio ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(data.commission_ratio) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.calculated_percentage.$model,
        expression: "$v.edit.calculated_percentage.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.calculated_percentage.$error || _vm.errors.calculated_percentage,
        "is-valid": !_vm.$v.edit.calculated_percentage.$invalid && !_vm.errors.calculated_percentage
      },
      attrs: {
        type: "text",
        "data-create": "2",
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.calculated_percentage, "$model", $event.target.value);
        }
      }
    })])]), _vm._v(" "), _c("div", {
      staticClass: "col-md-12"
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.edit.commission_ratio.$model,
        expression: "$v.edit.commission_ratio.$model"
      }],
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.commission_ratio.$error || _vm.errors.commission_ratio,
        "is-valid": !_vm.$v.edit.commission_ratio.$invalid && !_vm.errors.commission_ratio
      },
      attrs: {
        type: "text",
        "data-create": "2",
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.edit.commission_ratio, "$model", $event.target.value);
        }
      }
