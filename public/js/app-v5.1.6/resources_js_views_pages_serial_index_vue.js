      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 6:
              if (_this13.isVisible("restart_period_id")) _this13.getPeriod();
              ...
              _this13.edit.restart_period_id = serial.restart_period_id ? serial.restart_period_id : null;
              ...
              _this13.edit.is_default = serial.is_default ? parseInt(serial.is_default) : 0;
              _this13.errors = {};
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/document?company_id=".concat(_this14.company_id, "&document=1")).then(function (res) {
                var l = res.data.data;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/branches?company_id=".concat(_this15.company_id, "&notParent=1")).then(function (res) {
                var l = res.data.data;
                l.unshift({
                  id: 0,
                  name: "اضف فرع",
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/restart-period").then(function (res) {
                var l = res.data.data;
                _this16.types = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Document", {
    ...
    on: {
      click: function click($event) {
        _vm.serials.sort(_vm.sortNumber("restart_period_id"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(data.start_no) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.perfix && _vm.isVisible("perfix") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.perfix))])]) : _vm._e(), _vm._v(" "), _vm.setting.suffix && _vm.isVisible("suffix") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.suffix))])]) : _vm._e(), _vm._v(" "), _vm.setting.restart_period_id && _vm.isVisible("restart_period_id") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(data.restart_period ? _vm.$i18n.locale == "ar" ? data.restart_period.name : data.restart_period.name_e : " - ") + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.document_id && _vm.isVisible("document_id") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
      ...
      model: {
        value: _vm.$v.edit.restart_period_id.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.restart_period_id, "$model", $$v);
        },
        expression: "$v.edit.restart_period_id.$model"
      }
    }), _vm._v(" "), _vm.$v.edit.restart_period_id.$error || _vm.errors.restart_period_id ? _c("div", {
      staticClass: "text-danger"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.restart_period_id ? _vm._l(_vm.errors.restart_period_id, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
