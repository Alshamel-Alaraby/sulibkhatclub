  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/hr/payroll-heads", this.create).then(function (res) {
...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.payrollHeadsTable")))]), _vm._v(" "), _c("div", {
