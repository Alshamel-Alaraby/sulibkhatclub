  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      this.create.memberships_renewals.forEach(function (el, index) {
        _this9.create.memberships_renewals[index].from = "".concat(el.fromDay, "-").concat(el.fromMonth);
        _this9.create.memberships_renewals[index].to = "".concat(el.toDay, "-").concat(el.toMonth);
      });
      this.$v.create.$touch();
    ...
    editSubmit: function editSubmit(id) {
      var _this10 = this;
      this.edit.from = "".concat(this.edit.fromDay, "-").concat(this.edit.fromMonth);
      this.edit.to = "".concat(this.edit.toDay, "-").concat(this.edit.toMonth);
      this.$v.edit.$touch();
