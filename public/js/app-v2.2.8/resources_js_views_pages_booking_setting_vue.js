...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    }, [_vm._v(_vm._s(data.key))])]) : _vm._e(), _vm._v(" "), _vm.setting.value && _vm.isVisible("value") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(_vm.tConvert(data.value)))])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.isVisible("value") ? _c("div", {
      staticClass: "col-md-12"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", {
