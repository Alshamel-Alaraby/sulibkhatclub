(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_pointOfSell_reports_purchases_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      is_disabled: false,
      filterSetting: ["invoice_id", "total", "due"],
      printLoading: true,
      printObj: {
        id: "printData"
      }
  ...
  //       next((vm) => {
  //   return permissionGuard(vm, "POS purchases report", "all sold_Unit RealState");
  // });
  ...
  methods: {
    ...
    getTotal: function getTotal() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this4$supplier_id, _this4$from_date, _this4$to_date, _this4$payment_type;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _this4.isLoader = true;
              _context2.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("point-of-sale/Purchases-report/grandTotal?supplier_id=".concat((_this4$supplier_id = _this4.supplier_id) !== null && _this4$supplier_id !== void 0 ? _this4$supplier_id : "", "\n          &start_date=").concat((_this4$from_date = _this4.from_date) !== null && _this4$from_date !== void 0 ? _this4$from_date : "", "\n          &end_date=").concat((_this4$to_date = _this4.to_date) !== null && _this4$to_date !== void 0 ? _this4$to_date : "", "\n          &payment_method_id=").concat((_this4$payment_type = _this4.payment_type) !== null && _this4$payment_type !== void 0 ? _this4$payment_type : "")).then(function (res) {
                var l = res.data;
                _this4.total = l;
              })["catch"](function (err) {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("point-of-sale/Purchases-report?page=".concat(page, "&per_page=").concat(this.per_page, "\n          &supplier_id=").concat((_this$supplier_id = this.supplier_id) !== null && _this$supplier_id !== void 0 ? _this$supplier_id : "", "\n          &start_date=").concat((_this$from_date = this.from_date) !== null && _this$from_date !== void 0 ? _this$from_date : "", "\n          &end_date=").concat((_this$to_date = this.to_date) !== null && _this$to_date !== void 0 ? _this$to_date : "", "\n          &payment_method_id=").concat((_this$payment_type = this.payment_type) !== null && _this$payment_type !== void 0 ? _this$payment_type : "")).then(function (res) {
        ...
        items.push({
          ...
          name: "اجمالي",
          name_e: "Total",
          item_purchased: _this7.getItemsSumOf(items, "item_purchased"),
          total: _this7.getItemsSumOf(items, "total"),
          due_amount: _this7.getItemsSumOf(items, "due_amount")
        });
        items.push({
          bold: true,
          name: "المجموع الاجمالي",
          name_e: "Grand total",
          item_purchased: _this7.total.item_purchased_total,
          total: _this7.total.total_total,
          due_amount: _this7.total.due_amount_total
        });
        _this7.items = items;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.itemsPagination.last_page && this.current_page != this.itemsPagination.current_page && this.current_page) {
        var _this$supplier_id2, _this$from_date2, _this$to_date2, _this$payment_type2;
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i < this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("point-of-sale/Purchases-report?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "\n          &supplier_id=").concat((_this$supplier_id2 = this.supplier_id) !== null && _this$supplier_id2 !== void 0 ? _this$supplier_id2 : "", "\n          &start_date=").concat((_this$from_date2 = this.from_date) !== null && _this$from_date2 !== void 0 ? _this$from_date2 : "", "\n          &end_date=").concat((_this$to_date2 = this.to_date) !== null && _this$to_date2 !== void 0 ? _this$to_date2 : "", "\n          &payment_method_id=").concat((_this$payment_type2 = this.payment_type) !== null && _this$payment_type2 !== void 0 ? _this$payment_type2 : "")).then(function (res) {
          var l = res.data;
          var items = res.data.data;
          items.push({
            bold: true,
            name: "اجمالي",
            name_e: "Total",
            item_purchased: _this8.getItemsSumOf(items, "item_purchased"),
            total: _this8.getItemsSumOf(items, "total"),
            due_amount: _this8.getItemsSumOf(items, "due_amount")
          });
          items.push({
            bold: true,
            name: "المجموع الاجمالي",
            name_e: "Grand total",
            item_purchased: _this8.total.item_purchased_total,
            total: _this8.total.total_total,
            due_amount: _this8.total.due_amount_total
          });
          _this8.items = items;
    ...
    getPurchasesTypes: function getPurchasesTypes() {
      this.purchasesTypes = [{
        value: "supplier",
        name: "المورد",
        name_e: "Supplier"
      }, {
        value: "internal_purchasing",
        name: "المشتريات الداخلية",
        name_e: "Internal Purchasing"
      }, {
        value: "internal_transfer",
        name: "تحويلات داخلية",
        name_e: "Internal Transfer"
      }, {
        value: "purchase_return",
        name: "مرتجع مشتريات",
        name_e: "Purchase Return"
      }];
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=template&id=0dc6c172&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=template&id=0dc6c172&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("b-modal", {
    ...
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.supplier")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
      options: _vm.suppliers.map(function (type) {
        return type.id;
      }),
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.suppliers.find(function (x) {
          return x.id == opt;
        }).name : _vm.suppliers.find(function (x) {
          return x.id == opt;
        }).name_e;
      }
    },
  ...
  }, [_vm._v("\n              " + _vm._s(_vm.$t("general.PurchasesReport")) + "\n            ")]), _vm._v(" "), _c("div", {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.purchase_type,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "purchase_type", $$v);
      },
      expression: "setting.purchase_type"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("purchase_type")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.supplier_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "supplier_id", $$v);
      },
      expression: "setting.supplier_id"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("supplier")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.purchased_by,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "purchased_by", $$v);
      },
      expression: "setting.purchased_by"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("purchased_by")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.purchase_type ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("purchase_type")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.supplier_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("supplier")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.purchased_by ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("purchased_by")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.invoice_id ? _c("td", [!data.bold ? [_vm._v("\n                      " + _vm._s(data.invoice_id) + "\n                    ")] : [_vm._v(_vm._s(_vm.$i18n.locale == "ar" ? data.name : data.name_e))]], 2) : _vm._e(), _vm._v(" "), _vm.setting.date ? _c("td", [_vm._v("\n                    " + _vm._s(data.date) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.purchase_type ? _c("td", [_vm._v("\n                    " + _vm._s(data.type) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.supplier_id ? _c("td", [data.supplier ? [_vm._v("\n                      " + _vm._s(data.supplier ? _vm.$i18n.locale == "ar" ? data.supplier_name : data.supplier_name_e : "") + "\n                    ")] : _vm._e()], 2) : _vm._e(), _vm._v(" "), _vm.setting.purchased_by ? _c("td", [data.created_by ? [_vm._v("\n                      " + _vm._s(data.created_by ? _vm.$i18n.locale == "ar" ? data.created_by.name : data.created_by.name_e : "") + "\n                    ")] : _vm._e()], 2) : _vm._e(), _vm._v(" "), _vm.setting.item_purchased ? _c("td", [_vm._v("\n                    " + _vm._s(data.item_purchased) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.total ? _c("td", [_vm._v("\n                    " + _vm._s(data.total) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.due ? _c("td", [_vm._v("\n                    " + _vm._s(data.due_amount) + "\n                  ")]) : _vm._e()]);
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.boldTd[data-v-0dc6c172] {\r\n  font-weight: bold;\n}\ntable th[data-v-0dc6c172],\r\ntable td[data-v-0dc6c172] {\r\n  white-space: nowrap !important;\n}\n@media print {\n.do-not-print[data-v-0dc6c172] {\r\n    display: none;\n}\n.arrow-sort[data-v-0dc6c172] {\r\n    display: none;\n}\n}\nhr[data-v-0dc6c172] {\r\n  border-bottom: 1px solid #fff;\n}\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_purchases_vue_vue_type_style_index_0_id_0dc6c172_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_purchases_vue_vue_type_style_index_0_id_0dc6c172_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/views/pages/pointOfSell/reports/purchases.vue":
/*!********************************************************************!*\
  !*** ./resources/js/views/pages/pointOfSell/reports/purchases.vue ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _purchases_vue_vue_type_template_id_0dc6c172_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./purchases.vue?vue&type=template&id=0dc6c172&scoped=true& */ "./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=template&id=0dc6c172&scoped=true&");
/* harmony import */ var _purchases_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./purchases.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=script&lang=js&");
/* harmony import */ var _purchases_vue_vue_type_style_index_0_id_0dc6c172_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css& */ "./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _purchases_vue_vue_type_template_id_0dc6c172_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _purchases_vue_vue_type_template_id_0dc6c172_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "0dc6c172",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/pointOfSell/reports/purchases.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=template&id=0dc6c172&scoped=true&":
/*!***************************************************************************************************************!*\
  !*** ./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=template&id=0dc6c172&scoped=true& ***!
  \***************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_purchases_vue_vue_type_template_id_0dc6c172_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_purchases_vue_vue_type_template_id_0dc6c172_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_purchases_vue_vue_type_template_id_0dc6c172_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./purchases.vue?vue&type=template&id=0dc6c172&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=template&id=0dc6c172&scoped=true&");
...
/***/ "./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css&":
/*!*****************************************************************************************************************************!*\
  !*** ./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_purchases_vue_vue_type_style_index_0_id_0dc6c172_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/pointOfSell/reports/purchases.vue?vue&type=style&index=0&id=0dc6c172&scoped=true&lang=css&");
