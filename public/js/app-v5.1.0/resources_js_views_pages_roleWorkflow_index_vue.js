(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_roleWorkflow_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflow/index.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflow/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_create_role_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../components/create/role.vue */ "./resources/js/components/create/role.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.roleWorkflows.forEach(function (el) {
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      if (vm.showScreen("role", "role workflow") && vm.$store.state.auth.work_flow_trees.includes("role") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
  ...
  methods: {
    getCustomTableFields: function getCustomTableFields() {
      var _this4 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/general_role_workflows").then(function (res) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflows?page=".concat(page, "&per_page=").concat(_this5.per_page, "&search=").concat(_this5.search, "&").concat(filter)).then(function (res) {
                var l = res.data;
                _this5.roleWorkflows = l.data;
                _this5.roleWorkflowsPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.roleWorkflowsPagination.last_page && this.current_page != this.roleWorkflowsPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflows?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this6.roleWorkflows = l.data;
          _this6.roleWorkflowsPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/role-workflows/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this7.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/role-workflows/".concat(id)).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _this10.getRole();
            case 2:
              _context4.next = 4;
              return _this10.getWorkflow();
            case 4:
              _this10.create = {
                role_id: null,
                workflow_id: null,
    ...
    AddSubmit: function AddSubmit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var self, check, module;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _this11.$v.create.$touch();
              if (!_this11.$v.create.$invalid) {
                _context5.next = 3;
                break;
              }
            ...
            case 3:
              _context5.next = 5;
              return _this11.getRoleUsersCount(_this11.create.role_id);
            case 5:
              self = _this11;
              check = _this11.$store.state.auth.allWorkFlow.filter(function (workflow) {
                return workflow.id == self.create.workflow_id && workflow.module_id && self.usersCount > workflow.module_allowed_users_no;
              }).length > 0;
              if (!check) {
                _context5.next = 12;
                break;
              ...
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "error",
                text: "".concat(_this11.$t("general.ExceedMaxUserNumber")),
                showConfirmButton: false,
                timer: 1500
              });
              return _context5.abrupt("return");
            case 12:
              ...
              _this11.errors = {};
              _this11.create.role_id = _this11.create.role_id;
              _this11.create.workflow_id = _this11.create.workflow_id;
              module = _this11.workflows.find(function (e) {
                return _this11.create.workflow_id == e.id;
              });
              _this11.create.workflow_name = module.name_e;
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/role-workflows", _objectSpread(_objectSpread({}, _this11.create), {}, {
                company_id: _this11.company_id
              })).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _this12.$v.edit.$touch();
              if (!_this12.$v.edit.$invalid) {
                _context6.next = 3;
                break;
              }
            ...
            case 3:
              _context6.next = 5;
              return _this12.getRoleUsersCount(_this12.edit.role_id);
            case 5:
              self = _this12;
              check = _this12.$store.state.auth.allWorkFlow.filter(function (workflow) {
                return workflow.id == self.edit.workflow_id && workflow.module_id && self.usersCount > workflow.module_allowed_users_no;
              }).length > 0;
              if (!check) {
                _context6.next = 12;
                break;
              ...
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "error",
                text: "".concat(_this12.$t("general.ExceedMaxUserNumber")),
                showConfirmButton: false,
                timer: 1500
              });
              return _context6.abrupt("return");
            case 12:
              ...
              _this12.errors = {};
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/role-workflows/".concat(id), _this12.edit).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return _this13.getRole();
            case 2:
              _context7.next = 4;
              return _this13.getWorkflow();
            case 4:
              module = _this13.roleWorkflows.find(function (e) {
                return id == e.id;
              });
              _this13.edit.workflow_id = module.workflow_id;
              _this13.edit.workflow_name = module.name_e;
              _this13.edit.role_id = module.role.id;
              _this13.errors = {};
            case 9:
            case "end":
    ...
    getRoleUsersCount: function getRoleUsersCount(id) {
      var _this16 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("user-role/user-count/".concat(id)).then(function (res) {
                _this16.usersCount = res.data.user_count;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflows/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ('RoleWorkflow' + '.' || 0) + (type || 'xlsx'));
        }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflow/index.vue?vue&type=template&id=41c8a57c&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflow/index.vue?vue&type=template&id=41c8a57c& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Role", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.roleWorkflowsTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.getCompanyKey("role")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("workflow_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "workflow_id"
    },
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.roleWorkflowsPagination.from) + "-" + _vm._s(_vm.roleWorkflowsPagination.to) + "\n                    /\n                    " + _vm._s(_vm.roleWorkflowsPagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.roleWorkflowsPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.roleWorkflowsPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.roleWorkflowsPagination.last_page == _vm.roleWorkflowsPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
  ...
  }), _vm._v(" "), _vm.errors.role_id ? _vm._l(_vm.errors.role_id, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("workflow_id") ? _c("div", {
    staticClass: "col-md-12"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    staticClass: "my-1 mr-2"
  }, [_vm._v("\n                        " + _vm._s(_vm.getCompanyKey("workflow")) + "\n                        "), _vm.isRequired("workflow_id") ? _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _c("multiselect", {
    attrs: {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("role")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.workflow_id && _vm.isVisible("workflow_id") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("workflow")))])])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("general.Action")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_c("i", {
    staticClass: "fas fa-ellipsis-v"
  })]) : _vm._e()])]), _vm._v(" "), _vm.roleWorkflows.length > 0 ? _c("tbody", _vm._l(_vm.roleWorkflows, function (data, index) {
    return _c("tr", {
      key: data.id,
    ...
    }, [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.role.name : data.role.name_e) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.workflow_id && _vm.isVisible("workflow_id") ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
      ...
      staticClass: "my-1 mr-2"
    }, [_vm._v(_vm._s(_vm.getCompanyKey("workflow")) + "\n                                  "), _vm.isRequired("workflow_id") ? _c("span", {
      staticClass: "text-danger"
    }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _c("multiselect", {
      attrs: {
        options: _vm.workflows.map(function (type) {
...
/***/ "./resources/js/views/pages/roleWorkflow/index.vue":
/*!*********************************************************!*\
  !*** ./resources/js/views/pages/roleWorkflow/index.vue ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_41c8a57c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=41c8a57c& */ "./resources/js/views/pages/roleWorkflow/index.vue?vue&type=template&id=41c8a57c&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/roleWorkflow/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_41c8a57c___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_41c8a57c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/roleWorkflow/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/roleWorkflow/index.vue?vue&type=script&lang=js&":
/*!**********************************************************************************!*\
  !*** ./resources/js/views/pages/roleWorkflow/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflow/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/pages/roleWorkflow/index.vue?vue&type=template&id=41c8a57c&":
/*!****************************************************************************************!*\
  !*** ./resources/js/views/pages/roleWorkflow/index.vue?vue&type=template&id=41c8a57c& ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_41c8a57c___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_41c8a57c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_41c8a57c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=41c8a57c& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/roleWorkflow/index.vue?vue&type=template&id=41c8a57c&");
