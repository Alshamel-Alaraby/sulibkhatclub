...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_page$mixins$componen = {
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_10__["default"])(vm, "Membership Renewal", "all membershipRenewal club");
    });
  }
...
}), _defineProperty(_page$mixins$componen, "data", function data() {
  return {
    fields: [],
    per_page: 50,
    search: "",
...
}), _defineProperty(_page$mixins$componen, "validations", {
  create: {
    memberships_renewals: {
...
}), _defineProperty(_page$mixins$componen, "mounted", function mounted() {
