  ...
  methods: {
    ...
    getData: function getData() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/transactions?sponsor_id=".concat((_this$create$sponsor_ = this.create.sponsor_id) !== null && _this$create$sponsor_ !== void 0 ? _this$create$sponsor_ : '', "&date=").concat(convertedDate !== null && convertedDate !== void 0 ? convertedDate : '', "&page=").concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.$v.create.$invalid) {
        ...
        if (this.current_page <= this.installmentStatusPagination.last_page && this.current_page != this.installmentStatusPagination.current_page && this.current_page) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/transactions?sponsor_id=".concat((_this$create$sponsor_2 = this.create.sponsor_id) !== null && _this$create$sponsor_2 !== void 0 ? _this$create$sponsor_2 : '', "&date=").concat(convertedDate !== null && convertedDate !== void 0 ? convertedDate : '', "&page=").concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
            var l = res.data;
