...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      is_disabled: false,
      filterSetting: ["first_name", "second_name", "third_name", "last_name", "family_name", "birth_date", "national_id", "nationality_number", "home_phone", "work_phone", "home_address", "work_address", "job", "degree"],
      codeCountry: "",
      printLoading: true,
      printObj: {
        id: "printData"
  ...
  methods: {
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/customTable/table-columns/cm_members").then(function (res) {
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/club-members/members/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/club-members/members?page=".concat(page, "&per_page=").concat(this.per_page, "&company_id=").concat(this.company_id, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.membersPagination.last_page && this.current_page != this.membersPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/club-members/members?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&company_id=").concat(this.company_id)).then(function (res) {
          var l = res.data;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/club-members/members/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          ...
          if (result.value) {
            _this7.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"]("/club-members/members/".concat(id)).then(function (res) {
              _this7.checkAll = [];
              _this7.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/club-members/members", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/club-members/members/".concat(id), this.edit).then(function (res) {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm.isVisible("first_name") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "first_name"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_first_name")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("second_name") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "second_name"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_second_name")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("third_name") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "third_name"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_third_name")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("last_name") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "last_name"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_last_name")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("family_name") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "family_name"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_family_name")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("status_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "status_id"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("status")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("national_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "national_id"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_national_id")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("nationality_number") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_nationality_number")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("home_phone") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "home_phone"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_home_phone")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("work_phone") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "work_phone"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_work_phone")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("home_address") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "home_address"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_home_address")) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("work_address") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "work_address"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_job")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("degree") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "degree"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_degree")))]) : _vm._e()], 1)], 1), _vm._v(" "), _c("div", {
  ...
  }, [_vm.isPermission("create memberRequest club") ? _c("b-button", {
    directives: [{
      name: "b-modal",
  ...
  })]), _vm._v(" "), _vm.checkAll.length == 1 && _vm.isPermission("update memberRequest club") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
  ...
  })]) : _vm._e(), _vm._v(" "), _vm.checkAll.length > 1 && _vm.isPermission("delete memberRequest club") ? _c("button", {
    staticClass: "custom-btn-dowonload",
    on: {
      click: function click($event) {
        $event.preventDefault();
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_family_name")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("birth_date") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_birth_date")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("gender") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_work_address")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("first_name") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_job")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.isVisible("degree") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("member_request_create_form"),
      "title-class": "font-18",
    ...
    staticClass: "row"
  }, [_vm.isVisible("applying_date") ? _c("div", {
    ...
    on: {
      change: function change($event) {
        return _vm.v_dateCreate($event, "applying_date");
      }
    },
    model: {
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("applying_number") ? _c("div", {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.applying_number.$model,
      expression: "$v.create.applying_number.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.applying_number.$error || _vm.errors.applying_number,
      "is-valid": !_vm.$v.create.applying_number.$invalid && !_vm.errors.applying_number
    },
    attrs: {
      type: "number"
    },
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.applying_number, "$model", $event.target.value);
      }
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e()]), _vm._v(" "), _vm.isVisible("first_name") || _vm.isVisible("second_name") || _vm.isVisible("third_name") || _vm.isVisible("last_name") || _vm.isVisible("family_name") ? _c("hr", {
    staticStyle: {
    ...
    staticClass: "row"
  }, [_vm.isVisible("first_name") ? _c("div", {
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("second_name") ? _c("div", {
    staticClass: "col-md-2"
  }, [_c("div", {
    staticClass: "form-group"
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("third_name") ? _c("div", {
    staticClass: "col-md-2"
  }, [_c("div", {
    staticClass: "form-group"
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("last_name") ? _c("div", {
    staticClass: "col-md-2"
  }, [_c("div", {
    staticClass: "form-group"
  ...
  }), _vm._v(" "), _vm.errors.last_name ? _vm._l(_vm.errors.third_name, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                      ")]);
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("family_name") ? _c("div", {
    staticClass: "col-md-2"
  }, [_c("div", {
    staticClass: "form-group"
  ...
  }) : _vm._e()], 2)]) : _vm._e()]), _vm._v(" "), _vm.isVisible("gender") || _vm.isVisible("national_id") || _vm.isVisible("nationality_number") || _vm.isVisible("birth_date") ? _c("hr", {
    staticStyle: {
      margin: "10px 0 !important",
      "border-top": "1px solid rgb(141 163 159 / 42%)"
    }
    ...
    staticClass: "row"
  }, [_vm.isVisible("birth_date") ? _c("div", {
    staticClass: "col-md-3 position-relative"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    ...
    on: {
      change: function change($event) {
        return _vm.v_dateCreate($event, "birth_date");
      }
    },
    model: {
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("national_id") ? _c("div", {
    staticClass: "col-md-3"
  }, [_c("div", {
    staticClass: "form-group"
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("nationality_number") ? _c("div", {
    staticClass: "col-md-3"
  }, [_c("div", {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.nationality_number.$model,
      expression: "$v.create.nationality_number.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.nationality_number.$error || _vm.errors.nationality_number,
      "is-valid": !_vm.$v.create.nationality_number.$invalid && !_vm.errors.nationality_number
    },
    attrs: {
      type: "number"
    },
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.nationality_number, "$model", $event.target.value);
      }
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e()]), _vm._v(" "), _vm.isVisible("home_phone") || _vm.isVisible("home_address") || _vm.isVisible("work_phone") || _vm.isVisible("work_address") ? _c("hr", {
    staticStyle: {
      margin: "10px 0 !important",
      "border-top": "1px solid rgb(141 163 159 / 42%)"
    }
    ...
    staticClass: "row"
  }, [_vm.isVisible("home_phone") ? _c("div", {
    staticClass: "col-md-3"
  }, [_c("div", {
    staticClass: "form-group"
    ...
    on: {
      update: _vm.updatePhoneEdit
    },
    model: {
      value: _vm.$v.create.home_phone.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.home_phone, "$model", $$v);
      },
      expression: "$v.create.home_phone.$model"
    }
  }), _vm._v(" "), _vm.errors.home_phone ? _vm._l(_vm.errors.home_phone, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                      ")]);
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("home_address") ? _c("div", {
    staticClass: "col-md-3"
  }, [_c("div", {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.home_address.$model,
      expression: "$v.create.home_address.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.home_address.$error || _vm.errors.home_address,
      "is-valid": !_vm.$v.create.home_address.$invalid && !_vm.errors.home_address
    },
    attrs: {
      type: "text"
    },
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.home_address, "$model", $event.target.value);
      }
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("work_phone") ? _c("div", {
    staticClass: "col-md-3"
  }, [_c("div", {
    staticClass: "form-group"
    ...
    model: {
      value: _vm.$v.create.work_phone.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.work_phone, "$model", $$v);
      },
      expression: "$v.create.work_phone.$model"
    }
  }), _vm._v(" "), _vm.errors.work_phone ? _vm._l(_vm.errors.work_phone, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                      ")]);
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("work_address") ? _c("div", {
    staticClass: "col-md-3"
  }, [_c("div", {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.work_address.$model,
      expression: "$v.create.work_address.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.work_address.$error || _vm.errors.work_address,
      "is-valid": !_vm.$v.create.work_address.$invalid && !_vm.errors.work_address
    },
    attrs: {
      type: "text"
    },
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.work_address, "$model", $event.target.value);
      }
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e()]), _vm._v(" "), _vm.isVisible("job") || _vm.isVisible("degree") ? _c("hr", {
    staticStyle: {
      margin: "10px 0 !important",
      "border-top": "1px solid rgb(141 163 159 / 42%)"
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.job.$model,
      expression: "$v.create.job.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.job.$error || _vm.errors.job,
      "is-valid": !_vm.$v.create.job.$invalid && !_vm.errors.job
    },
    attrs: {
      type: "text"
    },
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.job, "$model", $event.target.value);
      }
    }
  ...
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _vm.isVisible("degree") ? _c("div", {
    staticClass: "col-md-3"
  }, [_c("div", {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.$v.create.degree.$model,
      expression: "$v.create.degree.$model"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.create.degree.$error || _vm.errors.degree,
      "is-valid": !_vm.$v.create.degree.$invalid && !_vm.errors.degree
    },
    attrs: {
      type: "text"
    },
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.$v.create.degree, "$model", $event.target.value);
      }
    }
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.first_name && _vm.isVisible("first_name") ? _c("th", [_c("div", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.second_name && _vm.isVisible("second_name") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.third_name && _vm.isVisible("third_name") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.last_name && _vm.isVisible("last_name") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.family_name && _vm.isVisible("family_name") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.birth_date && _vm.isVisible("birth_date") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.gender && _vm.isVisible("gender") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("member_gender")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.national_id && _vm.isVisible("national_id") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.nationality_number && _vm.isVisible("nationality_number") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.home_phone && _vm.isVisible("home_phone") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.work_phone && _vm.isVisible("work_phone") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.home_address && _vm.isVisible("home_address") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.work_address && _vm.isVisible("work_address") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.job && _vm.isVisible("job") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.degree && _vm.isVisible("degree") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.acceptance && _vm.isVisible("acceptance") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    return _c("tr", {
      ...
      on: {
        ...
        dblclick: function dblclick($event) {
          $event.preventDefault();
          _vm.isPermission("update memberRequest club") ? _vm.$bvModal.show("modal-edit-".concat(data.id)) : false;
        }
      }
    }, [_vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    ...
    }, [_vm.isPermission("update memberRequest club") ? _c("a", {
      staticClass: "dropdown-item",
      attrs: {
        href: "#"
      },
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.isPermission("delete memberRequest club") ? _c("a", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("member_request_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      on: {
        change: function change($event) {
          return _vm.v_dateEdit($event, "applying_date");
        }
      },
      model: {
        value: _vm.applying_date,
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.applying_number.$error || _vm.errors.applying_number,
        "is-valid": !_vm.$v.edit.applying_number.$invalid && !_vm.errors.applying_number
      },
      attrs: {
        type: "number"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.first_name.$error || _vm.errors.first_name,
        "is-valid": !_vm.$v.edit.first_name.$invalid && !_vm.errors.first_name
      },
      attrs: {
        type: "text"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.second_name.$error || _vm.errors.second_name,
        "is-valid": !_vm.$v.edit.second_name.$invalid && !_vm.errors.second_name
      },
      attrs: {
        type: "text"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.third_name.$error || _vm.errors.third_name,
        "is-valid": !_vm.$v.edit.third_name.$invalid && !_vm.errors.third_name
      },
      attrs: {
        type: "text"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.last_name.$error || _vm.errors.last_name,
        "is-valid": !_vm.$v.edit.last_name.$invalid && !_vm.errors.last_name
      },
      attrs: {
        type: "text"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.family_name.$error || _vm.errors.family_name,
        "is-valid": !_vm.$v.edit.family_name.$invalid && !_vm.errors.family_name
      },
      attrs: {
        type: "text"
      },
      ...
      "class": {
        "is-invalid": _vm.$v.edit.gender.$error || _vm.errors.gender,
        "is-valid": !_vm.$v.edit.gender.$invalid && !_vm.errors.gender
      }
    }, [_c("b-form-radio", {
      staticClass: "d-inline-block",
      attrs: {
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.national_id.$error || _vm.errors.national_id,
        "is-valid": !_vm.$v.edit.national_id.$invalid && !_vm.errors.national_id
      },
      attrs: {
        type: "number"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.nationality_number.$error || _vm.errors.nationality_number,
        "is-valid": !_vm.$v.edit.nationality_number.$invalid && !_vm.errors.nationality_number
      },
      attrs: {
        type: "number"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.home_address.$error || _vm.errors.home_address,
        "is-valid": !_vm.$v.edit.home_address.$invalid && !_vm.errors.home_address
      },
      attrs: {
        type: "text"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.work_address.$error || _vm.errors.work_address,
        "is-valid": !_vm.$v.edit.work_address.$invalid && !_vm.errors.work_address
      },
      attrs: {
        type: "text"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.job.$error || _vm.errors.job,
        "is-valid": !_vm.$v.edit.job.$invalid && !_vm.errors.job
      },
      attrs: {
        type: "text"
      },
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.degree.$error || _vm.errors.degree,
        "is-valid": !_vm.$v.edit.degree.$invalid && !_vm.errors.degree
      },
      attrs: {
        type: "text"
      },
