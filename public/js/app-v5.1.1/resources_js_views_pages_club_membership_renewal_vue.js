    ...
    create: {
      memberships_renewals: {
        ...
        $each: {
          ...
          membership_cost: {
            required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_10__.required,
            decimal: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_10__.decimal,
            minValue: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_10__.minValue)(0.01)
          },
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              filter = "";
              for (i = 0; i < _this3.filterSetting.length; ++i) {
                filter += "columns[".concat(i, "]=").concat(_this3.filterSetting[i], "&");
              }
              _context.next = 6;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/memberships-renewals?page=".concat(page, "&per_page=").concat(_this3.per_page, "&search=").concat(_this3.search, "&").concat(filter)).then(function (res) {
                var l = res.data;
                _this3.membershipRenewals = l.data;
                _this3.membershipRenewalsPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      this.create.memberships_renewals.forEach(function (el, index) {
        _this9.create.memberships_renewals[index].from = "".concat(el.fromMonth, "-").concat(el.fromDay);
        _this9.create.memberships_renewals[index].to = "".concat(el.toMonth, "-").concat(el.toDay);
      });
      this.$v.create.$touch();
...
var render = function render() {
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.from ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("membership_renewal_from")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.to ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("membership_renewal_to")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.membership_availability ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("membership_renewal_membership_availability")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.membership_cost ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("membership_renewal_renewal_membership_cost")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.renewal_availability ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("membership_renewal_renewal_availability")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.renewal_cost ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
