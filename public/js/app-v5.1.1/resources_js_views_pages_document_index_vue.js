  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/document?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this10.documents = l.data;
        _this10.documentsPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/document", _objectSpread({}, this.create)).then(function (res) {
          ...
          _this16.document_id = res.data.data.id;
          _this16.getData();
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
              icon: "success",
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        var _this$edit = this.edit,
          ...
          is_default = _this$edit.is_default;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _this18.docType();
            case 2:
              module = _this18.documents.find(function (e) {
                return id == e.id;
              });
              _this18.$bvModal.show("modal-edit-".concat(id));
              _this18.edit.name = module.name;
              _this18.edit.name_e = module.name_e;
              _this18.edit.is_default = module.is_default;
              if (module.attributes) {
                _this18.edit_effects.cash = module.attributes.cash;
                _this18.edit_effects.customer = module.attributes.customer;
                _this18.edit_effects.supplier = module.attributes.supplier;
                _this18.edit_effects.item_quantity = module.attributes.item_quantity;
                _this18.edit_effects.reserved_quantity = module.attributes.reserved_quantity;
                _this18.edit_effects.ordered_quantity = module.attributes.ordered_quantity;
                _this18.edit_effects.available = module.attributes.available;
              }
              _context4.next = 10;
            ...
            case 12:
              _this18.document_id = module.id;
              _this18.branchFormEdit.branche_id = module.branche_id;
              _this18.branchFormEdit.serial_id = module.serial_id;
              _this18.edit_linked_with_docs = module.document_Relateds.map(function (doc) {
                return doc.id;
              });
              _this18.errors = {};
            case 17:
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.addBranchForm("create");
      }
    }
  }, [_vm._v("\n                                            " + _vm._s(_vm.$t("general.Add")) + "\n                                        ")]) : _c("b-button", {
    staticClass: "mx-1",
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.branch")))]), _vm._v(" "), _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")]), _vm._v(" "), _c("multiselect", {
    "class": {
      "is-invalid": _vm.$v.branchFormCreate.branche_id.$error
    },
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.branches.find(function (type) {
          return type.id == opt;
        }).name : _vm.branches.find(function (type) {
          return type.id == opt;
        }).name_e;
      }
    },
    model: {
      value: _vm.$v.branchFormCreate.branche_id.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.branchFormCreate.branche_id, "$model", $$v);
      },
      expression: "$v.branchFormCreate.branche_id.$model"
    }
  }), _vm._v(" "), !_vm.$v.branchFormCreate.branche_id.required ? _c("div", {
    staticClass: "invalid-feedback"
    ...
    staticClass: "my-1 mr-2"
  }, [_vm._v(_vm._s(_vm.$t("general.serial")))]), _vm._v(" "), _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")]), _vm._v(" "), _c("multiselect", {
    "class": {
      "is-invalid": _vm.$v.branchFormCreate.serial_id.$error
    },
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.serials.find(function (type) {
          return type.id == opt;
        }).start_no;
      }
    },
    model: {
      value: _vm.$v.branchFormCreate.serial_id.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.branchFormCreate.serial_id, "$model", $$v);
      },
      expression: "$v.branchFormCreate.serial_id.$model"
    }
  }), _vm._v(" "), !_vm.$v.branchFormCreate.serial_id.required ? _c("div", {
    staticClass: "invalid-feedback"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.is_default && _vm.isVisible("is_default") ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("document_status")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.is_default && _vm.isVisible("is_default") ? _c("td", [_c("span", {
      "class": [data.is_default == "active" ? "text-success" : "text-danger", "badge"]
    }, [_vm._v("\n                                            " + _vm._s(data.is_default == "active" ? "".concat(_vm.$t("general.Active")) : "".concat(_vm.$t("general.Inactive"))) + "\n                                        ")])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
    ...
    }, [_c("form", [_vm.$store.state.auth.user.type == "super_admin" ? _c("div", {
      staticClass: "mb-3 d-flex justify-content-end"
    }, [!_vm.isLoader ? _c("b-button", {
      staticClass: "mx-1",
      attrs: {
    ...
    }, [_vm._v("\n                                                        " + _vm._s(_vm.$t("general.Cancel")) + "\n                                                    ")])], 1) : _vm._e(), _vm._v(" "), _c("b-tabs", [_c("b-tab", {
      attrs: {
        title: _vm.$t("general.DataEntry"),
        active: ""
      }
      ...
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.addBranchForm("update");
        }
      }
    }, [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.Add")) + "\n                                                            ")]) : _c("b-button", {
      staticClass: "mx-1",
      ...
      "class": {
        "is-invalid": _vm.$v.branchFormEdit.branche_id.$error
      },
      attrs: {
        options: _vm.branches.map(function (type) {
          return type.id;
      ...
      model: {
        value: _vm.$v.branchFormEdit.branche_id.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.branchFormEdit.branche_id, "$model", $$v);
        },
        expression: "$v.branchFormEdit.branche_id.$model"
      }
    }), _vm._v(" "), !_vm.$v.branchFormEdit.branche_id.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                                        " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                                    ")]) : _vm._e()], 1)]), _vm._v(" "), _c("div", {
      staticClass: "col-md-6 position-relative"
    }, [_c("div", {
      ...
      "class": {
        "is-invalid": _vm.$v.branchFormEdit.serial_id.$error
      },
      attrs: {
        options: _vm.serials.map(function (type) {
          return type.id;
      ...
      model: {
        value: _vm.$v.branchFormEdit.serial_id.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.branchFormEdit.serial_id, "$model", $$v);
        },
        expression: "$v.branchFormEdit.serial_id.$model"
      }
    }), _vm._v(" "), !_vm.$v.branchFormEdit.serial_id.required ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                                                        " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                                                    ")]) : _vm._e()], 1)])])]), _vm._v(" "), _c("b-tab", {
      attrs: {
        title: _vm.$t("general.linkedWithDocs")
