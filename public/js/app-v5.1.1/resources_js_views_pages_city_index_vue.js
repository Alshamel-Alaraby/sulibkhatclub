(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_city_index_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/city/index.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/city/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      checkAll: [],
      current_page: 1,
      filterSetting: ["name", "name_e", this.$i18n.locale == "ar" ? "country.name" : "country.name_e", this.$i18n.locale == "ar" ? "governorate.name" : "governorate.name_e", "governorate_id"],
      countries: [],
      governorates: [],
      is_disabled: false,
      Tooltip: "",
  ...
  methods: {
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/general_cities").then(function (res) {
    ...
    showGovernateModal: function showGovernateModal() {
      if (this.create.governorate_id == 0) {
        this.$bvModal.show("governate-create");
        this.create.governorate_id = null;
      }
    },
    showEditGovernateModal: function showEditGovernateModal() {
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      this.enabled3 = false;
      setTimeout(function () {
        var elt = _this5.$refs.exportable_table;
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ("City" + "." || 0) + (type || "xlsx"));
        }
        _this5.enabled3 = true;
      }, 100);
    },
    /**
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&columns=").concat(filter)).then(function (res) {
        var l = res.data;
        _this6.cities = l.data;
        _this6.citiesPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.citiesPagination.last_page && this.current_page != this.citiesPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&columns=").concat(filter)).then(function (res) {
          var l = res.data;
          _this7.cities = l.data;
          _this7.citiesPagination = l.pagination;
     ...
     */
    deleteCity: function deleteCity(id, index) {
      var _this8 = this;
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/cities/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this8.checkAll = [];
              _this8.getData();
    ...
    resetModal: function resetModal() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!_this10.isVisible("country_id")) {
                _context.next = 3;
                break;
              }
              _context.next = 3;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        this.is_disabled = false;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/cities", _objectSpread(_objectSpread({}, this.create), {}, {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              city = _this13.cities.find(function (e) {
                return id == e.id;
              });
            ...
            case 4:
              if (!_this13.isVisible("governorate_id")) {
                _context2.next = 7;
                break;
              }
              _context2.next = 7;
              return _this13.getGovernorate(city.country.id);
            case 7:
              _this13.edit.name = city.name;
              _this13.edit.name_e = city.name_e;
              _this13.edit.is_active = city.is_active ? 1 : 0;
              if (city.country) _this13.edit.country_id = city.country.id;
              if (city.governorate) _this13.edit.governorate_id = city.governorate.id;
              _this13.errors = {};
            case 13:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              if (id == 0) {
                _this15.$bvModal.show("country-create");
                _this15.create.country_id = null;
                _this15.edit.country_id = null;
              }
              if (id) {
                _context4.next = 3;
                break;
            ...
            case 3:
              if (!_this15.isVisible("country_id")) {
                _context4.next = 11;
                break;
              }
              _this15.governorates = [];
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/city/index.vue?vue&type=template&id=dc41a250&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/city/index.vue?vue&type=template&id=dc41a250& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Country", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("city.citiesTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("city_name_ar")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("name_e") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "name_e"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("city_name_en")))]) : _vm._e(), _vm._v(" "), _vm.isVisible("country_id") ? _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("governorate")))]) : _vm._e()], 1)], 1), _vm._v(" "), _c("div", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.deleteCity(_vm.checkAll);
      }
    }
  }, [_c("i", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.deleteCity(_vm.checkAll[0]);
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-trash-alt"
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.citiesPagination.from) + "-" + _vm._s(_vm.citiesPagination.to) + " /\n                    " + _vm._s(_vm.citiesPagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.citiesPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.citiesPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.citiesPagination.last_page == _vm.citiesPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("city_name_ar")))]), _vm._v(" "), _c("div", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("city_name_en")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("city_status")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.cities.length > 0 ? _c("tbody", _vm._l(_vm.cities, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      on: {
        input: _vm.showEditGovernateModal
      },
      model: {
        value: _vm.edit.governorate_id,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "governorate_id", $$v);
        },
        expression: "edit.governorate_id"
      }
...
/***/ "./resources/js/views/pages/city/index.vue":
/*!*************************************************!*\
  !*** ./resources/js/views/pages/city/index.vue ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_dc41a250___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=dc41a250& */ "./resources/js/views/pages/city/index.vue?vue&type=template&id=dc41a250&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/city/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_dc41a250___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_dc41a250___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/city/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/city/index.vue?vue&type=script&lang=js&":
/*!**************************************************************************!*\
  !*** ./resources/js/views/pages/city/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/city/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/pages/city/index.vue?vue&type=template&id=dc41a250&":
/*!********************************************************************************!*\
  !*** ./resources/js/views/pages/city/index.vue?vue&type=template&id=dc41a250& ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_dc41a250___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_dc41a250___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_dc41a250___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=dc41a250& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/city/index.vue?vue&type=template&id=dc41a250&");
