...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      if (vm.$store.state.auth.work_flow_trees.includes("department") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
  ...
  validations: {
    ...
    createTask: {
      name: {
        ...
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__.maxLength)(255)
      },
      name_e: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__.required,
        minLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__.minLength)(2),
  ...
  methods: {
    ...
    arabicValueTask: function arabicValueTask(txt) {
      this.createTask.name = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.arabicValue)(txt);
      this.editTask.name = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.arabicValue)(txt);
    },
    englishValueTask: function englishValueTask(txt) {
      this.createTask.name_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.englishValue)(txt);
      this.editTask.name_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.englishValue)(txt);
    },
    arabicValueDescriptionTask: function arabicValueDescriptionTask(txt) {
      this.createTask.description = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.arabicValue)(txt);
      this.editTask.description = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.arabicValue)(txt);
    },
    englishValueDescriptionTask: function englishValueDescriptionTask(txt) {
      this.createTask.description_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.englishValue)(txt);
      this.editTask.description_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_13__.englishValue)(txt);
    },
    /**
    ...
    getDataTask: function getDataTask() {
      ...
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tasks?page=".concat(page, "&per_page=").concat(this.per_page, "&department_id=").concat(this.department_id)).then(function (res) {
        var l = res.data;
        _this6.tasks = l.data;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/depertments", _objectSpread(_objectSpread({}, this.create), {}, {
          ...
          _this13.department_id = res.data.data.id;
          _this13.getData();
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
              icon: "success",
     ...
     *  edit countrie
     */
    editSubmitTask: function editSubmitTask(id) {
      var _this16 = this;
      ...
      if (!this.editTask.description) {
        this.editTask.description = this.editTask.description_e;
      }
      if (!this.editTask.description_e) {
        this.editTask.description_e = this.editTask.description;
      }
      ...
      if (this.$v.editTask.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/department-tasks/".concat(id), _objectSpread(_objectSpread({}, this.editTask), {}, {
          department_id: this.department_id
        })).then(function (res) {
          _this16.getDataTask();
          setTimeout(function () {
    ...
    resetModalEditTask: function resetModalEditTask(id) {
      var _this19 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var tasks;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              tasks = _this19.tasks.find(function (e) {
                return id == e.id;
              });
              _this19.editTask.name = tasks.name;
              _this19.editTask.name_e = tasks.name_e;
              _this19.editTask.description = tasks.description;
              _this19.editTask.description_e = tasks.description_e;
              _this19.errors = {};
            case 6:
            case "end":
              return _context.stop();
     ...
     *  hidden Modal (edit)
     */
    resetModalHiddenEditTask: function resetModalHiddenEditTask(id) {
      this.errors = {};
      this.editTask = {
        name: "",
        name_e: "",
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.AddNewRecord")) + "\n                            ")]), _vm._v(" "), !_vm.is_disabledTask ? [!_vm.isLoader ? _c("b-button", {
    staticClass: "mx-1",
    attrs: {
      variant: "success",
      type: "button"
    ...
    staticClass: "sr-only"
  }, [_vm._v(_vm._s(_vm.$t("login.Loading")) + "...")])], 1)] : _vm._e()], 2), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [_c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    ...
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.$v.createTask.name.$error || _vm.errors.name,
      "is-valid": !_vm.$v.createTask.name.$invalid && !_vm.errors.name
    },
    attrs: {
      type: "text",
      "data-create": "1",
    ...
    return _c("tr", {
    ...
    }, [_vm._v(_vm._s(_vm.$t("general.tasks")))]), _vm._v(" "), _c("div", {
      staticClass: "col-2 header-title"
    }, [_c("b-button", {
      directives: [{
        name: "b-modal",
        rawName: "v-b-modal.create-task",
        modifiers: {
          "create-task": true
        }
      }],
      ...
      staticClass: "table table-borderless table-hover table-centered m-0"
    }, [_c("thead", [_c("tr", [_vm.setting.name ? _c("th", [_c("div", {
      staticClass: "d-flex justify-content-center"
      ...
      staticClass: "do-not-print"
    }, [_vm._v("\n                                          " + _vm._s(_vm.$t("general.Action")) + "\n                                      ")]) : _vm._e()])]), _vm._v(" "), _vm.tasks.length > 0 ? _c("tbody", _vm._l(_vm.tasks, function (data2, index) {
      return _c("tr", {
        key: data2.id,
        staticClass: "body-tr-custom",
        on: {
          dblclick: function dblclick($event) {
            $event.preventDefault();
            return _vm.$bvModal.show("modal-edit-task-".concat(data.id));
          }
        }
      }, [_vm.setting.name ? _c("td", [_c("h5", {
        staticClass: "m-0 font-weight-normal"
      }, [_vm._v(_vm._s(data2.name))])]) : _vm._e(), _vm._v(" "), _vm.setting.name_e ? _c("td", [_c("h5", {
        staticClass: "m-0 font-weight-normal"
      }, [_vm._v(_vm._s(data2.name_e))])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
        staticClass: "do-not-print"
      }, [_c("div", {
        staticClass: "btn-group"
      }, [_c("button", {
        ...
        on: {
          click: function click($event) {
            return _vm.$bvModal.show("modal-edit-task-".concat(data2.id));
          }
        }
      }, [_c("div", {
        staticClass: "d-flex justify-content-between align-items-center text-black"
        ...
        on: {
          click: function click($event) {
            $event.preventDefault();
            return _vm.deleteTasks(data.id);
          }
        }
      }, [_c("div", {
        staticClass: "d-flex justify-content-between align-items-center text-black"
        ...
        ref: "edit-".concat(data2.id),
        refInFor: true,
        attrs: {
          id: "modal-edit-task-".concat(data2.id),
        ...
        on: {
          show: function show($event) {
            return _vm.resetModalEditTask(data2.id);
          },
          hidden: function hidden($event) {
            return _vm.resetModalHiddenEditTask(data2.id);
          }
        }
      }, [_c("form", [_c("div", {
        staticClass: "mb-3 d-flex justify-content-end"
        ...
        on: {
          click: function click($event) {
            $event.preventDefault();
            return _vm.editSubmitTask(data2.id);
          }
        }
      }, [_vm._v("\n                                                          " + _vm._s(_vm.$t("general.Edit")) + "\n                                                      ")]) : _c("b-button", {
        staticClass: "mx-1",
        ...
        on: {
          click: function click($event) {
            $event.preventDefault();
            return _vm.$bvModal.hide("modal-edit-task-".concat(data2.id));
          }
        }
      }, [_vm._v("\n                                                          " + _vm._s(_vm.$t("general.Cancel")) + "\n                                                      ")])], 1), _vm._v(" "), _c("div", {
        staticClass: "row"
        ...
        directives: [{
          name: "model",
          rawName: "v-model",
          value: _vm.$v.editTask.name.$model,
          expression: "$v.editTask.name.$model"
        }],
        staticClass: "form-control",
        "class": {
          "is-invalid": _vm.$v.editTask.name.$error || _vm.errors.name,
          "is-valid": !_vm.$v.editTask.name.$invalid && !_vm.errors.name
        },
        attrs: {
          type: "text",
          "data-edit": "1",
        ...
        on: {
          keyup: function keyup($event) {
            return _vm.arabicValueTask(_vm.editTask.name);
          },
          input: function input($event) {
            if ($event.target.composing) return;
            _vm.$set(_vm.$v.editTask.name, "$model", $event.target.value);
          }
        }
      })]), _vm._v(" "), !_vm.$v.edit.name.minLength ? _c("div", {
        staticClass: "invalid-feedback"
        ...
        directives: [{
          name: "model",
          rawName: "v-model",
          value: _vm.$v.editTask.name_e.$model,
          expression: "$v.editTask.name_e.$model"
        }],
        staticClass: "form-control englishInput",
        "class": {
          "is-invalid": _vm.$v.editTask.name_e.$error || _vm.errors.name_e,
          "is-valid": !_vm.$v.editTask.name_e.$invalid && !_vm.errors.name_e
        },
        attrs: {
          type: "text",
          "data-edit": "2",
        ...
        on: {
          keyup: function keyup($event) {
            return _vm.englishValueTask(_vm.editTask.name_e);
          },
          input: function input($event) {
            if ($event.target.composing) return;
            _vm.$set(_vm.$v.editTask.name_e, "$model", $event.target.value);
          }
        }
      })]), _vm._v(" "), !_vm.$v.editTask.name_e.minLength ? _c("div", {
        staticClass: "invalid-feedback"
      }, [_vm._v("\n                                                                  " + _vm._s(_vm.$t("general.Itmustbeatleast")) + "\n                                                                  " + _vm._s(_vm.$v.editTask.name_e.$params.minLength.min) + "\n                                                                  " + _vm._s(_vm.$t("general.letters")) + "\n                                                              ")]) : _vm._e(), _vm._v(" "), !_vm.$v.editTask.name_e.maxLength ? _c("div", {
        staticClass: "invalid-feedback"
      }, [_vm._v("\n                                                                  " + _vm._s(_vm.$t("general.Itmustbeatmost")) + "\n                                                                  " + _vm._s(_vm.$v.editTask.name_e.$params.maxLength.max) + "\n                                                                  " + _vm._s(_vm.$t("general.letters")) + "\n                                                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.name_e ? _vm._l(_vm.errors.name_e, function (errorMessage, index) {
        return _c("ErrorMessage", {
          key: index
        }, [_vm._v(_vm._s(errorMessage))]);
      }) : _vm._e()], 2)]), _vm._v(" "), _c("div", {
        ...
        directives: [{
          name: "model",
          rawName: "v-model",
          value: _vm.$v.editTask.description.$model,
          expression: "$v.editTask.description.$model"
        }],
        staticClass: "form-control",
        attrs: {
          maxlength: 1000,
        ...
        on: {
          input: [function ($event) {
            if ($event.target.composing) return;
            _vm.$set(_vm.$v.editTask.description, "$model", $event.target.value);
          }, function ($event) {
            return _vm.arabicValueDescriptionTask(_vm.editTask.description);
          }]
        }
      }), _vm._v(" "), _vm.errors.description ? _vm._l(_vm.errors.description, function (errorMessage, index) {
        return _c("ErrorMessage", {
        ...
        directives: [{
          name: "model",
          rawName: "v-model",
          value: _vm.$v.editTask.description_e.$model,
          expression: "$v.editTask.description_e.$model"
        }],
        staticClass: "form-control",
        attrs: {
          maxlength: 1000,
        ...
        on: {
          input: [function ($event) {
            if ($event.target.composing) return;
            _vm.$set(_vm.$v.editTask.description_e, "$model", $event.target.value);
          }, function ($event) {
            return _vm.englishValueDescriptionTask(_vm.editTask.description_e);
          }]
        }
      }), _vm._v(" "), _vm.errors.description_e ? _vm._l(_vm.errors.description_e, function (errorMessage, index) {
        return _c("ErrorMessage", {
