...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  // },
  methods: {
    onOwnerSelected: function onOwnerSelected(wallet_id) {
      this.owner_id = null;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/real-estate/units/general-filter?page=".concat(page, "&per_page=").concat(this.per_page).concat(this.building_id ? "&building_id=".concat(this.building_id) : "", "\n          ").concat(this.unit_ty ? "&unit_ty=".concat(this.unit_ty) : "", "\n          ").concat(this.unit_area ? "&unit_area=".concat(this.unit_area) : "", "\n          ").concat(this.rooms ? "&rooms=".concat(this.rooms) : "", "\n          ").concat(this.path ? "&path=".concat(this.path) : "", "\n          ").concat(this.property_id ? "&properties=".concat(this.property_id) : "", "\n          ").concat(this.wallet_id ? "&wallet_id=".concat(this.wallet_id) : "", "\n          ").concat(this.owner_id ? "&owner_id=".concat(this.owner_id) : "", "\n          ").concat(this.country_id ? "&country_id=".concat(this.country_id) : "", "\n          ").concat(this.city_id ? "&city_id=".concat(this.city_id) : "", "\n          ").concat(this.governorate_id ? "&governorate_id=".concat(this.governorate_id) : "", "\n          ")).then(function (res) {
        var l = res.data;
        _this4.items = l.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.itemsPagination.last_page && this.current_page != this.itemsPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/real-estate/units/general-filter?page=".concat(this.current_page, "&per_page=").concat(this.per_page).concat(this.building_id ? "&building_id=".concat(this.building_id) : "", "\n          ").concat(this.unit_ty ? "&unit_ty=".concat(this.unit_ty) : "", "\n          ").concat(this.unit_area ? "&unit_area=".concat(this.unit_area) : "", "\n          ").concat(this.rooms ? "&rooms=".concat(this.rooms) : "", "\n          ").concat(this.path ? "&path=".concat(this.path) : "", "\n          ").concat(this.property_id ? "&properties=".concat(this.property_id) : "", "\n          ").concat(this.wallet_id ? "&wallet_id=".concat(this.wallet_id) : "", "\n          ").concat(this.owner_id ? "&owner_id=".concat(this.owner_id) : "", "\n          ").concat(this.country_id ? "&country_id=".concat(this.country_id) : "", "\n          ").concat(this.city_id ? "&city_id=".concat(this.city_id) : "", "\n          ").concat(this.governorate_id ? "&governorate_id=".concat(this.governorate_id) : "", "\n          ")).then(function (res) {
          var l = res.data;
          _this5.items = l.data;
    ...
    getOwners: function getOwners(wallet_id) {
      var _this6 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("real-estate/units/owner-wallet/".concat(wallet_id)).then(function (res) {
                var l = res.data.data.owners;
                _this6.owners = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                  icon: "error",
    ...
    getBuildings: function getBuildings(wallet_id) {
      var _this7 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/real-estate/units/building-wallet/".concat(wallet_id)).then(function (res) {
                var l = res.data.data.buildings;
                _this7.buildings = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                  icon: "error",
    ...
    getGovernorates: function getGovernorates(countryId) {
      var _this12 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _this12.governorate_id = null;
              _this12.city_id = null;
              _context7.next = 5;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/governorates?country_id=".concat(countryId)).then(function (res) {
                var l = res.data.data;
                _this12.governorates = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
                  icon: "error",
    ...
    getCities: function getCities(governate_id) {
      var _this13 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _this13.city_id = null;
              _context8.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities?country_id=".concat(_this13.country_id, "&governorate_id=").concat(governate_id)).then(function (res) {
                var l = res.data.data;
                _this13.cities = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("b-modal", {
    ...
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.country")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
    ...
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.governorate")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
    ...
    model: {
      value: _vm.governorate_id,
      callback: function callback($$v) {
        _vm.governorate_id = $$v;
      },
      expression: "governorate_id"
    }
  })], 1), _vm._v(" "), _c("div", {
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.city")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
      options: _vm.cities.map(function (type) {
        return type.id;
      }),
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.cities.find(function (x) {
          return x.id == opt;
    ...
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.Unit_type")))]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.unit_ty,
    ...
    on: {
      input: function input($event) {
        ...
        _vm.unit_ty = $event.target.value;
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.Unit_area")))]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.unit_area,
      expression: "unit_area"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.unit_area = $event.target.value;
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.rooms")))]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.rooms,
    ...
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.path")))]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.path,
  ...
  }, [_vm._v("\n              " + _vm._s(_vm.$t("general.UnsolidUnitReport")) + "\n            ")]), _vm._v(" "), _c("div", {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.unit_status,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "unit_status", $$v);
      },
      expression: "setting.unit_status"
    }
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.wallet,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "wallet", $$v);
      },
      expression: "setting.wallet"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("wallet")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.unit_ty,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "unit_ty", $$v);
      },
      expression: "setting.unit_ty"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("admin_report_unit_ty")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.rooms,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "rooms", $$v);
      },
      expression: "setting.rooms"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("admin_report_rooms")) + "\n                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.path,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "path", $$v);
      },
      expression: "setting.path"
    }
  }, [_vm._v("\n                      " + _vm._s(_vm.getCompanyKey("admin_report_path")) + "\n                    ")]), _vm._v(" "), _c("div", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_status ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("unit_status")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.wallet ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("wallet")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_ty ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("admin_report_unit_ty")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.items.sort(_vm.sortString("unit_ty"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.rooms ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("admin_report_rooms")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.items.sort(_vm.sortString("rooms"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.path ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("admin_report_path")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.items.sort(_vm.sortString("path"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.unit ? _c("td", [_vm._v("\n                    " + _vm._s(_vm.$i18n.locale == "ar" ? data.name : data.name_e) + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.setting.building ? _c("td", [data.building ? [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.building.name : _vm.nameata.building.name_e) + "\n                    ")] : _vm._e()], 2) : _vm._e(), _vm._v(" "), _vm.setting.unit_status ? _c("td", [data.unit_status ? [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.unit_status.name : _vm.nameata.unit_status.name_e) + "\n                    ")] : _vm._e()], 2) : _vm._e(), _vm._v(" "), _vm.setting.owner ? _c("td", [data.owner ? [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.owner.name : _vm.nameata.owner.name_e) + "\n                    ")] : _vm._e()], 2) : _vm._e(), _vm._v(" "), _vm.setting.wallet ? _c("td", [data.wallet ? [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.wallet.name : _vm.nameata.wallet.name_e) + "\n                    ")] : _vm._e()], 2) : _vm._e(), _vm._v(" "), _vm.setting.unit_ty ? _c("td", [_vm._v(_vm._s(data.unit_ty))]) : _vm._e(), _vm._v(" "), _vm.setting.unit_area ? _c("td", [_vm._v(_vm._s(data.unit_area))]) : _vm._e(), _vm._v(" "), _vm.setting.rooms ? _c("td", [_vm._v(_vm._s(data.rooms))]) : _vm._e(), _vm._v(" "), _vm.setting.path ? _c("td", [_vm._v(_vm._s(data.path))]) : _vm._e()]);
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_laravel_mix_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n@media print {\n.do-not-print[data-v-73968aa8] {\r\n    display: none;\n}\n.arrow-sort[data-v-73968aa8] {\r\n    display: none;\n}\n}\nhr[data-v-73968aa8] {\r\n  border-bottom: 1px solid #fff;\n}\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_unsold_unit_report_vue_vue_type_style_index_0_id_73968aa8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_unsold_unit_report_vue_vue_type_style_index_0_id_73968aa8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _unsold_unit_report_vue_vue_type_template_id_73968aa8_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true& */ "./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true&");
...
/* harmony import */ var _unsold_unit_report_vue_vue_type_style_index_0_id_73968aa8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css& */ "./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _unsold_unit_report_vue_vue_type_template_id_73968aa8_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _unsold_unit_report_vue_vue_type_template_id_73968aa8_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "73968aa8",
  null
...
/***/ "./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true&":
/*!***************************************************************************************************************!*\
  !*** ./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true& ***!
  \***************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_unsold_unit_report_vue_vue_type_template_id_73968aa8_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_unsold_unit_report_vue_vue_type_template_id_73968aa8_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_unsold_unit_report_vue_vue_type_template_id_73968aa8_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=template&id=73968aa8&scoped=true&");
...
/***/ "./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css&":
/*!*****************************************************************************************************************************!*\
  !*** ./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_unsold_unit_report_vue_vue_type_style_index_0_id_73968aa8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/realEstate/unsold-unit-report.vue?vue&type=style&index=0&id=73968aa8&scoped=true&lang=css&");
