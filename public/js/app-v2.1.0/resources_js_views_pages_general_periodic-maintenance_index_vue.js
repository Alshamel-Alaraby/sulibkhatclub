...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
<<<<<<< HEAD:public/js/app-v2.0.9/resources_js_views_pages_general_periodic-maintenance_index_vue.js
      isMenuCondensed: false
=======
      version: "v2.1.0"
>>>>>>> origin/main:public/js/app-v2.1.0/resources_js_views_pages_general_periodic-maintenance_index_vue.js
    };
  },
  computed: _objectSpread({}, _state_helpers__WEBPACK_IMPORTED_MODULE_0__.layoutComputed),
  mounted: function mounted() {
