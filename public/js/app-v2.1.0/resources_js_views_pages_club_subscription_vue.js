...
<<<<<<< HEAD:public/js/app-v2.0.9/resources_js_views_pages_club_subscription_vue.js
=======
    isPermission: {},
    url: {
      "default": '/branches'
...
>>>>>>> origin/main:public/js/app-v2.1.0/resources_js_views_pages_club_subscription_vue.js
    menu: {
      type: String,
      required: true
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      checkAll: [],
      current_page: 1,
      filterSetting: ["cm_member_id", "date_from", "date_to", "amount", "prefix"],
      printLoading: true,
      printObj: {
        id: "printData"
      }
