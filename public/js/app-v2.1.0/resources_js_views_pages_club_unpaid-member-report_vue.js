...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    staticClass: "mb-1",
    attrs: {
      value: _vm.$i18n.locale == "ar" ? "member.name" : "member.name_e"
    },
    model: {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.member")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.installmentStatus.sort(_vm.sortString(_vm.$i18n.locale == "ar" ? "first_name" : "first_name"));
      }
    }
  }), _vm._v(" "), _c("i", {
