...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_12__["default"])(vm, "clubsetting", "all setting club");
    });
  },
  data: function data() {
    return {
      ...
      checkAll: [],
      current_page: 1,
      filterSetting: ["cm_members_type_id", "cm_permissions_id", "cm_financial_status_id", "membership_period", "allowed_subscription_date", "allowed_vote_date"
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/type-permission?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this4.settings = l.data;
        _this4.settingsPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this5 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      if (this.current_page <= this.settingsPagination.last_page && this.current_page != this.settingsPagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i < this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/type-permission?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this5.settings = l.data;
          _this5.settingsPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/club-members/type-permission/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this6.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/club-members/type-permission/".concat(id)).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this8.getType();
            case 2:
              _context.next = 4;
              return _this8.getPermissions();
            case 4:
              _context.next = 6;
    ...
    AddSubmit: function AddSubmit() {
      ...
      this.create.memberships_renewals.forEach(function (el, index) {
        _this9.create.memberships_renewals[index].allowed_subscription_date = "".concat(el.month, "-").concat(el.day);
        _this9.create.memberships_renewals[index].allowed_vote_date = "".concat(el.vote_month, "-").concat(el.vote_day);
        _this9.create.memberships_renewals[index].cm_members_type_id = _this9.create.cm_members_type_id;
      });
      this.$v.create.$touch();
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        this.is_disabled = false;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/club-members/type-permission", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/club-members/type-permission/".concat(id), this.edit).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              _context2.next = 4;
              return _this11.getPermissions();
            case 4:
              _context2.next = 6;
              return _this11.getStatus();
            case 6:
              setting = _this11.settings.find(function (e) {
                return id == e.id;
              });
              _this11.edit.day = setting.allowed_subscription_date.slice(3);
              _this11.edit.month = setting.allowed_subscription_date.slice(0, 2);
              _this11.edit.cm_members_type_id = setting.type.id;
              _this11.edit.cm_permissions_id = setting.cm_permissions_id;
              _this11.edit.cm_financial_status_id = setting.financialStatus.id;
              _this11.edit.membership_period = setting.membership_period;
              _this11.edit.allowed_subscription_date = setting.allowed_subscription_date;
              _this11.edit.vote_day = setting.allowed_vote_date.slice(3);
              _this11.edit.vote_month = setting.allowed_vote_date.slice(0, 2);
              _this11.edit.allowed_vote_date = setting.allowed_vote_date;
              _this11.errors = {};
            case 18:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/club-members/members-permissions").then(function (res) {
                var l = res.data.data;
                _this13.permissions = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.SettingTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("membership_period")) + "\n                                        ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.cm_members_type_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "cm_members_type_id", $$v);
      },
      expression: "setting.cm_members_type_id"
    }
  }, [_vm._v(_vm._s(_vm.getCompanyKey("member_type")) + "\n                                            ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.cm_permissions_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "cm_permissions_id", $$v);
      },
      expression: "setting.cm_permissions_id"
    }
  }, [_vm._v("\n                                                " + _vm._s(_vm.getCompanyKey("member_permission")) + "\n                                            ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.cm_financial_status_id,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "cm_financial_status_id", $$v);
      },
      expression: "setting.cm_financial_status_id"
    }
  }, [_vm._v("\n                                                " + _vm._s(_vm.getCompanyKey("financial_status")) + "\n                                            ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.membership_period,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "membership_period", $$v);
      },
      expression: "setting.membership_period"
    }
  }, [_vm._v("\n                                                " + _vm._s(_vm.getCompanyKey("membership_period")) + "\n                                            ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.allowed_subscription_date,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "allowed_subscription_date", $$v);
      },
      expression: "setting.allowed_subscription_date"
    }
  }, [_vm._v("\n                                                " + _vm._s(_vm.getCompanyKey("allowed_subscription_date")) + "\n                                            ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    model: {
      value: _vm.setting.allowed_vote_date,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "allowed_vote_date", $$v);
      },
      expression: "setting.allowed_vote_date"
    }
  }, [_vm._v("\n                                                " + _vm._s(_vm.$t("general.allowed_vote_date")) + "\n                                            ")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                                            " + _vm._s(_vm.settingsPagination.from) + "-" + _vm._s(_vm.settingsPagination.to) + " /\n                                            " + _vm._s(_vm.settingsPagination.total) + "\n                                        ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.settingsPagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.settingsPagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.settingsPagination.last_page == _vm.settingsPagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    attrs: {
      id: "create",
      title: _vm.getCompanyKey("settings_create_form"),
      "title-class": "font-18",
      "body-class": "p-4 ",
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.typs.find(function (x) {
          return x.id == opt;
  ...
  }) : _vm._e()], 2)])]), _vm._v(" "), _vm._l(_vm.create.memberships_renewals, function (item, index) {
    return [_c("div", {
      key: index,
      staticClass: "row"
    }, [_c("div", {
      ...
      attrs: {
        ...
        "custom-label": function customLabel(opt) {
          return _vm.$i18n.locale == "ar" ? _vm.permissions.find(function (x) {
            return x.id == opt;
    ...
    }) : _vm._e()], 2)]), _vm._v(" "), _vm.create.memberships_renewals[index].cm_permissions_id == 2 ? _c("div", {
      staticClass: "col-md-2"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", [_vm._v("\n                                                    " + _vm._s(_vm.$t("general.allowed_vote_date")) + "\n                                                    "), _c("span", {
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.cm_members_type_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("member_type")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.settings.sort(_vm.sortString(_vm.$i18n.locale =  true ? "name" : 0));
      }
    }
  }), _vm._v(" "), _c("i", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.cm_permissions_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("member_permission")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.cm_financial_status_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.membership_period ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("membership_period")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.settings.sort(_vm.sortString("membership_period"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.allowed_subscription_date ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("allowed_subscription_date")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.settings.sort(_vm.sortString("allowed_subscription_date"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.settings.length > 0 ? _c("tbody", _vm._l(_vm.settings, function (data, index) {
    return _c("tr", {
      key: data.id,
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.cm_members_type_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                            " + _vm._s(data.type ? _vm.$i18n.locale == "ar" ? data.type.name : data.type.name_e : " - ") + "\n                                        ")])]) : _vm._e(), _vm._v(" "), _vm.setting.cm_permissions_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                            " + _vm._s(_vm.$i18n.locale == "ar" ? data.permission.name : data.permission.name_e) + "\n                                        ")])]) : _vm._e(), _vm._v(" "), _vm.setting.cm_financial_status_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                                            " + _vm._s(data.financialStatus ? _vm.$i18n.locale == "ar" ? data.financialStatus.name : data.financialStatus.name_e : " - ") + "\n                                        ")])]) : _vm._e(), _vm._v(" "), _vm.setting.membership_period ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.membership_period))])]) : _vm._e(), _vm._v(" "), _vm.setting.allowed_subscription_date ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.allowed_subscription_date.slice(3) + "-" + data.allowed_subscription_date.slice(0, 2)))])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      attrs: {
        ...
        title: _vm.getCompanyKey("settings_edit_form"),
        "title-class": "font-18",
        "body-class": "p-4",
        size: "lg",
        "hide-footer": true
      ...
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.updateAllData.apply(null, arguments);
        }
      }
    }, [_vm._v("\n                                                        " + _vm._s(_vm.$t("general.updateData")) + "\n                                                    ")]) : _c("b-button", {
      staticClass: "mx-1 mr-3 ml-3",
      attrs: {
        variant: "success",
        disabled: ""
      }
      ...
      staticClass: "sr-only"
    }, [_vm._v(_vm._s(_vm.$t("login.Loading")) + "...")])], 1), _vm._v(" "), !_vm.isLoader ? _c("b-button", {
      ...
      staticClass: "form-control",
      "class": {
        "is-invalid": _vm.$v.edit.membership_period.$error || _vm.errors.membership_period,
        "is-valid": !_vm.$v.edit.membership_period.$invalid && !_vm.errors.membership_period
      },
      attrs: {
        type: "number"
      },
    ...
    }) : _vm._e()], 2)]), _vm._v(" "), _vm.edit.cm_permissions_id == 2 ? _c("div", {
      staticClass: "col-md-12"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", [_vm._v("\n                                                                " + _vm._s(_vm.$t("general.allowed_vote_date")) + "\n                                                                "), _c("span", {
