...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getStatus: function getStatus() {
      var _this7 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_6__["default"].get("/club-members/cm-status").then(function (res) {
        var l = res.data.data;
        _this7.statuses = l;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_8___default().fire({
    ...
    getSponsors: function getSponsors() {
      var _this8 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_6__["default"].get("/club-members/sponsers").then(function (res) {
        var l = res.data.data;
        l.unshift({
          id: 0,
          name: "اضف راعي",
    ...
    getFinancialStatus: function getFinancialStatus() {
      var _this10 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_6__["default"].get("/club-members/financial-status").then(function (res) {
        var l = res.data.data;
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    return _c("tr", {
      ...
      attrs: {
        ...
        "custom-label": function customLabel(opt) {
          return _vm.financialStatuses.find(function (x) {
            return x.id == opt;
          }) ? _vm.$i18n.locale == "ar" ? _vm.financialStatuses.find(function (x) {
            return x.id == opt;
