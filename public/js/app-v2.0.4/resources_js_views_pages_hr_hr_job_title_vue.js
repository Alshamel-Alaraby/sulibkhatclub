...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      if (vm.$store.state.auth.work_flow_trees.includes("realEstate unit status") || vm.$store.state.auth.work_flow_trees.includes("hr") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/hr/job-title/", this.create).then(function (res) {
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      _vm._s(
                                        _vm.getCompanyKey("job_title_name_ar")
                                      ) + "\n                  "
                                    ),
                                  ]
                                ),
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      "\n                    " +
                                        _vm._s(
                                          _vm.getCompanyKey("job_title_name_en")
                                        ) +
                                        "\n                  "
                                    ),
                                  ]
