...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_13__["default"])(vm, "Unit Status RealEstate", "all unit_status RealState");
    });
  },
  methods: {
    ...
    getCustomTableFields: function getCustomTableFields() {
      var _this3 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/customTable/table-columns/rlst_items").then(function (res) {
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      [
                        _vm.isPermission("create unit_status RealState")
                          ? _c(
                              "b-button",
                              {
                                directives: [
                        ...
                        _c("div", { staticClass: "d-inline-flex" }, [
                          ...
                          _vm.isPermission("update unit_status RealState")
                            ? _c(
                                "button",
                                {
                                  staticClass: "custom-btn-dowonload",
                          ...
                          _vm._v(" "),
                          _vm.checkAll.length > 1 &&
                          _vm.isPermission("delete unit_status RealState")
                            ? _c(
                                "button",
                                {
                                  staticClass: "custom-btn-dowonload",
