...
use Modules\CarRent\Http\Requests\CarTransmissionRequest;
use Modules\CarRent\Transformers\CarTransmissionResource;

class CarTransmissionController extends Controller
{
    public function __construct(private CarTransmission $model)
    {
        $this->model = $model;
    }
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', CarTransmissionResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
    ...
    public function find($id)
    {
        ...
        return responseJson(200, 'success', new CarTransmissionResource($model));
    }

    public function create(CarTransmissionRequest $request)
    {
    ...
    public function update($id, CarTransmissionRequest $request)
    {
