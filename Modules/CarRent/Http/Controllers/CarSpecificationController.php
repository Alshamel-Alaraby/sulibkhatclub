...
use Modules\CarRent\Http\Requests\CarSpecificationRequest;
use Modules\CarRent\Transformers\CarSpecificationResource;

class CarSpecificationController extends Controller
{
    public function __construct(private CarSpecification $model)
    {
        $this->model = $model;
    }
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', CarSpecificationResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
    ...
    public function find($id)
    {
        ...
        return responseJson(200, 'success', new CarSpecificationResource($model));
    }

    public function create(CarSpecificationRequest $request)
    {
    ...
    public function update($id, CarSpecificationRequest $request)
    {
