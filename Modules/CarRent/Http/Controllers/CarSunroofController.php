...
use Modules\CarRent\Http\Requests\CarSunroofRequest;
use Modules\CarRent\Transformers\CarSunroofResource;

class CarSunroofController extends Controller
{
    public function __construct(private CarSunroof $model)
    {
        $this->model = $model;
    }
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', CarSunroofResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
    ...
    public function find($id)
    {
        ...
        return responseJson(200, 'success', new CarSunroofResource($model));
    }

    public function create(CarSunroofRequest $request)
    {
    ...
    public function update($id, CarSunroofRequest $request)
    {
