...
use Modules\CarRent\Http\Requests\CarFuelTypeRequest;
use Modules\CarRent\Transformers\CarFuelTypeResource;

class CarFuelTypeController extends Controller
{
    public function __construct(private CarFuelType $model)
    {
        $this->model = $model;
    }
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', CarFuelTypeResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
    ...
    public function find($id)
    {
        ...
        return responseJson(200, 'success', new CarFuelTypeResource($model));
    }

    public function create(CarFuelTypeRequest $request)
    {
    ...
    public function update($id, CarFuelTypeRequest $request)
    {
