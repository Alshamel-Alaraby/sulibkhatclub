...
use Modules\CarRent\Http\Requests\CarModelRequest;
use Modules\CarRent\Transformers\CarModelResource;

class CarModelController extends Controller
{
    public function __construct(private CarModel $model)
    {
        $this->model = $model;
    }
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', CarModelResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
    ...
    public function find($id)
    {
        ...
        return responseJson(200, 'success', new CarModelResource($model));
    }
    ...
    {
        $models = $this->model->where('brand_id', $id)->get();

        return responseJson(200, 'success', CarModelResource::collection($models));
    }
}
