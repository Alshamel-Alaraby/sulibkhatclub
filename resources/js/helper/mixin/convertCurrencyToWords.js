export default {
    ...
    methods:{
        convert_currency_to_words(NumIn=0,{Feminine,Comma,SplitHund,Miah,Billions,TextToFollow,AG,Subject,Legal}={}) {
            ...
            TableUnits   = [...this.TableMale]; Table11_19= [...this.TableMale]; // Create copies of Masculine Table for manipulation
            ...
            if (Feminine === ON && !Scale)  {          // If Feminine, use the Feminine table if no scale
              TableUnits   = [...this.TableFemale]; Table11_19= [...this.TableFemale];// Create copies of Feminine Table for manipulation
