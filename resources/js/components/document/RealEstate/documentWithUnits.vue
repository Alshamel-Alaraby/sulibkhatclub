...
import CreateOrUpdateUnits from "./components/create-or-update-units.vue";
...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      let index = this.filterSetting.indexOf("tenant_id");
      if (index > -1) {
        _filterSetting[index] =
          this.$i18n.locale == "ar" ? "tenant.name" : "tenant.name_e";
      }
      ...
      adminApi
        .get(`/real-estate/contract-headers`)
        .then((res) => {
          let l = res.data;
    ...
    getDataCurrentPage() {
      if (
        ...
        adminApi
          .get(
            `contract-headers?document_id=${this.document_id}&start_date=${
              this.searchFilter.start_date ?? ""
            }&end_date=${
              this.searchFilter.end_date ?? ""
            }&is_related_document=${
              this.searchFilter.is_related_document ?? ""
            }&page=${this.current_page}&per_page=${this.per_page}&search=${
              this.search
            }&${filter}&is_quotation=1`
          )
          .then((res) => {
            let l = res.data;
            this.reservations = l.data;
      ...
      setTimeout(() => {
        ...
        if (dl) {
          ...
          XLSX.writeFile(
            wb,
            fn ||
              (this.document.name + "." || "SheetJSTableExport.") +
                (type || "xlsx")
          );
        }
        this.enabled3 = true;
        ...
        <div class="card">
          <div class="card-body">
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title" v-if="document">
                {{
                  page_title && page_title.url == $route.fullPath
                    ? $i18n.locale == "ar"
                      ? page_title.title
                      : page_title.title_e
                    : $i18n.locale == "ar"
                    ? $t("general.table") + " " + document.name
                    : document.name_e + " " + $t("general.table")
                }}
              </h4>
              <h4 class="header-title" v-else>
                {{
                  page_title && page_title.url == $route.fullPath
                    ? $i18n.locale == "ar"
                      ? page_title.title
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    ...
                    <b-form-checkbox
                      ...
                      value="tenant_id"
                      class="mb-1"
                      >{{ $t("general.tenant") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      v-model="filterSetting"
                      value="tenant_id"
                      class="mb-1"
                      >{{
                        document && document.document_detail_type == "booking"
                          ? document_id == 40
                            ? $t("general.employee")
                            : $t("general.receptionist")
                          : $t("general.documentSalesmen")
                      }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      v-model="filterSetting"
                ...
                <div>
                  ...
                  >
                    <div class="d-inline-block" style="font-size: 15px">
                      {{ reservationsPagination.from }}-{{
                        reservationsPagination.to
                      }}
                      /
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        @click.prevent="
                          getData(reservationsPagination.current_page - 1)
                        "
                      >
                        <span>&lt;</span>
                      </a>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group position-relative">
                      <label class="control-label"
                        >{{ $t("general.displayRelatedDocument") }}
                      </label>
                      <select
                        class="custom-select"
              ...
              >
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="reservations.sort(sortString('date'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.serial_id">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="reservations.sort(sortString('prefix'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="reservations.sort(sortString('-prefix'))"
                ...
                <tbody v-if="reservations.length > 0">
                  <tr
                    ...
                    @dblclick.prevent="
                      document_id != 34
                        ? $bvModal.show(`${data.id + ''}`)
                        : $bvModal.show(`${'printStatement' + ' ' + data.id}`)
                    "
                    v-for="(data, index) in reservations"
                    :key="data.id"
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-custom">
                          ...
                          <a
                            v-if="document && data.id && document_id != 34"
                            class="dropdown-item"
                            href="#"
                            @click="
                              $bvModal.show(
                                `${'PrintGeneralInvoice' + '-' + data.id}`
                              )
                            "
                          >
                            <div
                      ...
                      <div style="display: none">
                        ...
                        >
                          <PrintInvoice
                            :id="'PrintGeneralInvoice' + '-' + data.id"
                      ...
                      <div style="display: none">
                        <template
                          v-if="
                            document &&
                            document.document_detail_type == 'booking' &&
                            data.id &&
                            document_id == 34
                          "
                        >
                      ...
                      <div style="display: none">
                        <template
                          v-if="
                            document &&
                            document.document_detail_type == 'board_rent' &&
                            data.id
                          "
                        >
                          <CreateOrUpdatePanel
                      ...
                      <div style="display: none">
                        <template
                          v-if="
                            document &&
                            document.document_detail_type == 'normal' &&
                            data.id
                          "
                        >
                          <CreateOrUpdateItems
