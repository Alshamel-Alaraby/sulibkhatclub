 ...
 */
export default {
    name: "createOrUpdateInvoiceRealEstate",
    props: {
        document: {
            default: null,
        },
    ...
    methods: {
        ...
        getCustomers(customer_handel,employee_id=null,search='') {
            this.isLoader = true;
            adminApi
                .get(`/general-customer?limet=10&type=1&employee_id=${customer_handel=='his_customer'?employee_id:''}&search=${search}&columns[0]=name&columns[1]=name_e&columns[2]=id`)
                .then((res) => {
                    this.isLoader = false;
                    let l = res.data.data;
                    this.customers = l;
