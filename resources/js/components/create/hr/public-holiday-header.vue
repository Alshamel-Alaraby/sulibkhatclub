    ...
    <div>
        ...
        <div>
            ...
            <b-modal
                ...
                :title="
                (type != 'edit'
                    ? getCompanyKey('public_header_create_form')
                    : getCompanyKey('public_header_edit_form'))
                "
                title-class="font-18"
                body-class="p-4 "
                size="lg"
                                ...
                                <div class="col-md-6" v-if="isVisible('name')">
                                    <div class="form-group">
                                        <label for="field-1" class="control-label">
                                            {{ getCompanyKey("public_header_name_ar") }}
                                ...
                                <div class="col-md-6" v-if="isVisible('name_e')">
                                    <div class="form-group">
                                        <label for="field-2" class="control-label">
                                            {{ getCompanyKey("public_header_name_en") }}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr class="border-0">
                                                ...
                                                <th class="text-center">{{ $t('general.Name_en') }}</th>
                                                <th class="text-center">{{ $t('general.date') }}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr v-for="(item, index) in create.public_holiday_details">
                                                <td class="border-0 add-product-padding">
                                                    <input
                                                        ...
                                                        class="form-control"
                                                    />
                                                    <template v-if="errors[`public_holiday_details.${index}.name`]">
                                                        <ErrorMessage
                                                            v-for="(errorMessage, index) in errors[`public_holiday_details.${index}.name`]"
                                                            :key="index"
                                                        >{{ errorMessage }}
                                                        </ErrorMessage>
                                                    </template>
                                                ...
                                                <td class="border-0 add-product-padding">
                                                    <input
                                                        ...
                                                        class="form-control"
                                                    />
                                                    <template v-if="errors[`public_holiday_details.${index}.name_e`]">
                                                        <ErrorMessage
                                                            v-for="(errorMessage, index) in errors[`public_holiday_details.${index}.name_e`]"
                                                            :key="index"
                                                        >{{ errorMessage }}
                                                        </ErrorMessage>
                                                    </template>
                                                ...
                                                <td class="border-0 add-product-padding">
                                                    <date-picker
                                                        ...
                                                        valueType="format"
                                                    ></date-picker>
                                                    <template v-if="errors[`public_holiday_details.${index}.vdate`]">
                                                        <ErrorMessage
                                                            v-for="(errorMessage, index) in errors[`public_holiday_details.${index}.vdate`]"
                                                            :key="index"
                                                        >{{ errorMessage }}
                                                        </ErrorMessage>
                                                    </template>
                        ...
                        <b-tab :disabled="!location_id" :title="$t('general.date')">
                                ...
                                <div class="col-md-7 d-flex align-items-center mb-1 mb-xl-0">
                                    ...
                                    <div style="width: 75%">
                                        <multiselect
                                            ...
                                            :custom-label="
                                              (opt) => ($i18n.locale == 'ar'?locationDates.find((x) => x.id == opt).public_holiday_header.name:locationDates.find((x) => x.id == opt).public_holiday_header.name_e)+ ' ' + locationDates.find((x) => x.id == opt).vdate
                                             "
                                        >
                                        </multiselect>
                                    </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <td>
                                            <h5 class="m-0 font-weight-normal">{{ $i18n.locale == 'ar'? data.public_holiday_header.name : data.public_holiday_header.name_e }}</h5>
                                        </td>
                                        <td>
...
export default {
    ...
    props: {
        ...
        isPermission: {},
        url: { default: "/hr/public-holiday-header" },
    },
    mounted() {
    ...
    validations: {
        ...
        createBuilding: {
            employee_public_holiday_header_id: { required },
    ...
    methods: {
            ...
            if (Array.isArray(id)) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.isLoader = true;
                        adminApi
                            .post(`/hr/employee-public-holiday-header/bulk-delete`, { ids: id })
                            .then((res) => {
                                this.checkAll = [];
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        adminApi
                            .delete(`/hr/employee-public-holiday-header/${id}`)
                            .then((res) => {
                                this.checkAll = [];
                                this.getData(1, this.url);
                                this.successFun('Yourrowhasbeendeleted', 'Deleted');
        ...
        getLocationDate() {
            ...
            adminApi
                .get(`/hr/employee-public-holiday-header?public_holiday_header_id=${this.location_id}`)
                .then((res) => {
                    let l = res.data.data;
                ...
                if (this.type != "edit") {
                    ...
                    if (this.idObjEdit.dataObj) {
                        ...
                        if(module.public_holiday_details.length >  0 && module.public_holiday_details){
                            module.public_holiday_details.forEach(el => {
                                this.create.public_holiday_details.push({
                                    name: el.name,
                                    name_e: el.name_e,
                                    vdate: el.vdate,
                                });
        ...
        AddSubmitBuilding() {
            ...
            if (this.$v.createBuilding.$invalid) {
                ...
                if (this.type != "edit") {
                    adminApi
                        .post(`/hr/Employee-public-holiday-detail`, {
                            ...this.createBuilding,
                        })
                        .then((res) => {
                    ...
                    adminApi
                        .post(`/hr/Employee-public-holiday-detail/update`, {
                            ...this.createBuilding,
                        })
                        .then((res) => {
                            if (!this.isPage) return;
