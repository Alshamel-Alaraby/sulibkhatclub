<template>
  ...
  <b-modal
    ...
    :title="
      type != 'edit'
        ? getCompanyKey('buildingType_create_form')
        : getCompanyKey('buildingType_edit_form')
    "
    title-class="font-18"
    body-class="p-4 "
    :hide-footer="true"
...
export default {
  ...
  props: {
    ...
    isPermission: {},
    url: { default: "/real-estate/building-type" },
  },
  data() {
    return {
      fields: [],
  ...
  methods: {
    getCustomTableFields() {
      this.isCustom = true;
      adminApi
        .get(`/customTable/table-columns/rlst_building_types`)
        .then((res) => {
      ...
      setTimeout(() => {
        if (this.type != "edit") {
          ...
          if (this.idObjEdit.dataObj) {
            let type = this.idObjEdit.dataObj;
            this.errors = {};
            this.create.name = type.name;
            this.create.name_e = type.name_e;
          }
        }
      }, 50);
    },
