<template>
    <div>
        ...
        <b-modal
            :id="id"
            :title="type != 'edit' ?getCompanyKey('club_electoral_committees_create_form'):getCompanyKey('club_electoral_committees_edit_form')"
            title-class="font-18"
            body-class="p-4 "
            :hide-footer="true"
            @show="resetModal"
        ...
        >
            <form>
                ...
                <div class="row">
                    <div class="col-md-12" v-if="isVisible('name')">
                        <div class="form-group">
                            <label for="field-1" class="control-label">
                                {{ getCompanyKey('club_electoral_committees_name_ar') }}
                    ...
                    <div class="col-md-12" v-if="isVisible('name_e')">
                        <div class="form-group">
                            <label for="field-2" class="control-label">
                                {{ getCompanyKey('club_electoral_committees_name_en') }}
                    ...
                    <div class="col-md-12" v-if="isVisible('number_of_individuals')">
                        <div class="form-group">
...
import {maxLength, minLength, requiredIf,minValue} from "vuelidate/lib/validators";
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/club-members/electoral-committee'}
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/cm_electoral_committees`)
                .then((res) => {
            ...
            setTimeout( () => {
                if(this.type != 'edit'){
                    ...
                    if(this.idObjEdit.dataObj){
                        ...
                        this.create.number_of_individuals = group.number_of_individuals;
                    }
                }
            },50);
        },
