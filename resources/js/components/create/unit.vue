    ...
    methods: {
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.errors = {};
                adminApi
                    .post(`/units`, { ...this.create, company_id: this.company_id })
                    .then((res) => {
...
<template>
    <!--  create   -->
    <b-modal id="create-unit" :title="getCompanyKey('unit_create_form')" title-class="font-18" body-class="p-4 "
