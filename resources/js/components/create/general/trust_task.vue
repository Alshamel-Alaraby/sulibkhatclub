                ...
                <b-tabs nav-class="nav-tabs nav-bordered">
                    <b-tab :title="$t('general.DataEntry')" active>
                        ...
                        <div class="row">
                            ...
                            <div v-if="isVisible('employee_id')" class="col-md-3">
                                <div class="form-group">
                                    <label>
                            ...
                            <div v-if="isVisible('department_id')" class="col-md-3">
                            ...
                            <div v-if="isVisible('work_nature_id')" class="col-md-3">
                                <div class="form-group position-relative">
                                    <label
                            ...
                            <div v-if="isVisible('note') && type == 'edit'" class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ getCompanyKey("boardRent_panel_note") }}
                                        <span v-if="isRequired('note')" class="text-danger">*</span>
                                    </label>
                                    <textarea v-model="$v.create.note.$model" class="form-control" :maxlength="1000" rows="4" :disabled="true"
                                    ></textarea>
