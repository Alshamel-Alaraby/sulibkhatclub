<template>
    <div>
        ...
        <b-modal
            :id="id"
            :title="type != 'edit'?getCompanyKey('boardRent_task_request'):getCompanyKey('boardRent_task_edit_request')"
            title-class="font-18"
            ...
            <form>
                ...
                <b-tabs nav-class="nav-tabs nav-bordered">
                    <b-tab :title="$t('general.DataEntry')" active>
                        <div v-if="type == 'edit'" style="text-align: center; font-size: 16px; font-weight: bold;direction:ltr">
                            {{$i18n.locale == 'en' ?  $t('general.Signature') + ":"+ create.signature : create.signature + ":"+$t('general.Signature') }}
                        </div>
                        ...
                        <div class="row">
                            <div v-if="isVisible('department_id')" class="col-md-4">
                                <div class="form-group position-relative">
                                    <label class="control-label">
                                        {{ getCompanyKey("boardRent_work_type") }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div v-if="$v.create.priority_id.$error " class="invalid-feedback">
                                        {{ $t("general.fieldIsRequired") }}
                                    </div>
                            ...
                            <div v-if="isVisible('work_nature_id')" class="col-md-4">
                                <div class="form-group position-relative">
                                    <label
                                        class="control-label">{{ getCompanyKey("boardRent_trust_task_work_nature") }}
                                        <span v-if="isRequired('work_nature_id')" class="text-danger">*</span>
                                    </label>
                                    <multiselect
                                        v-model="$v.create.work_nature_id.$model"
                                        :options="work_nature.map((type) => type.id)"
                                        :custom-label=" (opt) => work_nature.find((x) => x.id == opt)?
                                            $i18n.locale == 'ar' ? work_nature.find((x) => x.id == opt).name : work_nature.find((x) => x.id == opt).name_e
                                            : null
                                        "
                                        :class="{'is-invalid': $v.create.work_nature_id.$error || errors.work_nature_id,'is-valid': !$v.create.work_nature_id.$invalid && !errors.work_nature_id,}"
                                    >
                                    </multiselect>
                                    <div v-if="$v.create.work_nature_id.$error" class="invalid-feedback">
                                        {{ $t("general.fieldIsRequired") }}
                                    </div>
                                    <template v-if="errors.work_nature_id">
                                        <ErrorMessage
                                            v-for="(errorMessage, index) in errors.work_nature_id"
                                            :key="index"
                                        >{{ errorMessage }}
                                        </ErrorMessage
                                        >
                            ...
                            <div v-if="isVisible('type')" class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <multiselect
                                        ...
                                        :custom-label=" (opt) => types.find((x) => x == opt)? $t('general.'+opt): null"
                            ...
                            <div v-if="isVisible('task_title')" class="col-md-4">
                                <div class="form-group">
                                    <label  class="control-label">
                                        {{ getCompanyKey('trust_task_title') }}
                                        <span v-if="isRequired('task_title')" class="text-danger">*</span>
                                    </label>
                                    <textarea  v-model="$v.create.task_title.$model"
                                        :class="{
                            ...
                            <div v-if="isVisible('note')" class="col-md-4" >
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ getCompanyKey("boardRent_panel_note") }}
                                        <span v-if="isRequired('note')" class="text-danger">*</span>
                                    </label>
                                    <textarea v-model="$v.create.note.$model" class="form-control" :maxlength="1000" cols="30" rows="5"></textarea>
                            ...
                            <h3 class="my-3 text-center col-12">{{ $t('general.Data of the requesting party') }}</h3>
                            <div v-if="isVisible('location_id')" class="col-md-4">
                                <div class="form-group position-relative">
                                    <label
                            ...
                            <div v-if="isVisible('sub_location_id')" class="col-md-4">
                                <div class="form-group position-relative">
                                    <label
                                        class="control-label">{{ getCompanyKey("boardRent_trust_task_sub_location") }}
                            ...
                            <div v-if="isVisible('address')" class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ getCompanyKey('general_task_address') }}
                            ...
                            <div v-if="isVisible('contact_person')" class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ getCompanyKey('general_task_informer_name') }}
                            ...
                            <div v-if="isVisible('contact_phone')" class="col-md-4">
                                <div class="form-group">
                                    <label  class="control-label">
                            ...
                            <div class="col-md-12" v-if="type == 'edit'">
                                <hr style="margin: 10px 0 !important;  border-top: 1px solid rgb(141 163 159 / 42%)" />
                            </div>

                            <div v-if="isVisible('department_task_id') && type == 'edit'" class="col-md-4" >
                                <div class="form-group position-relative">
                                    <label class="control-label">
                            ...
                            <div v-if="isVisible('status_id') && type == 'edit'" class="col-md-4">
                                <div class="form-group">
                                    <label>
                            ...
                            <div  class="col-md-4" v-if="type == 'edit'">
                                <div class="form-group">
                                    ...
                                    <multiselect
                                        :disabled="!(create.type == 'general') || type == 'edit'"
                                        :multiple="true"
                            ...
                            <div v-if="isVisible('notification_date')" class="col-md-4">
                          ...
                          <!--  <div v-if="isVisible('is_closed') && type == 'edit'" class="col-md-2" >
                                <div class="form-group">
                            ...
                            <div class="col-md-12 text-center" v-if="type == 'edit'">
                                <h5><strong><u>{{$t('general.ExpectedTime')}}</u></strong></h5>
                            </div>

                            <div v-if="isVisible('execution_date') && type == 'edit'" class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.startDate") }}
                            ...
                            <div v-if="isVisible('start_time') && type == 'edit'" class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.startTime") }}
                            ...
                            <div v-if="isVisible('execution_end_date') && type == 'edit'" class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.endDate") }}
                            ...
                            <div v-if="isVisible('end_time') && type == 'edit'" class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.endTime") }}
                            ...
                            <div v-if="isVisible('execution_duration') && type == 'edit'" class="col-md-2">
                                <div class="form-group">
                                    <label  class="control-label">
                                        {{ $t('general.duration') }}
                            ...
                            <div v-if="isVisible('actual_execution_date') && type == 'edit'" class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.startDate") }}
                            ...
                            <div v-if="isVisible('actual_start_time') && type == 'edit'" class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.startTime") }}
                            ...
                            <div v-if="isVisible('actual_execution_end_date') && type == 'edit'" class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.endDate") }}
                            ...
                            <div v-if="isVisible('actual_end_time') && type == 'edit'" class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ $t("general.endTime") }}
                            ...
                            <div v-if="isVisible('actual_execution_duration') && type == 'edit'" class="col-md-2">
                                <div class="form-group">
                                    <label  class="control-label">
                                        {{ $t('general.duration') }}
                            ...
                            <div v-if="isVisible('admin_note') && type == 'edit'" class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ getCompanyKey("boardRent_panel_admin_note") }}
                                    </label>
                                    <div v-html="create.admin_note"></div>
                                    <!--             <quill-editor
                                        :disabled="true"
                                        v-model="$v.create.admin_note.$model"
                                        :options="editorOption"
                                    />                             <textarea v-model="$v.create.admin_note.$model" :disabled="true" class="form-control" :maxlength="1000" rows="4"></textarea>-->
                    ...
                    <b-tab :disabled="!task_id" :title="$t('general.attachment')" v-show="type == 'edit'">
                        <div class="row">
...
export default {
    ...
    data()  {
        return {
            types: ['Periodic maintenance','Maintenance'],
            work_nature: [],
            fields: [],
            isCustom: false,
            debounce: {},
    ...
    validations: {
        create: {
            employee_id: {},
            work_nature_id: {required: requiredIf(function (model) {
                    return this.isRequired("work_nature_id");
                })},
            ...
            contact_phone: {rrequired: requiredIf(function (model) {
            ...
            sub_location_id: {requiredIf: requiredIf(function (model) {
                    return this.isRequired("sub_location_id");
                })},
    ...
    methods: {
        ...
        get_work_nature() {
            adminApi.get(`work_natures?drop_down=1&company_id=${this.company_id}`).then((res) => {
            ...
            setTimeout( async () => {
                if(this.type != 'edit'){
                    ...
                    if(this.idObjEdit.dataObj){
                        ...
                        this.create.work_nature_id = build.work_nature_id;
                        this.create.signature = build.signature;
