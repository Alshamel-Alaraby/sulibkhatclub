<template>
  ...
  <b-modal
    ...
    :title="
      type != 'edit'
        ? getCompanyKey('account_create_form')
        : getCompanyKey('account_edit_form')
    "
    title-class="font-18"
    body-class="p-4 "
    :hide-footer="true"
...
export default {
  ...
  methods: {
    ...
    defaultData(edit = null) {
      this.create = { name: "", name_e: "", account_number: "" };
      this.$nextTick(() => {
        this.$v.$reset();
      });
      this.errors = {};
      ...
      setTimeout(() => {
        if (this.type != "edit") {
          ...
          if (this.idObjEdit.dataObj) {
            let account = this.idObjEdit.dataObj;
            this.errors = {};
            this.create.name = account.name;
            this.create.name_e = account.name_e;
            this.create.message_type_id = account.account_number;
          }
        }
      }, 50);
    },
