<template>
    <div>
        ...
        <b-modal
            :id="id"
            :title="type != 'edit' ?getCompanyKey('car_transmission_create_form'):getCompanyKey('car_transmission_edit_form')"
            title-class="font-18"
            body-class="p-4 "
            :hide-footer="true"
            @show="resetModal"
                    ...
                    <div class="col-md-12" v-if="isVisible('name')">
                        <div class="form-group">
                            <label for="field-1" class="control-label">
                                {{ getCompanyKey('car_transmission_name_ar') }}
                    ...
                    <div class="col-md-12" v-if="isVisible('name_e')">
                        <div class="form-group">
                            <label for="field-2" class="control-label">
                                {{ getCompanyKey('car_transmission_name_en') }}
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/car-rent/car-transmissions'}
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/car_transmissions`)
                .then((res) => {
