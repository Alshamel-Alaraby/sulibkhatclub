        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi
                    ...
                    .then((res) => {
                        this.$bvModal.hide(`modal-edit-status-${id}`);
                        this.getData();
                        setTimeout(() => {
                            Swal.fire({
                                icon: "success",
        ...
        ExportExcel(type, fn, dl) {
            ...
            setTimeout(() => {
                ...
                if (dl) {
                    ...
                    XLSX.writeFile(wb, fn || (('Document Status' + '.' || 'SheetJSTableExport.') + (type || 'xlsx')));
                }
                this.enabled3 = true;
            }, 100);
        }
                    ...
                    <div class="row justify-content-between align-items-center mb-2 px-1">
                        <div class="col-md-3 d-flex align-items-center mb-1 mb-xl-0">
                            ...
                            <div class="d-inline-flex">
                                ...
                                <button v-print="'#printStatus'" class="custom-btn-dowonload">
                                    <i class="fe-printer"></i>
                                </button>
                                <!-- Start one edit -->
                                <button
                                    class="custom-btn-dowonload"
                                    @click="$bvModal.show(`modal-edit-status-${checkAll[0]}`)"
                        ...
                        <form>
                            <div class="mb-3 d-flex justify-content-end">
                                ...
                                <b-button
                                    variant="danger"
                                    type="button"
                                    @click.prevent="$bvModal.hide(`create-status`)"
                                >
                                    {{ $t("general.Cancel") }}
                                </b-button>
                    ...
                    <div class="table-responsive mb-3 custom-table-theme position-relative">
                        ...
                        <table class="table table-borderless table-hover table-centered m-0" ref="exportable_table"
                            ...
                            <tr
                                ...
                                @dblclick.prevent="$bvModal.show(`modal-edit-status-${data.id}`)"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-custom">
                                            <a
                                                class="dropdown-item"
                                                href="#"
                                                @click="$bvModal.show(`modal-edit-status-${data.id}`)"
                                            >
                                                <div
                                        ...
                                        <form>
                                            <div class="mb-3 d-flex justify-content-end">
                                                ...
                                                <b-button
                                                    variant="danger"
                                                    type="button"
                                                    @click.prevent="$bvModal.hide(`modal-edit-status-${data.id}`)"
                                                >
                                                    {{ $t("general.Cancel") }}
                                                </b-button>
                                            </div>
