        ...
        appointments_for_current_month: {
            handler(newV, old) {
                setTimeout(() => {
                    ...
                    weeks.forEach((week) => {
                        let check_exists = 0
                        this.appointments_for_current_month.forEach(element => {
                        ...
                        this.appointments_for_last_month.forEach(element => {
                            if (element.week == week) {
                                check_exists = 1
...
<template>
    <div class="card">
        <div class="card-body ordinaryMember">
            ...
            <h4 class="header-title">{{ $t('general.Number of appointments and reservations for this month and last month for each week') }}</h4>
