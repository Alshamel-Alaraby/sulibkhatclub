    ...
    watch: {
        total_and_paid_amount_for_each_insurance_company: {
            handler(newV, old) {
                ...
                this.total_and_paid_amount_for_each_insurance_company.forEach(element => {
...
<template>
    <b-modal id="h_m_s_total_and_paid_amount_for_each_insurance_company" title-class="font-18" size="xlll" body-class="p-4 "
        :hide-footer="true" :title="$t('general.Total and paid amount for each insurance company')">
        <div class="card">
