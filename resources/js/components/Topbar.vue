  ...
  <div class="navbar-custom">
    <div class="container-fluid">
      ...
      <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
        ...
        <template v-for="(relate,key) in Object.keys(relates)">
            <li class="nav-route-related d-none d-md-block" v-if="relates['archiving'].includes($route.name)">
                <div>
                    <ul class="list-unstyled">
                        <li class="d-inline">
                            <a href="javascript:void(0)">Ocr</a>
                        </li>
                        <li class="d-inline">
