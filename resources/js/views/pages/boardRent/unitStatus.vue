    ...
    methods: {
        ...
        log(id) {
            if (this.mouseEnter != id) {
                ...
                this.mouseEnter = id;
                adminApi
                    .get(`/boards-rent/unit_statuses/logs/${id}`)
                    .then((res) => {
                        let l = res.data.data;
                        l.forEach((e) => {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `/boards-rent/unit_statuses?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
        ...
        getDataCurrentPage(page = 1) {
            if (
                ...
                adminApi
                    .get(
                        `/boards-rent/unit_statuses?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}&company_id=${this.company_id}`
                    )
                    .then((res) => {
                        let l = res.data;
                        this.statuses = l.data;
            ...
            if (Array.isArray(id)) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.isLoader = true;
                        adminApi
                            .post(`/boards-rent/unit_statuses/bulk-delete`, { ids: id })
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        adminApi
                            .delete(`/boards-rent/unit_statuses/${id}`)
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                adminApi
                    .post(`/boards-rent/unit_statuses`, {...this.create, company_id: this.company_id })
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.errors = {};
                adminApi
                    .put(`/boards-rent/unit_statuses/${id}`, this.edit)
                    .then((res) => {
        ...
        async resetModalEdit(id) {
            await this.getStatus();
            let statuses = this.statuses.find((e) => id == e.id);
            this.edit.name = statuses.name;
            this.edit.name_e = statuses.name_e;
            this.errors = {};
        },
        /**
         *  hidden Modal (edit)
                ...
                <div class="card">
                            ...
                            <div class="col-xs-10 col-md-9 col-lg-7" style="font-weight: 500">
                                <div class="d-inline-block" style="width: 22.2%">
                                    ...
                                    >
                                        ...
                                        <b-form-checkbox v-model="filterSetting" :value="$i18n.locale == 'ar'? 'status.name':'status.name_e'" class="mb-1">
                  ...
                  >
                    <i class="fe-search"></i>
                          ...
                          'pointer-events':
                            statusesPagination.current_page == 1 ? 'none' : '',
                                            ...
                                            <a
                                                ...
                                                :style="{
                          'pointer-events':
                            statusesPagination.last_page ==
                            statusesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                                                @click.prevent="getData(statusesPagination.current_page + 1)"
                        ...
                        <b-modal
                            id="create"
                            :title="getCompanyKey('boardRent_unitStatus_create_form')"
                            title-class="font-18"
                            body-class="p-4 "
                            :hide-footer="true"
                            @show="resetModal"
                            ...
                            <table class="table table-borderless table-hover table-centered m-0" ref="exportable_table"
                                ...
                                <tr>
                                    ...
                                    <th v-if="setting.name">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey("boardRent_unitStatus_name_ar") }}</span>
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="statuses.sort(sortString('name'))"
                                                ></i>
                                                <i
                                    ...
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey("boardRent_unitStatus_name_en") }}</span>
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="statuses.sort(sortString('name_e'))"
                                                ></i>
                                                <i
                                                    class="fas fa-arrow-down"
                                                    @click="statuses.sort(sortString('-name_e'))"
                                    ...
                                    <th v-if="setting.status_id">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey("boardRent_unitStatus_status") }}</span>
                                        </div>
                                    </th>
                                ...
                                >
                                    ...
                                    <td v-if="setting.status_id">
                                        <h5 class="m-0 font-weight-normal">{{ $i18n.locale == 'ar' ? data.status.name : data.status.name_e}}</h5>
                                    </td>
                                    <td v-if="enabled3" class="do-not-print">
                                        <div class="btn-group">
                                            <button
                                        ...
                                        <b-modal
                                            ...
                                            :title="getCompanyKey('boardRent_unitStatus_edit_form')"
                                            title-class="font-18"
                                            body-class="p-4"
                                            :ref="`edit-${data.id}`"
                                            :hide-footer="true"
