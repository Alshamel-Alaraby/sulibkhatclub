...
export default {
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `/boards-rent/sectors?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
                    this.sectors = l.data;
                    this.sectorsPagination = l.pagination;
        ...
        getDataCurrentPage(page = 1) {
            if (
                this.current_page <= this.sectorsPagination.last_page &&
                this.current_page != this.sectorsPagination.current_page &&
                this.current_page
            ) {
                this.isLoader = true;
                let filter = "";
            ...
            if (Array.isArray(id)) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.isLoader = true;
                        adminApi
                            .post(`/boards-rent/sectors/bulk-delete`, { ids: id })
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.errors = {};
                adminApi
                    .post(`/boards-rent/sectors`, {...this.create,company_id:this.company_id})
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi
                    .put(`/boards-rent/sectors/${id}`, { name, name_e })
                    .then((res) => {
         ...
         */
        resetModalEdit(id) {
            let employee = this.sectors.find((e) => id == e.id);
        ...
        log(id) {
            if (this.mouseEnter != id) {
                ...
                this.mouseEnter = id;
                adminApi
                    .get(`/boards-rent/sectors/logs/${id}`)
                    .then((res) => {
                        let l = res.data.data;
                        l.forEach((e) => {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title">{{ $t("general.sectorsTable") }}</h4>
                                ...
                                <div class="d-inline-block" style="width: 22.2%">
                                    ...
                                    >
                                        <b-form-checkbox  v-model="filterSetting" value="name" class="mb-1">{{
                                            getCompanyKey('boardRent_sector_name_ar')
                                            }}</b-form-checkbox>
                                        <b-form-checkbox
                                            v-model="filterSetting"
                                            value="name_e"
                                            class="mb-1"
                                        >{{ getCompanyKey('boardRent_sector_name_en') }}</b-form-checkbox
                                        >
                                    </b-dropdown>
                                    <!-- Basic dropdown -->
                                </div>
                  ...
                  >
                    <i class="fe-search"></i>
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-block">
                                        ...
                                        >
                                            ...
                                            <b-form-checkbox  v-model="setting.name_e" class="mb-1">
                                                {{ getCompanyKey('boardRent_sector_name_en') }}
                                            </b-form-checkbox>
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size: 13px">
                                            {{ sectorsPagination.from }}-{{ sectorsPagination.to }} /
                                            {{ sectorsPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                ...
                                                :style="{
                          'pointer-events':
                            sectorsPagination.current_page == 1 ? 'none' : '',
                        }"
                                                @click.prevent="getData(sectorsPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                ...
                                                :style="{
                          'pointer-events':
                            sectorsPagination.last_page ==
                            sectorsPagination.current_page
                              ? 'none'
                              : '',
                        }"
                                                @click.prevent="getData(sectorsPagination.current_page + 1)"
                        ...
                        <b-modal
                            id="create"
                            :title="getCompanyKey('boardRent_sector_create_form')"
                            title-class="font-18"
                            body-class="p-4 "
                            :hide-footer="true"
                            @show="resetModal"
                                ...
                                <tr>
                                    ...
                                    <th v-if="setting.name">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey('boardRent_sector_name_ar') }}</span>
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="sectors.sort(sortString('name'))"
                                                ></i>
                                                <i
                                    ...
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey('boardRent_sector_name_en') }}</span>
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="sectors.sort(sortString('name_e'))"
                                                ></i>
                                                <i
                                                    class="fas fa-arrow-down"
                                                    @click="sectors.sort(sortString('-name_e'))"
                                ...
                                >
                                    ...
                                    <td v-if="enabled3" class="do-not-print">
                                        ...
                                        <b-modal
                                            ...
                                            :title="getCompanyKey('boardRent_sector_edit_form')"
                                            title-class="font-18"
                                            body-class="p-4"
                                            :ref="`edit-${data.id}`"
                                            :hide-footer="true"
