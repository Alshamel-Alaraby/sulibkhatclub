    ...
    methods: {
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                adminApi
                    .post(`/boards-rent/sell-methods`, this.create)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.errors = {};
                adminApi
                    .put(`/boards-rent/sell-methods/${id}`, this.edit)
                    .then((res) => {
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size: 13px">
                                            {{ sellMethodsPagination.from }}-{{ sellMethodsPagination.to }} /
                                        ...
                                        <div class="d-inline-block">
                                            <a
                                                ...
                                                :style="{
                          'pointer-events':
                            sellMethodsPagination.current_page == 1 ? 'none' : '',
                        }"
                                                @click.prevent="getData(sellMethodsPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
