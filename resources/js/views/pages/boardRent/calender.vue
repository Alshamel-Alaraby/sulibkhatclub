    ...
    methods: {
        ...
        editSubmit() {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.put(`/tasks/${this.task_id}`, this.edit)
                    .then((res) => {
                        this.getData();
                        setTimeout(() => {
                            Swal.fire({
        ...
        async editEvent(info) {
            ...
            this.calendar = this.calendarOptions.events.find((el) => el.id ==  this.task_id)
            await this.getEmployees();
            await this.getEmployeeDepartments();
            await this.getEmployees();
            await this.getDepartment();
                ...
                >
                    <form>
                        <div class="mb-3 d-flex justify-content-end">
                            ...
                            <b-button class="mx-1" variant="danger" @click="confirm">
                                {{ $t('general.delete') }}
                            </b-button>
