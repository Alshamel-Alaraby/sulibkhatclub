...
export default {
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `/boards-rent/tasks?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
                    this.tasks = l.data;
        ...
        getDataCurrentPage(page = 1) {
            if (
                this.current_page <= this.tasksPagination.last_page &&
                this.current_page != this.tasksPagination.current_page &&
                this.current_page
            ) {
                this.isLoader = true;
                let filter = "";
                ...
                adminApi
                    .get(
                        `/boards-rent/tasks?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}&company_id=${this.company_id}`
                    )
                    .then((res) => {
                        let l = res.data;
                        this.tasks = l.data;
            ...
            if (Array.isArray(id)) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.isLoader = true;
                        adminApi
                            .post(`/boards-rent/tasks/bulk-delete`, { ids: id })
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                adminApi
                    .post(`/boards-rent/tasks`, {...this.create, company_id: this.company_id})
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.errors = {};
                adminApi
                    .put(`/boards-rent/tasks/${id}`, this.edit)
                    .then((res) => {
        ...
        async resetModalEdit(id) {
            ...
            await  this.getDepartnent();
            this.edit.name = tasks.name;
            this.edit.name_e = tasks.name_e;
            this.edit.description = tasks.description;
            this.edit.description_e = tasks.description_e;
            this.edit.department_id = tasks.department_id;
            this.errors = {};
        },
        /**
         *  hidden Modal (edit)
...
<template>
    <Layout>
        <PageHeader />
        <Department :companyKeys="companyKeys" :defaultsKeys="defaultsKeys" @created="getDepartnent" />
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-xs-10 col-md-9 col-lg-7" style="font-weight: 500">
                                <div class="d-inline-block" style="width: 22.2%">
                                    ...
                                    >
                                        ...
                                        <b-form-checkbox v-model="filterSetting" :value="$i18n.locale == 'ar'?'department.name' : 'department.name_e'" class="mb-1">
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-block">
                                        ...
                                        >
                                            ...
                                            <b-form-checkbox v-model="setting.department_id" class="mb-1"
                                            >{{ getCompanyKey("boardRent_task_department") }}
                                            </b-form-checkbox>
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size: 13px">
                                            {{ tasksPagination.from }}-{{ tasksPagination.to }} /
                                        ...
                                        <div class="d-inline-block">
                                            <a
                                                ...
                                                :style="{
                          'pointer-events':
                            tasksPagination.current_page == 1 ? 'none' : '',
                        }"
                                            ...
                                            <a
                                                ...
                                                :style="{
                          'pointer-events':
                            tasksPagination.last_page ==
                            tasksPagination.current_page
                              ? 'none'
                              : '',
                        }"
                                                @click.prevent="getData(tasksPagination.current_page + 1)"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <multiselect @input="showDepartmentModal" v-model="create.department_id"
                                                         :options="departments.map((type) => type.id)"
                                                         :custom-label="(opt) => departments.find((x) => x.id == opt).name">
                                            </multiselect>
                            ...
                            <table class="table table-borderless table-hover table-centered m-0" ref="exportable_table"
                                ...
                                <tr>
                                    ...
                                    <th v-if="setting.description">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey("boardRent_task_description_ar") }}</span>
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="tasks.sort(sortString('name'))"
                                    ...
                                    <th v-if="setting.description_e">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey("boardRent_task_description_en") }}</span>
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="tasks.sort(sortString('name_e'))"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group position-relative">
                                                            ...
                                                            <multiselect @input="showDepartmentModalEdit" v-model="edit.department_id"
                                                                         :options="departments.map((type) => type.id)"
                                                                         :custom-label="(opt) => departments.find((x) => x.id == opt).name">
                                                            </multiselect>
