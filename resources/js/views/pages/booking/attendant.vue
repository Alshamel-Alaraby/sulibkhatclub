...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Booking attendant", "all Booking Rooms");
    });
  },
  data() {
    return {
  ...
  validations: {
    create: {
      ...
      id_number: {
        required: requiredIf(function (model) {
          return this.isRequired("id_number");
        }),
        integer,
      },
      notes: {
  ...
  methods: {
    async getCustomers() {
      await adminApi
        .get(`/general-customer?customer_handel=1`)
        .then((res) => {
          let l = res.data.data;
    ...
    getCustomTableFields() {
      adminApi
        .get(`/customTable/table-columns/general_attendants`)
        .then((res) => {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/attendant?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/attendant/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    async resetModal() {
      ...
      if (this.isVisible("customer_id")) await this.getCustomers();
    ...
    async resetModalEdit(id) {
      ...
      this.edit.customer_id = category.customer_id;
      this.edit.national_id = category.national_id;
      this.edit.id_number = category.id_number;
      this.edit.notes = category.notes;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
    ...
    ExportExcel(type, fn, dl) {
      ...
      setTimeout(() => {
        ...
        if (dl) {
          ...
          XLSX.writeFile(
            wb,
            fn || ("rooms" + "." || "SheetJSTableExport.") + (type || "xlsx")
          );
        }
        this.enabled3 = true;
      }, 100);
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.attendantTable") }}</h4>
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    <b-form-checkbox
                      ...
                      value="name"
                      class="mb-1"
                      >{{ getCompanyKey("attendant_name_ar") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      ...
                      value="name_e"
                      class="mb-1"
                      >{{ getCompanyKey("attendant_name_en") }}</b-form-checkbox
                    >
                  </b-dropdown>
                  <!-- Basic dropdown -->
                </div>
              ...
              <div class="col-md-3 d-flex align-items-center mb-1 mb-xl-0">
                ...
                <div class="d-inline-flex">
                  ...
                  <button
                    ...
                    v-if="
                      checkAll.length == 1 && isPermission('update Category')
                    "
                  >
                  ...
                  <button
                    class="custom-btn-dowonload"
                    v-if="
                      checkAll.length > 1 && isPermission('delete Category')
                    "
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      <b-form-checkbox
                        ...
                        class="mb-1"
                        >{{
                          getCompanyKey("attendant_name_ar")
                        }}</b-form-checkbox
                      >
                      <b-form-checkbox
                        v-if="isVisible('name_e')"
                        ...
                        class="mb-1"
                        >{{
                          getCompanyKey("attendant_name_en")
                        }}</b-form-checkbox
                      >
                      <b-form-checkbox
                        v-if="isVisible('customer_id')"
                        v-model="setting.customer_id"
                        class="mb-1"
                        >{{
                          getCompanyKey("attendant_customer")
                        }}</b-form-checkbox
                      >
                      <b-form-checkbox
                        ...
                        class="mb-1"
                        >{{
                          getCompanyKey("attendant_national_id")
                        }}</b-form-checkbox
                      >
                      <b-form-checkbox
                        v-if="isVisible('id_number')"
                        v-model="setting.id_number"
                        class="mb-1"
                        >{{
                          getCompanyKey("attendant_id_number")
                        }}</b-form-checkbox
                      >
                  ...
                  >
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ categoriesPagination.from }}-{{
                        categoriesPagination.to
                      }}
                      /
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        @click.prevent="
                          getData(categoriesPagination.current_page - 1)
                        "
                      >
                        <span>&lt;</span>
                      </a>
            ...
            <b-modal
              id="create"
              :title="getCompanyKey('attendant_create_form')"
              title-class="font-18"
              body-class="p-4 "
              size="lg"
              :hide-footer="true"
            ...
            >
              <form>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6" v-if="isVisible('customer_id')">
                    <div class="form-group">
                      <label
                        >{{ getCompanyKey("attendant_customer")
                        }}<span
                          v-if="isRequired('customer_id')"
                          class="text-danger"
                          >*</span
                        ></label
                      >
                  ...
                  <div class="col-md-6" v-if="isVisible('id_number')">
                    <div class="form-group">
                      <label for="field-2" class="control-label">
                        {{ getCompanyKey("attendant_id_number") }}
                        <span v-if="isRequired('id_number')" class="text-danger"
                          >*</span
                        >
                      </label>
                      <input
                        ...
                        class="form-control"
                        data-create="2"
                        v-model="$v.create.id_number.$model"
                        :class="{
                          'is-invalid':
                            $v.create.id_number.$error || errors.id_number,
                          'is-valid':
                            !$v.create.id_number.$invalid && !errors.id_number,
                        }"
                        id="field-2"
                      />
                      <template v-if="errors.id_number">
                        <ErrorMessage
                          v-for="(errorMessage, index) in errors.id_number"
                          :key="index"
                          >{{ errorMessage }}</ErrorMessage
                        >
                      </template>
                  ...
                  <div class="col-md-6" v-if="isVisible('notes')">
                    <div class="form-group">
                      <label class="mr-2">
                        {{ getCompanyKey("attendant_notes") }}
                        <span v-if="isRequired('notes')" class="text-danger"
                          >*</span
                        >
                      </label>
                      <textarea
              ...
              >
                  ...
                  <tr>
                    ...
                    <th v-if="setting.name && isVisible('name')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("attendant_name_ar") }}</span>
                    ...
                    <th v-if="setting.name_e && isVisible('name_e')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("attendant_name_en") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.customer_id && isVisible('customer_id')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("attendant_customer") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="categories.sort(sortString('name'))"
                    ...
                    <th v-if="setting.id_number && isVisible('id_number')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("attendant_id_number") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="categories.sort(sortString('name'))"
                ...
                <tbody v-if="categories.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.customer_id && isVisible('customer_id')">
                      {{
                        data.customer
                          ? $i18n.locale == "ar"
                            ? data.customer.name
                    ...
                    <td v-if="setting.id_number && isVisible('id_number')">
                      <h5 class="m-0 font-weight-normal">
                        {{ data.id_number }}
                      </h5>
                    </td>
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('attendant_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        size="lg"
                        :ref="`edit-${data.id}`"
                            ...
                            >
                              <div class="form-group">
                                ...
                                <multiselect
                                  ...
                                  :class="{
                                    'is-invalid':
                                      $v.edit.customer_id.$error ||
                                      errors.customer_id,
                                    'is-valid':
                                      !$v.edit.customer_id.$invalid &&
                                      !errors.customer_id,
                                  }"
                                >
                                </multiselect>
                            ...
                            <div class="col-md-6" v-if="isVisible('id_number')">
                              <div class="form-group">
                                ...
                                <input
                                  ...
                                  class="form-control"
                                  data-edit="2"
                                  v-model="$v.edit.id_number.$model"
                                  :class="{
                                    'is-invalid':
                                      $v.edit.id_number.$error ||
                                      errors.id_number,
                                    'is-valid':
                                      !$v.edit.id_number.$invalid &&
                                      !errors.id_number,
                                  }"
                                  id="field-2"
                                />
