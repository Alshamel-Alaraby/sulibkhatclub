...
export default {
  ...
  data() {
    return {
      ...
      is_disabled: false,
      filterSetting: ["name", "name_e", "phone", "id_number", "address","nationality","passport_no","passport_expiry_date","visa_no"],
      Tooltip: "",
      idDelete: null,
      mouseEnter: null,
      printLoading: true,
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/general-customer?page=${page}&type=1&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
    ...
    async resetModalEdit(id) {
      ...
      this.edit.passport_expiry_date = build.passport_expiry_date;
      this.edit.visa_no = build.visa_no;
      this.edit.phone = build.phone;
      this.edit.email = build.email;
      this.edit.id_number = build.id_number;
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.guestTable") }}</h4>
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    <b-form-checkbox
                      ...
                      value="name"
                      class="mb-1"
                      >{{ getCompanyKey("guest_name_ar") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      ...
                      value="name_e"
                      class="mb-1"
                      >{{ getCompanyKey("guest_name_en") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      ...
                      value="phone"
                      class="mb-1"
                      >{{ getCompanyKey("guest_phone") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      ...
                      value="id_number"
                      class="mb-1"
                      >{{ getCompanyKey("guest_id_number") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      ...
                      value="address"
                      class="mb-1"
                      >{{ getCompanyKey("guest_address") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      v-if="isVisible('nationality')"
                      v-model="filterSetting"
                      value="nationality"
                      class="mb-1"
                      >{{ getCompanyKey("guest_nationality") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      v-if="isVisible('passport_no')"
                      v-model="filterSetting"
                      value="passport_no"
                      class="mb-1"
                      >{{ getCompanyKey("guest_passport_number") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      v-if="isVisible('passport_expiry_date')"
                      v-model="filterSetting"
                      value="passport_expiry_date"
                      class="mb-1"
                      >{{ getCompanyKey("guest_passport_expiration_date") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      v-if="isVisible('visa_no')"
                      v-model="filterSetting"
                      value="visa_no"
                      class="mb-1"
                      >{{ getCompanyKey("guest_visa_number") }}</b-form-checkbox
                    >
                  </b-dropdown>
                  <!-- Basic dropdown -->
                </div>
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox
                        ...
                        class="mb-1"
                        >{{ getCompanyKey("guest_employee") }}</b-form-checkbox
                      >
                      <b-form-checkbox
                        v-if="isVisible('phone')"
                      ...
                      <b-form-checkbox
                        ...
                        class="mb-1"
                        >{{ getCompanyKey("guest_email") }}</b-form-checkbox
                      >
                      ...
                      <b-form-checkbox
                        ...
                        >{{ getCompanyKey("guest_id_number") }}</b-form-checkbox
                      >
                      <b-form-checkbox v-if="isVisible('nationality')" v-model="setting.nationality" class="mb-1">
                          {{ getCompanyKey("guest_nationality") }}
                      </b-form-checkbox>
                      <b-form-checkbox v-if="isVisible('passport_no')" v-model="setting.passport_no" class="mb-1">
                          {{ getCompanyKey("guest_passport_number") }}
                      </b-form-checkbox>
                      <b-form-checkbox v-if="isVisible('passport_expiry_date')" v-model="setting.passport_expiry_date" class="mb-1">
                          {{ getCompanyKey("guest_passport_expiration_date") }}
                      </b-form-checkbox>
                      <b-form-checkbox v-if="isVisible('visa_no')" v-model="setting.visa_no" class="mb-1">
            ...
            <b-modal
              id="create"
              :title="getCompanyKey('guest_create_form')"
              title-class="font-18"
                        ...
                        <div class="col-md-3" v-if="isVisible('id_number')">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid':
                                  $v.create.id_number.$error ||
                                  errors.id_number,
                                'is-valid':
                                  !$v.create.id_number.$invalid &&
                                  !errors.id_number,
                              }"
                            />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" v-if="isVisible('passport_no')">
                                <div class="form-group">
                                    <label class="control-label">
                                        {{getCompanyKey( "guest_passport_number")}}
                                        <span v-if="isRequired('passport_no')"
                                            class="text-danger"
                                        >*</span>
                                    </label>
                                    <input
                            ...
                            <div class="col-md-3" v-if="isVisible('passport_expiry_date')">
                                <div class="form-group">
                                    ...
                                    <template v-if="errors.passport_expiry_date">
                                        <ErrorMessage
                                            v-for="( errorMessage, index ) in errors.passport_expiry_date"
                                            :key="index"
                                        >{{ errorMessage }}</ErrorMessage>
                                    </template>
                                </div>
                            ...
                            <div class="col-md-3" v-if="isVisible('visa_no')">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                        'is-invalid':
                                          $v.create.visa_no.$error ||
                                          errors.visa_no,
                                        'is-valid':
                                          !$v.create.visa_no.$invalid &&
                                          !errors.visa_no,
                                      }"
                                    />
                                    <template v-if="errors.visa_no">
                                        <ErrorMessage v-for="( errorMessage, index) in errors.visa_no" :key="index">{{ errorMessage }}</ErrorMessage>
                                    </template>
                                </div>
                            </div>
                        </div>
                  ...
                  <tr>
                    ...
                    <th v-if="setting.name && isVisible('name')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("guest_name_ar") }}</span>
                    ...
                    <th v-if="setting.name_e && isVisible('name_e')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("guest_name_en") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.employee && isVisible('employee_id')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("guest_employee") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.phone && isVisible('phone')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("guest_phone") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="customers.sort(sortNumber('phone'))"
                    ...
                    <th v-if="setting.email && isVisible('email')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("guest_email") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="customers.sort(sortNumber('phone'))"
                    ...
                    <th v-if="setting.id_number && isVisible('id_number')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("guest_id_number") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="customers.sort(sortString('id_number'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="customers.sort(sortString('-id_number'))"
                    ...
                    <th v-if="setting.address && isVisible('address')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("guest_address") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                      ...
                      <th v-if="setting.nationality && isVisible('nationality')">
                          <div class="d-flex justify-content-center">
                              <span>{{ getCompanyKey("guest_nationality") }}</span>
                              <div class="arrow-sort">
                                  <i
                                      class="fas fa-arrow-up"
                                      @click="customers.sort(SortNumber('nationality'))"
                                  ></i>
                                  <i
                                      class="fas fa-arrow-down"
                                      @click="customers.sort(SortNumber('-nationality'))"
                      ...
                      <th v-if="setting.passport_no && isVisible('passport_no')">
                          <div class="d-flex justify-content-center">
                              <span>{{ getCompanyKey("guest_passport_number") }}</span>
                              <div class="arrow-sort">
                                  <i
                                      class="fas fa-arrow-up"
                                      @click="customers.sort(SortNumber('passport_no'))"
                                  ></i>
                                  <i
                                      class="fas fa-arrow-down"
                                      @click="customers.sort(SortNumber('-passport_no'))"
                      ...
                      <th v-if="setting.passport_expiry_date && isVisible('passport_expiry_date')">
                          <div class="d-flex justify-content-center">
                              <span>{{ getCompanyKey("guest_passport_expiration_date") }}</span>
                              <div class="arrow-sort">
                                  <i
                                      class="fas fa-arrow-up"
                                      @click="customers.sort(SortNumber('passport_expiry_date'))"
                                  ></i>
                                  <i
                                      class="fas fa-arrow-down"
                                      @click="customers.sort(SortNumber('-passport_expiry_date'))"
                      ...
                      <th v-if="setting.visa_no && isVisible('visa_no')">
                          <div class="d-flex justify-content-center">
                              <span>{{ getCompanyKey("guest_visa_number") }}</span>
                              <div class="arrow-sort">
                                  <i
                                      class="fas fa-arrow-up"
                                      @click="customers.sort(SortNumber('visa_no'))"
                                  ></i>
                                  <i
                                      class="fas fa-arrow-down"
                                      @click="customers.sort(SortNumber('-visa_no'))"
                ...
                <tbody v-if="customers.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.address && isVisible('address')">
                      ...
                      <td v-if="setting.nationality && isVisible('nationality')">
                          <h5 class="m-0 font-weight-normal">{{ data.nationality }}</h5>
                      </td>
                      <td v-if="setting.passport_no && isVisible('passport_no')">
                          <h5 class="m-0 font-weight-normal">{{ data.passport_no }}</h5>
                      </td>
                      <td v-if="setting.passport_expiry_date && isVisible('passport_expiry_date')">
                          <h5 class="m-0 font-weight-normal">{{ data.passport_expiry_date }}</h5>
                      </td>
                      <td v-if="setting.visa_no && isVisible('visa_no')">
                          <h5 class="m-0 font-weight-normal">{{ data.visa_no }}</h5>
                      </td>
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('guest_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        dialog-class="modal-full-width"
                        :ref="`edit-${data.id}`"
                                  ...
                                  <div class="row">
                                      <div class="col-md-3" v-if="isVisible('nationality')">
                                          <div class="form-group">
                                              ...
                                              <input
                                                  ...
                                                  :class="{
                                                    'is-invalid':
                                                      $v.edit.nationality.$error ||
                                                      errors.nationality,
                                                    'is-valid':
                                                      !$v.edit.nationality.$invalid &&
                                                      !errors.nationality,
                                                  }"
                                              />
                                              <template v-if="errors.nationality">
                                      ...
                                      <div class="col-md-3" v-if="isVisible('passport_no')">
                                          <div class="form-group">
                                              ...
                                              <input
                                                  ...
                                                  :class="{
                                        'is-invalid':
                                          $v.edit.passport_no.$error ||
                                          errors.passport_no,
                                        'is-valid':
                                          !$v.edit.passport_no.$invalid &&
                                          !errors.passport_no,
                                      }"
                                              />
                                              <template v-if="errors.passport_no">
                                      ...
                                      <div class="col-md-3" v-if="isVisible('passport_expiry_date')">
                                          <div class="form-group">
                                              ...
                                              <date-picker
                                                  type="date"
                                                  v-model="edit.passport_expiry_date"
                                                  format="YYYY-MM-DD"
                                                  valueType="format"
                                                  :confirm="false"
                                                  :class="{
                                            'is-invalid': $v.edit.passport_expiry_date.$error || errors.passport_expiry_date,
                                            'is-valid':!$v.edit.passport_expiry_date.$invalid && !errors.passport_expiry_date,
                                          }"
                                      ...
                                      <div class="col-md-3" v-if="isVisible('visa_no')">
                                          <div class="form-group">
                                              ...
                                              <input
                                                  ...
                                                  class="form-control"
                                                  step="0.1"
                                                  v-model="$v.edit.visa_no.$model"
                                                  :class="{
                                        'is-invalid':
                                          $v.edit.visa_no.$error ||
                                          errors.visa_no,
                                        'is-valid':
                                          !$v.edit.visa_no.$invalid &&
                                          !errors.visa_no,
                                      }"
                                              />
                                              <template v-if="errors.visa_no">
