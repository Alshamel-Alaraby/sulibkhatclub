...
export default {
  ...
  components: {
    ...
    beforeRouteEnter(to, from, next) {
      next((vm) => {
        return permissionGuard(vm, "Booking Services", "");
      });
    },
  data() {
    return {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/General-item?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/General-item/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    ExportExcel(type, fn, dl) {
      ...
      setTimeout(() => {
        ...
        if (dl) {
          ...
          XLSX.writeFile(
            wb,
            fn || ("services" + "." || "SheetJSTableExport.") + (type || "xlsx")
          );
        }
        this.enabled3 = true;
      }, 100);
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.servicesTable") }}</h4>
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    <b-form-checkbox
                      ...
                      value="name"
                      class="mb-1"
                      >{{ getCompanyKey("service_name_ar") }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      ...
                      value="name_e"
                      class="mb-1"
                      >{{ getCompanyKey("service_name_en") }}</b-form-checkbox
                    >
                  </b-dropdown>
                  <!-- Basic dropdown -->
                </div>
            ...
            <b-modal
              id="create"
              :title="getCompanyKey('service_create_form')"
              title-class="font-18"
              body-class="p-4 "
              :hide-footer="true"
              @show="resetModal"
                ...
                <div class="row">
                  ...
                  <div class="col-md-12" v-if="isVisible('price')">
                    <div class="form-group">
                      <label  class="control-label">
                        {{ getCompanyKey("service_price") }}
                        <span v-if="isRequired('price')" class="text-danger"
                          >*</span
                        >
                      </label>
                      <input
                  ...
                  <div class="col-md-12" v-if="isVisible('type')">
                    <div class="form-group">
                      <label  class="control-label">
                        {{ getCompanyKey("service_type") }}
                        <span v-if="isRequired('type')" class="text-danger"
                          >*</span
                        >
                      </label>
                        <select
                  ...
                  <tr>
                    ...
                    <th v-if="setting.name && isVisible('name')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("service_name_ar") }}</span>
                    ...
                    <th v-if="setting.name_e && isVisible('name_e')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("service_name_en") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.price && isVisible('price')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("service_price") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="categories.sort(sortString('price'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="categories.sort(sortString('-price'))"
                      ...
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("service_type") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="categories.sort(sortString('type'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="categories.sort(sortString('-type'))"
                  ...
                  >
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('service_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        :ref="`edit-${data.id}`"
                        :hide-footer="true"
                              ...
                              <div class="col-md-12" v-if="isVisible('type')">
                                  <div class="form-group">
                                      ...
                                      <select
                                          ...
                                          :class="{'is-invalid': $v.edit.type.$error || errors.type,'is-valid': !$v.edit.type.$invalid && !errors.type,}"
                                      >
                                          <option value="normal">{{ $t('general.normal') }}</option>
                                          <option value="product">{{ $t('general.product') }}</option>
                                          <option value="service">{{ $t('general.service') }}</option>
