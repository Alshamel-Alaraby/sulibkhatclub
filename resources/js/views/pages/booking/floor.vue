...
export default {
    page: {
        title: "floors",
        meta: [{ name: "description", content: "floors" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, Floor
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Booking Floor", "all Brand");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"floor_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"floor_name_en",isV: 'name_e',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Floor')"
                            :permissionUpdate="isPermission('update Floor')"
                            :permissionDelete="isPermission('delete Floor')" :isExcl="true"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative" ref="exportable_table"
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Floor')"
                                :permissionDelete="isPermission('delete Floor')"
