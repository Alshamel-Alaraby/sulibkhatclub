...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      if (
        vm.$store.state.auth.work_flow_trees.includes("color") ||
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/colors?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.colors = l.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.colorsPagination.last_page &&
        this.current_page != this.colorsPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
    ...
    AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        adminApi
          .post(`/colors`, { ...this.create, company_id: this.company_id })
          .then((res) => {
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        adminApi
          .put(`/colors/${id}`, { name, name_e, is_active })
          .then((res) => {
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            colorsPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            colorsPagination.last_page == colorsPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(colorsPagination.current_page + 1)"
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="colors.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e && isVisible('name_e')">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="colors.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="colors.sort(sortString('-name_e'))"
