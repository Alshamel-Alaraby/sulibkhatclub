...
export default {
    ...
    methods: {
        ...
        async get_appointments(page = 1) {
            ...
            &columns[10]=date&columns[11]=created_at&columns[12]=number&order=created_at&sort=ASC`).then((res) => {
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title">{{ page_title && page_title.url == $route.fullPath ? ($i18n.locale ==
                                'ar' ? page_title.title : page_title.title_e) : $t('general.Waiting Rooms') }}</h4>
