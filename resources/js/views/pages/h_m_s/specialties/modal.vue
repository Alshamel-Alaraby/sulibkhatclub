<template>
   <div>
       ...
       <b-modal
           :id="id"
           :title="type != 'edit'?getCompanyKey('hms_specialties_create_form'):getCompanyKey('hms_specialties_edit_form')"
           title-class="font-18"
           body-class="p-4 "
           :hide-footer="true"
           @show="resetModal"
                   ...
                   <div class="col-md-12" v-if="isVisible('name')">
                       <div class="form-group">
                           <label for="field-1" class="control-label">
                               {{ getCompanyKey('hms_specialties_name_ar') }}
                   ...
                   <div class="col-md-12" v-if="isVisible('name_e')">
                       <div class="form-group">
                           <label for="field-2" class="control-label">
                               {{ getCompanyKey('hms_specialties_name_en') }}
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/h_m_s/specialties'}
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/h_m_s_specialties`)
                .then((res) => {
            ...
            setTimeout( () => {
                if(this.type != 'edit'){
                    ...
                    if(this.idObjEdit.dataObj){
                        let specialty = this.idObjEdit.dataObj;
                        this.errors = {};
                        this.create.name = specialty.name;
                        this.create.name_e = specialty.name_e;
                    }
                }
            },50);
        },
