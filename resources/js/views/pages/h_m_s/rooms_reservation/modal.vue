<template>
    <div>
        ...
        <!--  create   -->
        <b-modal :id="id"
            :title="type != 'edit' ? getCompanyKey('hms_appointments_create_reservation_form') : getCompanyKey('hms_appointments_edit_form')"
                ...
                <div class="row">
                    <div class="col-md-5 row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <multiselect  @input="showBranchModal" v-model="create.branch_id" placeholder="" selectLabel="" deselectLabel=""
                                    :options="branches.map((type) => type.id)" @select="get_rooms_and_doctors_by_branch('branch')"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    {{ getCompanyKey("hms_appointments_opreations_rooms_categories") }}
                                </label>
                                <multiselect   v-model="parent_rooms_category_id" placeholder="" selectLabel="" deselectLabel=""
                                    :options="opreations_rooms_categories.map((type) => type.id)" @select="get_rooms_and_doctors_by_branch()"
                                    :custom-label="(opt) => opreations_rooms_categories.find((x) => x.id == opt) ?
                                        $i18n.locale == 'ar'
                                            ? opreations_rooms_categories.find((x) => x.id == opt).name
                                            : opreations_rooms_categories.find((x) => x.id == opt).name_e : null">
                                </multiselect>
                        ...
                        <div class="col-md-12" v-if="isVisible('from_doctor_id')">
                            <div class="form-group">
                                <label>
...
export default {
    ...
    props: {
        id: { default: "create", }, companyKeys: { default: [], }, defaultsKeys: { default: [], }, opreations_rooms_categories: {Array, default: [], },
        isPage: { default: true }, isVisiblePage: { default: null }, isRequiredPage: { default: null },
        type: { default: 'create' }, idObjEdit: { default: null }, isPermission: {}, url: { default: '/h_m_s/rooms_reservation' }, branches: { Array, default: [] }
    ...
    methods: {
        ...
        showDoctorModal() {
            if (this.create.doctor_id == 0) {
                this.$bvModal.show("addDoctorFromAppointment");
        ...
        get_available_times() {
            if (this.create.doctor_id && this.create.room_id && this.create.date) {
                ...
                adminApi
                    .get(`/h_m_s/room_available_times?doctor_id=${this.create.doctor_id}&room_id=${this.create.room_id}&date=${this.formatDateTime(this.create.date)}`)
                    .then((res) => {
        ...
        get_rooms_and_doctors_by_branch(changed_by = '') {
            if(this.create.branch_id && this.parent_rooms_category_id)
                adminApi.get(`/h_m_s/rooms?branch_id=${this.create.branch_id}&parent_rooms_category_id=${this.parent_rooms_category_id}`).then((res) => {
            ...
            if(this.create.branch_id && changed_by == 'branch')
            adminApi.get(`h_m_s/doctors?drop_down=1&branch_id=${this.create.branch_id}&company_id=${this.company_id}&outdoctor=1`).then((res) => {
                let data = res.data
