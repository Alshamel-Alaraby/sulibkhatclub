...
export default {
    ...
    beforeRouteEnter(to, from, next) {
        next((vm) => {
          return permissionGuard(vm, "InsuranceCompanies", "InsuranceCompanies");
        });
   },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"hms_insurance_companies_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"hms_insurance_companies_name_en",isV: 'name_e',
