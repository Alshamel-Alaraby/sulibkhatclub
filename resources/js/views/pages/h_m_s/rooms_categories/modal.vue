<template>
    <div>
        <!--  create   -->
        <b-modal :id="id"
            :title="type != 'edit' ? (getCompanyKey('hms_rooms_categories_create_form') + (create.parent_id ? ' ' + $t('general.Inside') + ' ( ' + selected_parent.name + ' )' : '')) : getCompanyKey('hms_rooms_categories_edit_form')"
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div v-if="isVisible('is_default') && create.parent_id" class="col-md-6">
                        <div class="form-group">
                            <label class="mr-2">
                                {{ getCompanyKey("hms_rooms_categories_is_default") }}
                            ...
                            <b-form-group :class="{
                                ...
                                <b-form-radio class="d-inline-block" v-model="$v.create.is_default.$model"
                                    name="some-radios" :value="1">{{ $t("general.Default") }}</b-form-radio>
                                <b-form-radio class="d-inline-block m-1" v-model="$v.create.is_default.$model"
                                    name="some-radios" :value="0">{{ $t("general.Nondefault") }}</b-form-radio>
                            </b-form-group>
...
export default {
    ...
    props: {
        ...
        type: { default: 'create' }, idObjEdit: { default: null }, isPermission: {}, url: { default: '/h_m_s/rooms_categories' },
        selected_parent: { Object, default: {} }
    },
    data() {
        return {
            fields: [],
