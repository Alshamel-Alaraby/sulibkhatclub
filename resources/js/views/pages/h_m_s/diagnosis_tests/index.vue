...
export default {
    page: {
        ...
        meta: [{ name: "description", content: "Diagnosis Tests" }],
    },
    watch:{
        pageTitle: {
        handler(newV, old) {
    ...
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"hms_diagnosis_tests_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"hms_diagnosis_tests_name_en",isV: 'name_e',
                ...
                {
                    isFilter: true,isSet: true,trans:"hms_diagnosis_tests_comment",isV: 'comment',
                    type: 'string',sort: true,setting: {"comment":true},isSetting: true
                }
            ],
            sendSetting: {},
            searchField: [],
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <searchPage
                            ...
                            :title="page_title && page_title.url == $route.fullPath ? ($i18n.locale == 'ar' ? page_title.title :page_title.title_e ):$t('general.Diagnosis Tests')"
                            :isVisible="isVisible"
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create DiagnosisTest')"
                            :permissionUpdate="isPermission('update DiagnosisTest')"
                            :permissionDelete="isPermission('delete DiagnosisTest')" :isExcl="true"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative" ref="exportable_table"
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update DiagnosisTest')"
                                :permissionDelete="isPermission('delete DiagnosisTest')"
