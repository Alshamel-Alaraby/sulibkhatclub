...
export default {
    page: {
        ...
        meta: [{ name: "description", content: "Services Types" }],
    },
    watch: {
        pageTitle: {
            handler(newV, old) {
    ...
    data() {
        return {
            ...
            tableSetting: [
                ...
                {
                    isFilter: false, isSet: true, trans: "hms_service_types_price", isV: 'price',
                    type: 'string', sort: true, setting: { "price": true }, isSetting: true
                },
                {
                    isFilter: false, isSet: true, trans: "hms_service_types_hours", isV: 'hours',
                    type: 'string', sort: true, setting: { "hours": true }, isSetting: true
                },
                {
                    isFilter: false, isSet: true, trans: "hms_service_types_minutes", isV: 'minutes',
                    type: 'string', sort: true, setting: { "minutes": true }, isSetting: true
                },
                {
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <!-- start search -->
                        <searchPage page="hms.ServicesTypes"
                            :title="page_title && page_title.url == $route.fullPath ? ($i18n.locale == 'ar' ? page_title.title : page_title.title_e) : $t('general.Services Types')"
                        ...
                        <actionSetting :companyKeys="companyKeys" :defaultsKeys="defaultsKeys" :current_page="current_page"
                            :isCreate="true" :isEdit="true" :isDelete="true" :permissionCreate="isPermission('create ServiceType')"
                            :permissionUpdate="isPermission('update ServiceType')" :permissionDelete="isPermission('delete ServiceType')"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative" ref="exportable_table"
                            ...
                            <tableCustom :companyKeys="companyKeys" :defaultsKeys="defaultsKeys" :isLog="false"
                                ...
                                :permissionUpdate="isPermission('update ServiceType')"
                                :permissionDelete="isPermission('delete ServiceType')" :isVisible="isVisible"
