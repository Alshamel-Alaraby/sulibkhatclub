...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/salesmen-plans?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.plans = l.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        ...
        adminApi
          .get(
            `/salesmen-plans?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
          )
          .then((res) => {
            let l = res.data;
            this.plans = l.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/salesmen-plans/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.errors = {};
        adminApi
          .put(`/salesmen-plans/${id}`, this.edit)
          .then((res) => {
    ...
    async resetModalEdit(id) {
      ...
      this.edit.salesmen_plans_source_id = branch.salesmen_plans_source.id;
      this.edit.restart_period_id = branch.restart_period.id;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
    ...
    ExportExcel(type, fn, dl) {
      ...
      setTimeout(() => {
        ...
        if (dl) {
          ...
          XLSX.writeFile(
            wb,
            fn || ("plans" + "." || "SheetJSTableExport.") + (type || "xlsx")
          );
        }
        this.enabled3 = true;
      }, 100);
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.plansTable") }}</h4>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox
                        v-if="isVisible('salesmen_plans_source_id')"
                        v-model="setting.salesmen_plans_source_id"
                        class="mb-1"
                      >
                  ...
                  >
                    <div class="form-group position-relative">
                      ...
                      <multiselect
                        ...
                        :custom-label="
                          (opt) => sources.find((x) => x.id == opt).name
                        "
                      >
                      </multiselect>
                      <div
                  ...
                  <div class="col-md-12" v-if="isVisible('restart_period_id')">
                    <div class="form-group position-relative">
                      ...
                      <multiselect
                        ...
                        :custom-label="
                          (opt) => periods.find((x) => x.id == opt).name
                        "
                      >
                      </multiselect>
                      <div
                  ...
                  <tr>
                    ...
                    <th v-if="setting.name && isVisible('name')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("salesmanplan_name_ar") }}</span>
                    ...
                    <th v-if="setting.name_e && isVisible('name_e')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("salesmanplan_name_en") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="plans.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="plans.sort(sortString('-name_e'))"
                    ...
                    <th
                      v-if="
                        setting.salesmen_plans_source_id && isVisible('salesmen_plans_source_id')
                      "
                    >
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("source") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="plans.sort(sortString('name'))"
                    ...
                    <th v-if="setting.restart_period_id && isVisible('restart_period_id')">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("period") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="plans.sort(sortString('name'))"
                  ...
                  >
                    ...
                    <td
                      v-if="
                        ...
                        isVisible('salesmen_plans_source_id')
                      "
                    >
