...
import SeatsMaterial from "../../../components/create/rent-car/seat-material";
...
export default {
    page: {
        title: "Seats Materials",
        meta: [{ name: "description", content: "Seats Materials" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, SeatsMaterial
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Seats Materials", "all Seats Materials");
        });
    },
    data() {
        return {
            url: '/car-rent/car-seats-material',
            searchMain: '',
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"car_seats_material_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_seats_material_name_en",isV: 'name_e',
    ...
    mounted() {
        ...
        this.settingFun();
        this.getCustomTableFields('car_seats_materials');
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- start search -->
                        <searchPage
                            page="general.SeatsMaterialTable"
                            :isVisible="isVisible"
