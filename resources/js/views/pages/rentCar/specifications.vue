...
import Specification from "../../../components/create/rent-car/specification";
...
export default {
    ...
    components: {
        ...
        actionSetting, tableCustom, Specification
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Specifications", "all Specifications");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"car_specifications_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_specifications_name_en",isV: 'name_e',
