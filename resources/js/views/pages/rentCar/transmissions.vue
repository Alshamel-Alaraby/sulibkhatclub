...
import Transmission from "../../../components/create/rent-car/transmission";
...
export default {
    page: {
        title: "Transmissions",
        meta: [{ name: "description", content: "Transmissions" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, Transmission
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Transmission", "all Transmission");
        });
    },
    data() {
        return {
            url: '/car-rent/car-transmissions',
            searchMain: '',
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"car_transmission_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_transmission_name_en",isV: 'name_e',
    ...
    mounted() {
        ...
        this.settingFun();
        this.getCustomTableFields('car_transmissions');
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- start search -->
                        <searchPage
                            page="general.TransmissionTable"
                            :isVisible="isVisible"
