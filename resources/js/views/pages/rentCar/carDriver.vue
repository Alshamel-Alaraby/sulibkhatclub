...
import CarDriver from "../../../components/create/rent-car/car-driving";
...
export default {
    page: {
        title: "Car Driver",
        meta: [{ name: "description", content: "Car Driver" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, CarDriver
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Car Driver", "all Car Driver");
        });
    },
    data() {
        return {
            url: '/car-rent/car-drivers',
            searchMain: '',
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"car_car_drive_employee", isV: 'employee_id',
                    type: 'relation',name: 'employee',sort: false,col1: 'name',col2: 'name_e',
                    setting: {"employee_id":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_car_drive_driving_license",isV: 'driving_license',
                    type: 'string',sort: true,setting: {"driving_license":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_car_drive_license_exp_date",isV: 'license_exp_date',
                    type: 'string',sort: true,setting: {"license_exp_date":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_car_daily_price",isV: 'daily_price',
                    type: 'string',sort: true,setting: {"daily_price":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_car_weekly_price",isV: 'weekly_price',
                    type: 'string',sort: true,setting: {"weekly_price":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_car_monthly_price",isV: 'monthly_price',
                    type: 'string',sort: true,setting: {"monthly_price":true},isSetting: true
                },
            ],
            sendSetting: {},
            searchField: [],
    ...
    mounted() {
        ...
        this.settingFun();
        this.getCustomTableFields('car_drivers');
