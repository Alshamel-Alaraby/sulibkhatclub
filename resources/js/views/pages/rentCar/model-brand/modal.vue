<template>
    <div>
        <!--  create   -->
        <b-modal :id="id"
            :title="type != 'edit' ? selected_parent.isModel ? getCompanyKey('car_model_create_form') :getCompanyKey('brand_create_form')
            : selected_parent.isModel ? getCompanyKey('car_model_edit_form') : getCompanyKey('brand_edit_form')"
...
export default {
    ...
    props: {
        ...
        selected_parent: { type: Object, default: {} }
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/h_m_s_rooms_categories`)
                .then((res) => {
            ...
            setTimeout(() => {
                if (this.type != 'edit') {
                    ...
                    if (this.idObjEdit.dataObj) {
                        let rooms_category = this.idObjEdit.dataObj;
                        this.errors = {};
                        this.create.name = rooms_category.name;
                        this.create.name_e = rooms_category.name_e;
                        this.create.brand_id = rooms_category.brand_id;
                    }
                }
            }, 50);
        },
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                if (this.type != 'edit') {
                    ...
                    adminApi
                        .post(!this.selected_parent.isModel ?this.url:'/car-rent/car-models', { ...this.create, company_id: this.company_id })
                        .then((res) => {
                    ...
                    adminApi
                        .put(`${!this.selected_parent.isModel ?this.url:'/car-rent/car-models'}/${this.idObjEdit.idEdit}`, {
                            ...this.create,
