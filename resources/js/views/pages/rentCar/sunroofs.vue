...
import SunRoof from "../../../components/create/rent-car/sun-roof";
...
export default {
    page: {
        title: "Sun Roofs",
        meta: [{ name: "description", content: "Sun Roofs" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, SunRoof
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Sun Roofs", "all Sun Roofs");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"car_sun_roofs_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_sun_roofs_name_en",isV: 'name_e',
