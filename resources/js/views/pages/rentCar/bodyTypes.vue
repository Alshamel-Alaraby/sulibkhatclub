...
import BodyType from "../../../components/create/rent-car/body-type";
...
export default {
    page: {
        title: "Body Types",
        meta: [{ name: "description", content: "Body Types" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, BodyType
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Body Types", "all Body Types");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"car_body_type_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_body_type_name_en",isV: 'name_e',
