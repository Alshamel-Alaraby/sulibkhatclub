  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      if (vm.$store.state.auth.work_flow_trees.includes("sales men-e")) {
        ...
        (vm.showScreen("sales men", "sales men") &&
      ...
      ExportExcel(type, fn, dl) {
          ...
          setTimeout(() => {
              ...
              if (dl) {
                  ...
                  XLSX.writeFile(wb, fn || (('Sales Man' + '.' || 'SheetJSTableExport.') + (type || 'xlsx')));
              }
              this.enabled3 = true;
          }, 100);
      },
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    ...
                    <b-form-checkbox
                      ...
                      v-if="isVisible('salesman_type_id')"
                      :value="
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox v-if="isVisible('salesman_type_id')" v-model="setting.salesman_type_id" class="mb-1">
                        {{ getCompanyKey("sale_man_type") }}
                      </b-form-checkbox>
              ...
              <table class="table table-borderless table-hover table-centered m-0"  ref="exportable_table"
                ...
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.salesman_type_id && isVisible('salesman_type_id')">
                      <div class="d-flex justify-content-center">
