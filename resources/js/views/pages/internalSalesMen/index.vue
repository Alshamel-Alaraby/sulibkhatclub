  ...
  methods: {
    ...
    AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        adminApi
          .post(`/internal-salesmen`, { ...this.create, company_id: this.company_id })
          .then((res) => {
      ...
      ExportExcel(type, fn, dl) {
          ...
          setTimeout(() => {
              ...
              if (dl) {
                  ...
                  XLSX.writeFile(wb, fn || (('Internal Sales Man' + '.' || 'SheetJSTableExport.') + (type || 'xlsx')));
              }
              this.enabled3 = true;
          }, 100);
      },
...
<template>
  <Layout>
    <PageHeader />
    <employee :companyKeys="companyKeys" :defaultsKeys="defaultsKeys" @created="getEmployee" />
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
