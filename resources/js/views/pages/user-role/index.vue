...
import User from "../../../components/create/user.vue";
...
export default {
  ...
  methods: {
    ...
    async getData(page = 1) {
      ...
      let index = this.filterSetting.indexOf("role_id");
      if (index > -1) {
      ...
      await adminApi
        .get(
          `/user-role?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.userRoles = l.data;
          this.roleUsersPagination = l.pagination;
    ...
    getDataCurrentPage() {
      if (
        this.current_page <= this.roleUsersPagination.last_page &&
        this.current_page != this.roleUsersPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let _filterSetting = [...this.filterSetting];
        ...
        adminApi
          .get(
            `/user-role?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
          )
          .then((res) => {
            let l = res.data;
            this.userRoles = l.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/user-role/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    async getUsers() {
      ...
      await adminApi
        ...
        .then((res) => {
          this.isLoader = false;
          let l = res.data.data;
          l.unshift({ id: 0, name: "اضف مستخدم", name_e: "Add user" });
          this.users = l;
        })
        .catch((err) => {
          Swal.fire({
    ...
    async getRoles() {
      ...
      await adminApi
        ...
        .then((res) => {
          this.isLoader = false;
          let l = res.data.data;
          l.unshift({ id: 0, name: "اضف دور", name_e: "Add role" });
          this.roles = l;
        })
        .catch((err) => {
          Swal.fire({
        ...
        <div class="card">
          <div class="card-body">
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.RoleUserTable") }}</h4>
                ...
                <div>
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 15px">
                      {{ roleUsersPagination.from }}-{{ roleUsersPagination.to }}
                      /
                      {{ roleUsersPagination.total }}
                    </div>
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            roleUsersPagination.current_page == 1 ? 'none' : '',
                        }"
                        @click.prevent="getData(roleUsersPagination.current_page - 1)"
                      >
                        <span>&lt;</span>
                      </a>
                      <input
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            roleUsersPagination.last_page ==
                            roleUsersPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(roleUsersPagination.current_page + 1)"
            ...
            <b-modal
              id="create"
              :title="getCompanyKey('role_user_create_form')"
              title-class="font-18"
              body-class="p-4 "
              :hide-footer="true"
              @show="resetModal"
                  ...
                  <div class="col-md-12 position-relative" v-if="isVisible('role_id')">
                    <div class="form-group">
                      ...
                      <multiselect
                        ...
                        "
                        :class="{
                          'is-invalid': $v.create.role_id.$error || errors.role_id,
                        }"
                      >
                      </multiselect>
                      <div v-if="!$v.create.role_id.required" class="invalid-feedback">
                        ...
                        :custom-label="
                          (opt) =>
                            $i18n.locale == 'ar'
                              ...
                              : users.find((x) => x.id == opt).name_e
                        "
                        :class="{
                          'is-invalid': $v.create.user_id.$error || errors.user_id,
                        }"
                      >
                      </multiselect>
                      <div v-if="!$v.create.user_id.required" class="invalid-feedback">
                        {{ $t("general.fieldIsRequired") }}
                      </div>
                  ...
                  >
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('role_user_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        :ref="`edit-${data.id}`"
                        :hide-footer="true"
                            ...
                            <div class="col-md-12" v-if="isVisible('role_id')">
                              <div class="form-group">
                                ...
                                <multiselect
                                  ...
                                  :class="{
                                    'is-invalid':
                                      $v.edit.role_id.$error || errors.role_id,
                                  }"
                                >
                                </multiselect>
                                <div
                                  v-if="!$v.edit.role_id.required"
                            ...
                            <div class="col-md-12" v-if="isVisible('user_id')">
                              <div class="form-group">
                                ...
                                <multiselect
                                  ...
                                  :class="{
                                    'is-invalid':
                                      $v.edit.user_id.$error || errors.user_id,
                                  }"
                                >
                                </multiselect>
                                <div
                                  v-if="!$v.edit.user_id.required"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.fieldIsRequired") }}
                                </div>
