...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Sales and Purchases Report" }],
  },
  mixins: [translation],
  components: {
    Multiselect,
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/point-of-sale/SalesPurchases-report?page=${page}&per_page=${this.per_page}`
        )
        .then((res) => {
          let l = res.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        ...
        adminApi
          .get(
            `/point-of-sale/SalesPurchases-report?page=${this.current_page}&per_page=${this.per_page}`
          )
          .then((res) => {
            let l = res.data;
                  ...
                  <tr>
                    ...
                    <th v-if="setting.type">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("sales_type") }}</span>
