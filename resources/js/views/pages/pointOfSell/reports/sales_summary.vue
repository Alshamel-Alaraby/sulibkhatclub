...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Sales Summary Report" }],
  },
  mixins: [translation],
  components: {
    Multiselect,
 ...
 async mounted() {
  ...
  methods: {
    async getTotal() {
      ...
      await adminApi
        .get(
          `/point-of-sale/sales-summary/grandTotal?group=${
            this.group_value ?? ""
          }
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/point-of-sale/sales-summary?page=${page}
        ...
        .then((res) => {
          let l = res.data;
          let items = res.data.original.data;
          let self = this;
          items.push({
            bold: true,
            name: "اجمالي",
          ...
          this.items = items;
          this.itemsPagination = l.original.pagination;
          this.current_page = l.original.pagination.current_page;
        })
        .catch((err) => {
          Swal.fire({
            icon: "error",
              ...
              >
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      <b-form-checkbox v-model="setting.item_sold" class="mb-1">
                        {{ getCompanyKey("item_sold") }}
                      </b-form-checkbox>
                      <b-form-checkbox v-model="setting.sub_total" class="mb-1">
                        {{ getCompanyKey("sub_total") }}
                      </b-form-checkbox>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.item_sold">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("item_sold") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.sub_total">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("sub_total") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                ...
                <tbody v-if="items.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.item_sold">
                      {{ data.item_sold }}
                    </td>

                    <td v-if="setting.sub_total">
                      {{ data.sub_total }}
                    </td>
