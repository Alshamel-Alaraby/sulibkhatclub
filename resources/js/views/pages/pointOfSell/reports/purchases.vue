...
export default {
  ...
  methods: {
    ...
    async getTotal() {
      ...
      await adminApi
        .get(
          `point-of-sale/Purchases-report/grandTotal?supplier_id=${this.supplier_id ?? ""}
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `point-of-sale/Purchases-report?page=${page}&per_page=${this.per_page}
        ...
        .then((res) => {
          ...
          items.push({
            ...
            due_amount: this.getItemsSumOf(items, "due_amount"),
          });
          items.push({
            bold: true,
            name: "المجموع الاجمالي",
            name_e: "Grand total",
            item_purchased: this.total.item_purchased_total,
            total: this.total.total_total,
            due_amount: this.total.due_amount_total,
          });
    ...
    getDataCurrentPage(page = 1) {
      if (
        ...
        adminApi
          .get(
            `point-of-sale/Purchases-report?page=${
              this.current_page
    ...
    getPurchasesTypes() {
      this.purchasesTypes = [
        { value: "supplier", name: "المورد", name_e: "Supplier" },
        {
  ...
  <Layout>
    ...
    >
      <div class="row mb-2 px-2">
        ...
        <div class="col-md-2">
          <label>{{ $t("general.supplier") }}</label>
          <multiselect
            v-model="supplier_id"
            ...
            :custom-label="
              (opt) =>
                $i18n.locale == 'ar'
                  ? suppliers.find((x) => x.id == opt).name
                  : suppliers.find((x) => x.id == opt).name_e
            "
          >
          </multiselect>
        </div>
        ...
        <!-- <div class="col-md-2">
          <label>{{ $t("general.purchaseType") }}</label>
          <multiselect
            v-model="purchase_type"
            :options="purchasesTypes.map((type) => type.value)"
            :custom-label="
              (opt) =>
                $i18n.locale == 'ar'
                  ? purchasesTypes.find((x) => x.value == opt).name
                  : purchasesTypes.find((x) => x.value == opt).name_e
            "
          >
          </multiselect>
        </div> -->
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox
                        v-model="setting.purchase_type"
                        class="mb-1"
                      >
                        {{ getCompanyKey("purchase_type") }}
                      </b-form-checkbox>
                      <b-form-checkbox
                        v-model="setting.supplier_id"
                        class="mb-1"
                      >
                        {{ getCompanyKey("supplier") }}
                      </b-form-checkbox>
                      <b-form-checkbox
                        v-model="setting.purchased_by"
                        class="mb-1"
                      >
                        {{ getCompanyKey("purchased_by") }}
                      </b-form-checkbox>
                      <b-form-checkbox
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.purchase_type">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("purchase_type") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.purchased_by">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("purchased_by") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                ...
                <tbody v-if="items.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.purchase_type">
                      {{ data.type }}
                    </td>

                    <td v-if="setting.supplier_id">
                    ...
                    <td v-if="setting.purchased_by">
                      <template v-if="data.created_by">
                        {{
                          data.created_by
                            ? $i18n.locale == "ar"
                              ? data.created_by.name
                              : data.created_by.name_e
                            : ""
                        }}
                      </template>
                    </td>
