...
export default {
  page: {
    title: "Register Log",
    meta: [{ name: "description", content: "Register Log" }],
  },
  mixins: [translation],
  components: {
    Multiselect,
  ...
  methods: {
    ...
    getStatuses() {
      this.statuses = [
        { value: "open", name: "مفتوح", name_e: "Open" },
        { value: "closed", name: "مغلق", name_e: "Closed" },
      ];
    },
    getCachRegisters() {
      this.cashRegisters = [
  ...
  <Layout>
    ...
    >
      <div class="row mb-2 px-2">
        ...
        <div class="col-md-2">
          ...
          <multiselect
            ...
            :custom-label="
              (opt) =>
                $i18n.locale == 'ar'
                  ? statuses.find((x) => x.value == opt).name
                  : statuses.find((x) => x.value == opt).name_e
            "
          >
          </multiselect>
        </div>
        ...
        <div class="col-md-2">
          <label>{{ $t("general.cashRegister") }}</label>
          <multiselect
            v-model="cash_register"
            :options="cashRegisters.map((type) => type.value)"
            :custom-label="
              (opt) =>
                $i18n.locale == 'ar'
                  ? cashRegisters.find((x) => x.value == opt).name
                  : cashRegisters.find((x) => x.value == opt).name_e
            "
          >
          </multiselect>
        </div>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox v-model="setting.opened_by" class="mb-1">
                        {{ getCompanyKey("opened_by") }}
                      </b-form-checkbox>
                      <b-form-checkbox v-model="setting.closed_by" class="mb-1">
                        {{ getCompanyKey("closed_by") }}
                      </b-form-checkbox>
                      ...
                      <b-form-checkbox
                        v-model="setting.opening_amount"
                        class="mb-1"
                      >
                        {{ getCompanyKey("opening_amount") }}
                      </b-form-checkbox>
                      <b-form-checkbox
                        v-model="setting.cash_sales"
                        class="mb-1"
                      >
                        {{ getCompanyKey("cash_sales") }}
                      </b-form-checkbox>
                      <b-form-checkbox
                        v-model="setting.cash_receives"
                        class="mb-1"
                      >
                        {{ getCompanyKey("cash_receives") }}
                      </b-form-checkbox>
                      <b-form-checkbox
                        v-model="setting.closing_amount"
                        class="mb-1"
                      >
                        {{ getCompanyKey("closing_amount") }}
                      </b-form-checkbox>
                      <b-form-checkbox
                        v-model="setting.difference"
                        class="mb-1"
                      >
                        {{ getCompanyKey("difference") }}
                      </b-form-checkbox>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.opened_by">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("opened_by") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.closed_by">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("closed_by") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.opening_amount">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("opening_amount") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('customer'))"
                    ...
                    <th v-if="setting.cash_sales">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("cash_sales") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('customer'))"
                    ...
                    <th v-if="setting.cash_receives">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("cash_receives") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('customer'))"
                    ...
                    <th v-if="setting.closing_amount">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("closing_amount") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('customer'))"
                    ...
                    <th v-if="setting.difference">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("difference") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('customer'))"
                ...
                <tbody v-if="items.length > 0">
                  ...
                  >
                    ...
                    <td :class="{ boldTd: data.bold }" v-if="setting.id">
                    ...
                    <td :class="{ boldTd: data.bold }" v-if="setting.title">
                      {{ data.title }}
                    </td>
                    <td v-if="setting.opened_by">
                      <template v-if="data.opened_by">
                        {{
                          data.opened_by
                            ? $i18n.locale == "ar"
                              ? data.opened_by.name
                              : data.opened_by.name_e
                            : ""
                        }}
                      </template>
                    </td>
                    <td v-if="setting.closed_by">
                      <template v-if="data.closed_by">
                        {{
                          data.closed_by
                            ? $i18n.locale == "ar"
                              ? data.closed_by.name
                              : data.closed_by.name_e
                            : ""
                        }}
                      </template>
                    </td>
                    <td :class="{ boldTd: data.bold }" v-if="setting.status">
                      {{ data.status }}
                    </td>
                    <td :class="{ boldTd: data.bold }" v-if="setting.note">
                      {{ data.note }}
                    </td>
                    <td :class="{ boldTd: data.bold }" v-if="setting.due">
                      {{ data.due }}
                    </td>
                    <td
                      :class="{ boldTd: data.bold }"
                      v-if="setting.opening_amount"
                    >
                      {{ data.opening_amount }}
                    </td>
                    <td
                      :class="{ boldTd: data.bold }"
                      v-if="setting.cash_sales"
                    >
                      {{ data.cash_sales }}
                    </td>
                    <td
                      :class="{ boldTd: data.bold }"
                      v-if="setting.cash_receives"
                    >
                      {{ data.cash_receives }}
                    </td>
                    <td
                      :class="{ boldTd: data.bold }"
                      v-if="setting.closing_amount"
                    >
                      {{ data.closing_amount }}
                    </td>
                    <td
                      :class="{ boldTd: data.bold }"
                      v-if="setting.difference"
                    >
                      {{ data.difference }}
                    </td>
                  </tr>
