...
export default {
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `/document?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
                    this.documents = l.data;
                    this.documentsPagination = l.pagination;
        ...
        getDataCurrentPage(page = 1) {
            if (
                this.current_page <= this.documentsPagination.last_page &&
                this.current_page != this.documentsPagination.current_page &&
                this.current_page
            ) {
                this.isLoader = true;
                let filter = "";
            ...
            if (Array.isArray(id)) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.isLoader = true;
                        adminApi
                            .post(`/document/bulk-delete`, { ids: id })
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size: 13px">
                                            {{ documentsPagination.from }}-{{ documentsPagination.to }} /
