...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/units?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.units = l.data;
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        adminApi
          .put(`/units/${id}`, { name, name_e, is_active })
          .then((res) => {
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    ...
                    <div class="d-inline-block">
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            unitsPagination.last_page == unitsPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(unitsPagination.current_page + 1)"
