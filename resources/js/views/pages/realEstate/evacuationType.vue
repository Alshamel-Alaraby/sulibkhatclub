...
import EvacuationType from "../../../components/create/realEstate/evacuationType";
/**
...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Evacuation Types" }],
  },
  mixins: [translation, customTable, successError, crudHelper],
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "EvacuationTypes", "all Evacuation Types");
    });
  },
  components: {
    Layout,
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create evacuationType')"
              :permissionUpdate="isPermission('update evacuationType')"
              :permissionDelete="isPermission('delete evacuationType')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
