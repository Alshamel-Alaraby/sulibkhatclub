...
import Guards from "../../../components/create/realEstate/guards.vue";
/**
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Guards", "all Guards");
    });
  },
  components: {
    Layout,
  ...
  mounted() {
    this.searchField = this.tableSetting
      ...
      .map((el) => el.isV);
    this.settingFun();
    this.getCustomTableFields("rlst_guards");
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create Guards')"
              :permissionUpdate="isPermission('update Guards')"
              :permissionDelete="isPermission('delete guards')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
