...
import polices from "../../../components/create/invoiceCom";
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Policy Realestate", "all policy RealState");
    });
  },
  ...
  data() {
    return {
      url: "/real-estate/policy",
      searchMain: "",
      tableSetting: [
        {
          isFilter: true,
          isSet: true,
          trans: "policy_name_ar",
          isV: "name",
          type: "string",
          sort: true,
          setting: { name: true },
  ...
  mounted() {
    this.searchField = this.tableSetting
      ...
      .map((el) => el.isV);
    this.settingFun();
    this.getCustomTableFields("rlst_policies");
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create policy RealState')"
              :permissionUpdate="isPermission('update policy RealState')"
              :permissionDelete="isPermission('delete policy RealState')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
