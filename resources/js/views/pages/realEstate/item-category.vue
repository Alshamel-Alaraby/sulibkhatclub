...
export default {
  ...
  methods: {
    filterSearch(fields) {
      ...
      if (indexC > -1) {
        fields[indexC] =
          this.$i18n.locale == "ar" ? "parent.name" : "parent.name_e";
      }
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create category RealState')"
              :permissionUpdate="isPermission('update category RealState')"
              :permissionDelete="isPermission('delete category RealState')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
