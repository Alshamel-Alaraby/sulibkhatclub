      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <!--  create   -->
            <b-modal id="create" :title="getCompanyKey('unitstatus_create_form')" title-class="font-18" body-class="p-4 "
                ...
                <tbody v-if="unitStatuses.length > 0">
                  <tr @click.capture="checkRow(data.id)"
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <!--  edit   -->
                      <b-modal :id="`modal-edit-${data.id}`" :title="getCompanyKey('unitstatus_edit_form')"
