        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create revenue-items RealState')"
              :permissionUpdate="isPermission('update revenue-items RealState')"
              :permissionDelete="isPermission('delete revenue-items RealState')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
            ...
            >
              ...
              <tableCustom
                ...
                :isDelete="true"
                :permissionUpdate="
                  isPermission('update revenue-items RealState')
                "
                :permissionDelete="
                  isPermission('delete revenue-items RealState')
                "
                :isVisible="isVisible"
...
import RevenueItems from "../../../components/create/realEstate/revenueItems";
