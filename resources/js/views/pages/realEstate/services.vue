        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create services RealState')"
              :permissionUpdate="isPermission('update services RealState')"
              :permissionDelete="isPermission('delete services RealState')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
...
import Services from "../../../components/create/realEstate/services.vue";
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "services", "all services");
    });
  },
  components: {
    Layout,
