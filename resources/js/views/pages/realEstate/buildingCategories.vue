      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <!-- start search -->
            <searchPage
              page="general.buildingCategoriesTable"
              :isVisible="isVisible"
            ...
            <actionSetting
              ...
              :isDelete="true"
              :permissionCreate="
                isPermission('create buildingCategories RealState')
              "
              :permissionUpdate="
                isPermission('update buildingCategories RealState')
              "
              :permissionDelete="
                isPermission('delete buildingCategories RealState')
              "
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
...
import buildingCategories from "../../../components/create/realEstate/buildingCategories";
/**
...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Building Categories" }],
  },
  ...
  data() {
    return {
      url: "/real-estate/building-categories",
      searchMain: "",
      tableSetting: [
        {
          isFilter: true,
          isSet: true,
          trans: "building_categories_name_ar",
          isV: "name",
          type: "string",
          sort: true,
          setting: { name: true },
        ...
        },
        {
          isFilter: true,
          isSet: true,
          trans: "building_categories_name_en",
          isV: "name_e",
          type: "string",
          sort: true,
          setting: { name_e: true },
  ...
  mounted() {
    this.searchField = this.tableSetting
      ...
      .map((el) => el.isV);
    this.settingFun();
    this.getCustomTableFields("rlst_building_categories");
