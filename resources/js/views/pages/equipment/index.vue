...
export default {
  ...
  beforeRouteEnter(to, from, next) {
      next((vm) => {
          if (
              vm.$store.state.auth.work_flow_trees.includes("equipment") ||
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/equipments?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.equipments = l.data;
          this.equipmentsPagination = l.pagination;
    ...
    getDataCurrentPage() {
      if (
        this.current_page <= this.equipmentsPagination.last_page &&
        this.current_page != this.equipmentsPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
        ...
        adminApi
          .get(
            `/equipments?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
          )
          .then((res) => {
            let l = res.data;
            this.equipments = l.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/equipments/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    async resetModalEdit(id) {
      this.getRootNodes();
      let propertyTree = this.equipments.find((e) => id == e.id);
        ...
        <div class="card">
          <div class="card-body">
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.equipmentsTable") }}</h4>
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    ...
                    <b-form-checkbox
                      ...
                      value="name_e"
                      class="mb-1"
                      >{{ getCompanyKey("equipment_name_en") }}</b-form-checkbox
                    >
                  </b-dropdown>
                  <!-- Basic dropdown -->
                </div>
                ...
                <div>
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 15px">
                      {{ equipmentsPagination.from }}-{{
                        equipmentsPagination.to
                      }}
                      /
                      {{ equipmentsPagination.total }}
                    </div>
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            equipmentsPagination.current_page == 1 ? 'none' : '',
                        }"
                        @click.prevent="
                          getData(equipmentsPagination.current_page - 1)
                        "
                      >
                        <span>&lt;</span>
                      </a>
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            equipmentsPagination.last_page ==
                            equipmentsPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="
            ...
            <b-modal
              id="create"
              :title="getCompanyKey('equipment_create_form')"
              title-class="font-18"
              body-class="p-4 "
              :hide-footer="true"
              size="lg"
              ...
              <table class="table table-borderless table-hover table-centered m-0" ref="exportable_table"
                  ...
                  <tr>
                    ...
                    <th v-if="setting.name">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("equipment_name_ar") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="equipments.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("equipment_name_en") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="equipments.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="equipments.sort(sortString('-name_e'))"
                ...
                <tbody v-if="equipments.length > 0">
                  <tr
                    ...
                    v-for="(data, index) in equipments"
                    :key="data.id"
                  ...
                  >
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('equipment_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        size="lg"
                        :ref="`edit-${data.id}`"
