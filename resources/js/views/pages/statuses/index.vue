...
export default {
  ...
  data() {
    return {
      ...
      filterSetting: ["name", "name_e",'color','icon'],
      Tooltip: "",
      mouseEnter: null,
      enabled3: true,
      printLoading: true,
  ...
  validations: {
    create: {
      ...
      color: { required: requiredIf(function (model) {
              return this.isRequired("color");
          }) , minLength: minLength(3), maxLength: maxLength(100) },
      icon: { required: requiredIf(function (model) {
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <b-modal
              id="create"
              :title="getCompanyKey('statuses_create_form')"
              title-class="font-18"
              body-class="p-4 "
              :hide-footer="true"
              @show="resetModal"
                  ...
                  >
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('statuses_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        :ref="`edit-${data.id}`"
                        :hide-footer="true"
