...
<!--                                        v-if="checkAll.length == 1 && isPermission('update financialStatus hr')"-->
<!--                                    >-->
...
<!--                                    <button-->
<!--                                        class="custom-btn-dowonload"-->
<!--                                        v-if=" checkAll.length > 1 && isPermission('delete financialStatus hr')"-->
                            ...
                            >
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-block">
                                        ...
                                        >
                                            <b-form-checkbox v-if="isVisible('name')" v-model="setting.name"
                                                             class="mb-1"
                                            >{{ getCompanyKey("financial_status_name_ar") }}
                                            </b-form-checkbox>
...
<!--                                    </th>-->
                                ...
                                <tr @click.capture="checkRow(data.id)"
                                    @dblclick.prevent=" isPermission('update financialStatus hr')
