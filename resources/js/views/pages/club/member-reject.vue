                                    ...
                                    <div class="col-md-6" v-if="isVisible('cm_member_id')">
                                        <div class="form-group position-relative">
                                            ...
                                            <multiselect
                                                ...
                                                :custom-label="
                                                  (opt) => members.find((x) => x.id == opt) ? members.find((x) => x.id == opt).first_name +' '+ members.find((x) => x.id == opt).second_name
                            ...
                            <div class="row data-header-print" :class="[$i18n.locale == 'ar' ? 'dir-print-rtl' :'dir-print-ltr']">
                                ...
                                <div class="text-center" style="width: 69%; padding-top: 5px; display: inline-block;">
                                    <div style="width:100%; display: inline-block;">
                                        ...
                                        <h2 style="font-weight: bold"> {{ $t("general.MembershipCancellationStatement") }} </h2>
                                    </div>
                                </div>
