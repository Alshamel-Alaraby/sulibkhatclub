...
export default {
    ...
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Members have the right to attend the assembly", "all Permission member club");
        });
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title">
                                {{ $t("general.membersHaveTheRightToAttendTheAssembly") }}
                            </h4>
                            ...
                            <div class="head-branch text-center">
                                <div>
                                    ...
                                    <div class="d-inline-block" style="width:70%">
                                        ...
                                        <h3 class="text-center d-inline-block" v-if="permissions.length > 0">
                                            {{ $t('general.MembersOfTheGeneralAssemblywho')+ ' '+
                                        (create.cm_permission_id.length > 0?
                                                permissions.find(el => el.id == Math.min(...create.cm_permission_id))?
                                                    $i18n.locale == 'ar'? permissions.find(el => el.id == Math.min(...create.cm_permission_id)).name:
                                                        permissions.find(el => el.id == Math.min(...create.cm_permission_id)).name_e
                                                    : ''
                                                : ''
                                        )
                                        + " " +$t('general.in') + ':' + create.date }}
                                        </h3>
                                    </div>
                                </div>
                            </div>
