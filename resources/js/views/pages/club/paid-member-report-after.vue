    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            if (this.$v.create.$invalid) {
                ...
                adminApi.get(`/club-members/transactions/member-transaction-paid-after-date?date=${this.create.date}&year=${this.create.year}&page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                    .then((res) => {
                        let l = res.data;
        ...
        getDataCurrentPage(page = 1) {
            ...
            if (this.$v.create.$invalid) {
                ...
                if (this.current_page <= this.installmentStatusPagination.last_page && this.current_page != this.installmentStatusPagination.current_page && this.current_page) {
                    ...
                    adminApi.get(`/club-members/transactions/member-transaction-paid-after-date?date=${this.create.date}&year=${this.create.year}&page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                        .then((res) => {
                            let l = res.data;
                            this.installmentStatus = l.data;
                            this.installmentStatusPagination = l.pagination;
