...
import EmployeeLocation from "../../../components/create/hr/employee-location";
...
export default {
    page: {
        ...
        meta: [{ name: "description", content: 'Employee Location' }],
    },
    mixins: [translation,customTable,successError,crudHelper],
    components: {
        Layout, PageHeader, loader, EmployeeLocation,
        searchPage,actionSetting, tableCustom
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Employee Location", "all wallet RealState");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"employee_location_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_location_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_location_longitude",isV: 'longitude',
                    type: 'string',sort: true,setting: {"longitude":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_location_latitude",isV: 'latitude',
                    type: 'string',sort: true,setting: {"latitude":true},isSetting: true
                },
            ],
            sendSetting: {},
            searchField: [],
