...
import PublicHolidayHeader from "../../../components/create/hr/public-holiday-header";
...
export default {
    page: {
        title: "Public Header",
        meta: [{ name: "description", content: 'Public Header' }],
    },
    mixins: [translation,customTable,successError,crudHelper],
    components: {
        Layout, PageHeader, loader, PublicHolidayHeader,
        searchPage,actionSetting, tableCustom
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Public Header", "all wallet RealState");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"public_header_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"public_header_name_en",isV: 'name_e',
