...
export default {
    page: {
        title: "Payments Follow-up Report",
        meta: [{name: "Payments Follow-up", content: 'Payments Follow-up Report'}],
    },
    mixins: [translation],
    components: {
        Layout,
    ...
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Payments Follow-upP", "all PaymentsFollowUp");
        });
    },
    data() {
        return {
            ...
            customers: [],
            payment_types: [],
            payments_status: ['Paid', 'Unpaid', 'Partial paid'],
            payment_deadline: ['Early repayment', 'On-time payment', 'Late payment'],
            isLoader: false,
            create: {
                ...
                start_due_date: this.formatDate(new Date()),
                end_due_date: this.formatDate(new Date()),
                payments_status: '',
                payment_deadline: '',
            },
            errors: {},
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-block">
                                        ...
                                        <b-dropdown variant="primary"
                                            ...
                                            <b-form-checkbox v-model="setting.currency_id" class="mb-1">
                                                {{ getCompanyKey("installment_opening_balance_currency") }}
                                            </b-form-checkbox>
                                            <b-form-checkbox v-model="setting.rate" class="mb-1">
                                                {{ getCompanyKey("installment_opening_balance_rate") }}
                                            </b-form-checkbox>
                                            <b-form-checkbox v-model="setting.local_debit" class="mb-1">
                                                {{ getCompanyKey("installment_opening_balance_local_debit") }}
                                            </b-form-checkbox>
                                            <b-form-checkbox v-model="setting.local_credit" class="mb-1">
                                                {{ getCompanyKey("installment_opening_balance_local_credit") }}
                                            </b-form-checkbox>
                                            ...
                                            <b-form-checkbox v-model="setting.break_type" class="mb-1">
                                                {{ $t('general.type') }}
                                            </b-form-checkbox>
                                            <b-form-checkbox v-model="setting.instalment_type_id" class="mb-1">
                                                {{ getCompanyKey("installment_payment_type_id") }}
                                            </b-form-checkbox>
                                            <b-form-checkbox v-model="setting.amount_status" class="mb-1">
                                                {{ $t('general.amount_status') }}
                                            </b-form-checkbox>
                                            <b-form-checkbox v-model="setting.date_status" class="mb-1">
                                                {{ $t('general.date_status') }}
                                            </b-form-checkbox>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            >
                                                ...
                                                <option value="Paid_Partially">{{
                                                        $t('general.Paid_Partially')
                                                    }}
                                                </option>
                                            </select>
                            ...
                            <table class="table table-borderless table-hover table-centered m-0">
                                ...
                                >
                                    ...
                                    <td v-if="setting.break_type">
                                        <h5 v-if="data.document" class="m-0 font-weight-normal">
                                            {{ $i18n.locale == "ar" ? data.document.name : data.document.name_e }}</h5>
                                        <h5 v-else class="m-0 font-weight-normal">---</h5>
                                    </td>
                                    <td v-if="setting.instalment_type_id">
                                        <h5 class="m-0 font-weight-normal td5">
                                            {{ $i18n.locale == "ar" ? data.installment_payment_type.name : data.installment_payment_type.name_e }}</h5>
                                    </td>
                                    <td v-if="setting.amount_status">
                                        <h5 class="m-0 font-weight-normal td5">
                                            {{ $t('general.' + data.amount_status) }}</h5>
                                    </td>
                                    <td v-if="setting.date_status">
                                        <h5 class="m-0 font-weight-normal td5">
                                            {{ $t('general.' + dateStatus(data.instalment_date, data.payment_invoice.date)) }}</h5>
                                    </td>
                                    <td v-if="setting.serial_number">
                                        <h5 class="m-0 font-weight-normal td5">
                                            {{ data.payment_invoice ? data.payment_invoice.prefix : '---' }}</h5>
                                    </td>
                                </tr>
                                </tbody>
                                <tbody v-else>
