...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      ...
      if (
        vm.$store.state.auth.work_flow_trees.includes("main contact groups") ||
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/recievable-payable/rp_main_contact_group?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        ...
        adminApi
          .get(
            `/recievable-payable/rp_main_contact_group?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
          )
          .then((res) => {
            let l = res.data;
            this.rolesType = l.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/recievable-payable/rp_main_contact_group/bulk-delete`, {
                ids: id,
              })
              .then((res) => {
                this.checkAll = [];
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            adminApi
              .delete(`/recievable-payable/rp_main_contact_group/${id}`)
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        adminApi
          .put(`/recievable-payable/rp_main_contact_group/${id}`, { name, name_e })
          .then((res) => {
    ...
    log(id) {
      if (this.mouseEnter != id) {
        ...
        this.mouseEnter = id;
        adminApi
          .get(`/recievable-payable/rp_main_contact_group/logs/${id}`)
          .then((res) => {
            let l = res.data.data;
            l.forEach((e) => {
      ...
      ExportExcel(type, fn, dl) {
          ...
          setTimeout(() => {
              ...
              if (dl) {
                  ...
                  XLSX.writeFile(wb, fn || (('MainContactGroups' + '.' || 'SheetJSTableExport.') + (type || 'xlsx')));
              }
              this.enabled3 = true;
          }, 100);
      },
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.MainContactGroupsTable") }}</h4>
                  ...
                  <tr>
                    ...
                    <th v-if="setting.name">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("Group_name") }}</span>
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("Group_name_e") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                  ...
                  >
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('MainContactGroupsEdit')"
                        title-class="font-18"
                        body-class="p-4"
                        :ref="`edit-${data.id}`"
                        :hide-footer="true"
