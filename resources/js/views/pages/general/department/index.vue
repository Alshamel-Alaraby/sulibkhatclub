...
import Department from "../../../../components/create/general/departmentTask";
...
export default {
  page: {
    title: "Departments",
    meta: [{ name: "Departments", content: "Departments" }],
  },
  mixins: [translation,customTable,successError,crudHelper],
  components: {
        Layout, PageHeader, loader, Department,
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"department_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"department_name_en",isV: 'name_e',
  ...
  methods: {
      filterSearch(fields){
          let indexLocation = fields.indexOf("branch_id"),
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Department')"
                  :permissionUpdate="isPermission('update Department')"
                  :permissionDelete="isPermission('delete Department')" :isExcl="true"
            ...
            >
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Department')"
                    :permissionDelete="isPermission('delete Department')"
