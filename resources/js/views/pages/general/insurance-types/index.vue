...
import InsuranceTypes from "../../../../components/create/general/insurance-type";
...
export default {
    page: {
        ...
        meta: [{ name: "description", content: "Insurance Types" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, InsuranceTypes
    },
    beforeRouteEnter(to, from, next) {
         next((vm) => {
      return permissionGuard(vm, "Insurance Types", "all Insurance Types");
    });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"insurance_type_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"insurance_type_name_en",isV: 'name_e',
