...
import InsuranceSetting from "../../../../components/create/general/insuranceSetting";
...
export default {
    page: {
        ...
        meta: [{ name: "description", content: "Insurance Settings" }],
    },
    mixins: [translation,customTable,crudHelper],
    components: {
        Layout, PageHeader, loader, searchPage,
        actionSetting, tableCustom, InsuranceSetting
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "insurance Setting", "all insurance Setting");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"car_insurance_settings_title_ar",isV: 'title',
                    type: 'string',sort: true,setting: {"title":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_insurance_settings_title_en",isV: 'title_e',
                    type: 'string',sort: true,setting: {"title_e":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_insurance_settings_db_table",isV: 'db_table',
                    type: 'string',sort: true,setting: {"db_table":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"car_insurance_settings_db_field",isV: 'db_field',
                    type: 'string',sort: true,setting: {"db_field":true},isSetting: true
                },
            ],
            sendSetting: {},
            searchField: [],
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :isCreate="tables.length == 0 ? true: false" :isEdit="true" :isDelete="true"
