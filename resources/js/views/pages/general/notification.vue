                        ...
                        <div class="row justify-content-center align-items-center mt-2 mb-2 px-1">
                               <div class="col-md-7">
                                   <div class="notify position-relative">
                                       ...
                                       <!--       end loader       -->
                                       <a
                                           class="notify-item py-2"
                                       >
                                           <h5 class="m-0 d-flex justify-content-between">
                                            <button class="btn btn-danger btn-sm" @click.prevent="clearAll"> {{ $t("navbar.dropdown.notification.subtext") }}</button>
...
.rtl  .notify-item:hover, .notify-item:focus {
    color: #272e37;
    text-decoration: none;
    background-color: #f1f5f7;
}
