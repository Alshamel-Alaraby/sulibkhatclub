...
import ContractTemplates from "../../../../components/create/general/contractTemplates";
...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Contract Templates" }],
  },
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "ContractTemplates", "all Contract Templates");
    });
  },
  data() {
    return {
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create Contract Templates')"
              :permissionUpdate="isPermission('update Contract Templates')"
              :permissionDelete="isPermission('delete Contract Templates')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
