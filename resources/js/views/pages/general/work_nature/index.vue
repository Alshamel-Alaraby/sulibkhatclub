...
import WorkNature from "../../../../components/create/general/work_nature";
...
export default {
    page: {
        title: "Work Nature",
        meta: [{ name: "description", content: "Work Nature" }],
    },
    watch:{
        pageTitle: {
        handler(newV, old) {
    ...
    components: {
        ...
        actionSetting, tableCustom, WorkNature
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
          return permissionGuard(vm, "Work Nature", "all WorkNature");
        });
   },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"general_work_nature_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"general_work_nature_name_en",isV: 'name_e',
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <searchPage
                            page="Work Nature"
                            :title="page_title && page_title.url == $route.fullPath ? ($i18n.locale == 'ar' ? page_title.title :page_title.title_e ):$t('general.Work Nature')"
                            :isVisible="isVisible"
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create WorkNature')"
                            :permissionUpdate="isPermission('update WorkNature')"
                            :permissionDelete="isPermission('delete WorkNature')" :isExcl="true"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative" ref="exportable_table"
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update WorkNature')"
                                :permissionDelete="isPermission('delete WorkNature')"
