...
import Role from "../../../../components/create/general/role";
...
export default {
    ...
    components: {
        ...
        actionSetting, tableCustom, Role
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Role", "all Role");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true, isSet: true, trans: "role_name", isV: 'name',
                    type: 'string', sort: true, setting: {"name": true}, isSetting: true
                },
                {
                    isFilter: true, isSet: true, trans: "role_name_e", isV: 'name_e',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Role')"
                            :permissionUpdate="isPermission('update Role')"
                            :permissionDelete="isPermission('delete Role')" :isExcl="true"
                            :isPrint="true" :checkAll="checkAll" :sideAction="true" :sidePaginate="true"
                            :isFilter="true" :group="true" :isGroup="true"
                            :isSetting="false" :isPaginate="true" :settings="tableSetting"
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Role')"
                                :permissionDelete="isPermission('delete Role')"
