...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Lawyer", "all Lawyer");
    });
  },
  data() {
    return {
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create Lawyer')"
              :permissionUpdate="isPermission('update Lawyer')"
              :permissionDelete="isPermission('delete Lawyer')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
