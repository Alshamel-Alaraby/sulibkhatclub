        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create costCenters ')"
              :permissionUpdate="isPermission('update costCenters ')"
              :permissionDelete="isPermission('delete costCenters ')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
...
import Cost from "../../../../components/create/general/GlCostCenters.vue";
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "CostCenters", "all CostCenters");
    });
  },
  components: {
    Layout,
