...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/payment-types?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.paymentTypesPagination.last_page &&
        this.current_page != this.paymentTypesPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        adminApi
          .put(`/payment-types/${id}`, { name, name_e, is_default })
          .then((res) => {
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            paymentTypesPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            paymentTypesPagination.last_page ==
                            paymentTypesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(paymentTypesPagination.current_page + 1)"
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="paymentTypes.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e && isVisible('name_e')">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="paymentTypes.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="paymentTypes.sort(sortString('-name_e'))"
